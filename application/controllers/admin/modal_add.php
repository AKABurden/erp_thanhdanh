                    ...
                    <div class="col-md-12">
                        ...
                        <table class="tnh-tb table-bordered table-hover dont-responsive-table m-group0" style="">
                            <tbody>
                                ...
                                <tr>
                                    <td style="width: 15%;">
                                        <label for="date" class="control-label">
                                            ...
                                            1. <?php echo _l('intpro_date'); ?>
                                        </label>
                                    </td>
                                    <td style="width: 30%;">
                                        <?= form_input('date', !empty($object) ? $object->date : date('Y/m/d H:i:s'), 'id="date" class="form-control datetimepicker" placeholder="' . lang('date') . '" required ') ?>
                                    </td>
                                    <td style="width: 15%;">
                                ...
                                <tr>
                                    <td>
                                        <?= lang('3.2 Loại đề xuất', 'recommended_list_group_id') ?>
                                    </td>
                                    <td>
                                        <?php
                                        ...
                                        <select name="recommended_list_group_id" id="recommended_list_group_id" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98" data-placeholder="<?= lang('Nhóm đề xuất') ?>" class="selectpicker">
                                            ...
                                            <?php if (!empty($dtRecommendedListG)) : ?>
                                                <?php foreach ($dtRecommendedListG as $key => $value) : ?>
                                                    <option data-bonus="<?= $value['type_bonus'] ?>" <?= ((!empty($object->recommended_list_group_id) && $object->recommended_list_group_id == $value['id']) ? 'selected' : '') ?> data-subtext="<?= $value['name'] ?>" value="<?= $value['id'] ?>"><?= $value['code'] ?>
                                                    </option>
                                                <?php endforeach; ?>
                                            <?php endif; ?>
                                        </select>
                                    ...
                                    <td style="">
                                        <label for="staff_assigned" class="control-label">
                                            <?php echo _l('9. Quản lý duyệt'); ?>
                                        </label>
                                    </td>
                                    <td>
                                        <?php $value = !empty($object->staff_assigned) ? $object->staff_assigned : [] ?>
                                        <?php echo render_select('staff_assigned', (!empty($staffs) ? $staffs : []), ['staffid', ['firstname', 'lastname']], '', $value) ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <?= lang('4. Nhóm đề xuất', 'recommended_list_id') ?>
                                    </td>
                                    <td>
                                        <?php
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <label for="head_of_department_id" class="control-label">
                                            <?php echo _l('12. Trưởng bộ phận duyệt'); ?>
                                        </label>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td style="">
                                        <label for="monitor_id" class="control-label">
                                            <?php echo _l('11. Giám sát phận duyệt'); ?>
                                        </label>
                                    </td>
                                    <td>
                                        ...
                                        <select class="form-control suggest_id selectpicker" name="suggest_id" id="suggest_id" data-live-search="true" data-none-selected-text="<?= _l('dropdown_non_selected_tex') ?>">
                                            ...
                                            <?php if (!empty($dtSuggest)) { ?>
                                                <?php foreach ($dtSuggest as $key => $value) { ?>
                                                    <option <?= ($value['id'] == $valueSelected) ? 'selected' : '' ?> value="<?= $value['id'] ?>"><?= $value['reference_no'] ?></option>
                                                <?php } ?>
                                            <?php } ?>
                                        </select>
                                    </td>
                                    ...
                                    <td colspan="4">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <?= lang('16. Chi tiết yêu cầu', 'title', ['style' => 'text-transform: capitalize']) ?>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                17. <?= lang('internal_proposal_content', 'title', ['style' => 'text-transform: capitalize']) ?>
