...
class App_css extends App_assets
{
    ...
    public function compile($group = 'admin')
    {
        ...
        // var_dump($this->registered);die;
        if(empty($this->registered['admin'])) {
            $this->registered['admin'] = array(
                'favicon'=> array(
                    'path'=>'uploads/company/favicon.jpg',
                    'version'=>false,
                    'attributes'=>array(
                        'rel'=>'shortcut icon',
                        'type'=>false
                ...
                'reset-css'=>array(
                    'path'=>'assets/css/reset.min.css',
                    'deps'=>array()
                ),
                'roboto-css'=>array(
                    'path'=>'assets/plugins/roboto/roboto.css',
                    'deps'=>array()
                ),
                'vendor-css'=>array(
                    'path'=>'assets/builds/vendor-admin.css',
                    'deps'=>array()
                ),
                'app-css'=>array(
                    'path'=>base_url().'assets/css/style.min.css',
                    'deps'=>array()
                )
            );
        }
