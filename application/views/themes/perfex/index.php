      ...
      <div class="container">
         ...
         <div class="row">
            ...
            <!--    <ul class="submenu customer-top-submenu">
                  ...
                  <li class="customers-top-submenu-calendar"><a href="<?php echo site_url('clients/pos'); ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <?php echo _l('cong_convert_orders_to_quotes'); ?></a></li>
               </ul>
