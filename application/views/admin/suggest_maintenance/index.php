    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestMaintenance): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_maintenance/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-maintenance" class="table dt-tnh table-suggest-maintenance-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Giờ Dừng Máy') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-maintenance',
        '<?= site_url('admin/suggest_maintenance/getSuggestMaintenances') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_maintenance/getSuggestMaintenances') ?>',
                "type": "POST",
                "data": function(d) {
     ...
     function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_maintenance/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function agreeFinish(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_maintenance/agreeFinish',
            data: dataPOST,
            dataType: "json",
            success: function (response) {
                if (response.result) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_maintenance/exportExcel',
            data: {
