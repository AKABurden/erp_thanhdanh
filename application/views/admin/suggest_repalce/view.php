    ...
    <div class="modal-content">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <?php
                            $dtMachines = get_table_where('tbl_machines',['id' => $dtData['machines_id']],'','row_array');
                            ?>
                            <div><?= lang('Thiết bị') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtMachines['name'] ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Người đề xuất') ?>: </div>
                            <div class="ml-at t-bold"><?= !empty($dtData['staff_suggest']) ? get_staff_full_name($dtData['staff_suggest']) : '' ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            ...
                            <div class="ml-at t-bold"><?= !empty($dtData['staff_agree']) ? get_staff_full_name($dtData['staff_agree']) : '' ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Hoàn thành thanh toán') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['finish_payment']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('note') ?>: </div>
                        ...
                        <div class="tab-panels">
                                ...
                                <div class="table-responsive">
                                    <table id="table-items" class="table dt-tnh table-hover table-condensed table-cs-border">
                                        ...
                                        <tr>
                                            ...
                                            <th><?= lang('Mã vật tư') ?></th>
                                            <th><?= lang('Tên vật tư') ?></th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left" style="width: 100px">
                                                        ...
                                                        <?php if ($value['result'] == 2){ ?>
                                                            <div class="text-center mtop5"><a target="_blank" href="<?=  base_url('admin/production_report/detail?object_id=' . $value['id'] . '&object_type=suggest_repalce_item') ?>" class="btn btn-info">Báo cáo không phù hợp</a></div>
                                                        <?php } ?>
                                                    </td>
                            ...
                            <section id="view-activity-log" class="tab-panel">
                                <div class="activity-container tnh-activity-log" style="max-height: 500px;">
                                    <?php
                                    $history = getActivityLogByObjId($dtData['id'], 'suggest_replace');
                                    ?>
        ...
        <div class="modal-footer">
            <a data-tnh="modal" class="tnh-modal hide click1"
               href=" <?= base_url() ?>admin/suggest_repalce/view/<?= $dtData['id'] ?>" data-toggle="modal"
...
<script type="text/javascript">
    function changeResult(_this,id){
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_repalce/changeResult',
            data: {
                id:id,
                result_id: $(_this).val(),
