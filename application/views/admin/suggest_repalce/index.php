    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestReplace): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_repalce/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-replace" class="table dt-tnh table-suggest-replace-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Hoàn Thành Thanh Toán') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-replace',
        '<?= site_url('admin/suggest_repalce/getSuggestReplaces') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_repalce/getSuggestReplaces') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_repalce_id, status) {
        var dataPOST = {};
        dataPOST[csrf_token_name] = hash;
        dataPOST['suggest_repalce_id'] = suggest_repalce_id;
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_repalce/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_repalce/exportExcel',
            data: {
