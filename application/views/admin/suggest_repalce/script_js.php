<script>
    ...
    ajaxSelectParams('#report_acceptance_id', 'admin/suggest_repalce/searchDeliveryRecords', $("#report_acceptance_id").val(), true, true);
    ...
    appValidateForm($('#suggest_replace'), {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.result) {
                    ...
                    window.location.href = site.base_url+'admin/suggest_repalce';
                } else {
