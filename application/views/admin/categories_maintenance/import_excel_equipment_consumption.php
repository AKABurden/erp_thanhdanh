        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?= base_url('uploads/template/Template_dinh_muc_thiet_bi.xlsx?vs=1.3') ?>">Download file mẫu</a>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'categories_maintenance/import_equipment_consumption/<?= $type ?>';
