    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestPurchaseNPL): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_purchase_npl/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest_purchase_npl" class="table dt-tnh table-suggest_purchase_npl-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Mã Yêu Cầu Mua') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest_purchase_npl',
        '<?= site_url('admin/suggest_purchase_npl/getSuggestPurchaseNpl') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_purchase_npl/getSuggestPurchaseNpl') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_purchase_npl/exportExcel',
            data: {
