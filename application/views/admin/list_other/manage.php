            ...
            <div class="_buttons">
                ...
                <?php if ($this->preAdd): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/list_other/detail/' . $type) ?>" class=" c_modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-list-other" class="table dt-tnh table-list-other" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?= lang('#') ?></th>
                                            <th class="text-center"><?= lang('Mã sản phẩm') ?></th>
                                            <th class="text-center"><?= lang('Tên sản phẩm') ?></th>
                                            <th class="text-center"><?= lang($name_colums['standard']) ?></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = initDataTableCustom('.table-list-other', admin_url + 'list_other/table/<?= $type ?>', [0], [0], CustomersServerParams, ['0', 'desc']);
    })
