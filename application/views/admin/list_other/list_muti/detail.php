<div id="list_other_modal" class="modal fade" role="dialog">
    <div class="modal-dialog modal-lg">
        <?php echo form_open(admin_url('list_other/detail_muti/' . $type . '/'.$filterType.'/' . (!empty($list_muti) ? $list_muti->{$columKey} : '')),
            ['id' => 'from_list_other']); ?>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 70%;">
                                        <?php if($v['type'] == 'input_select') {?>
                                            <input type="text" name="<?=$k?>" id="<?=$k?>" style="width: 100%;" value="<?= !empty($list_muti) ? $list_muti->{$k} : '' ?>" data-placeholder="<?= lang($v['label']) ?>">
                                            <?php $inputSelect[] = [
                                                    'id' => $k,
                                        ...
                                        <?php }
                                            ...
                                            $value = !empty($list_muti) ? $list_muti->{$k} : '';
