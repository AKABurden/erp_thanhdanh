            ...
            <div class="_buttons">
                ...
                <?php if ($this->preAdd): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/list_other/detail_other/' . $type) ?>" class=" c_modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-list-data-other" class="table dt-tnh table-list-data-other" style="width: 100%;">
                                    <thead>
                                        <tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = initDataTableCustom('.table-list-data-other', admin_url + 'list_other/table_other/<?= $type ?>', [0], [0], CustomersServerParams, ['0', 'desc']);
    })
