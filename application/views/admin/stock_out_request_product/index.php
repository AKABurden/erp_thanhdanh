        ...
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php //if (has_permission('spending_plan', '', 'create')) { ?>
                    ...
                    <a href="<?= admin_url('stock_out_request_product/submit') ?>" class="btn btn-info mright5 pull-right H_action_button">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <?php $table_data = array(
                            ...
                            _l('Ngày lập phiếu'),
                            _l('Mã phiếu'),
                            _l('tnh_reference_productions_orders'),
                            _l('note'),
                            _l('action'),
                        );
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = tnhInitDataTable('.table-tb-main', '', {
            ...
            'responsive': false,
            "ajax": {
                "url": site.base_url + 'admin/stock_out_request_product/',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/stock_out_request_product/export_excel',
            data: {
