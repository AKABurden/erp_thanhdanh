            ...
            <div class="horizontal-tabs">
               <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                  <li role="presentation" class="active">
                     <a href="#sales_statistics" onclick="sales_statistics(true);" aria-controls="sales_statistics" role="tab" data-toggle="tab">
                        <i class="fa fa-line-chart menu-icon"></i> <?php echo _l('sales_statistics'); ?>
                     </a>
                  </li>
               ...
               <div class="tab-content">
                  <div role="tabpanel" class="tab-pane active" id="sales_statistics">
                     <?php $this->load->view('admin/dashboard/widgets/dashbord_reports'); ?>
                  </div>
