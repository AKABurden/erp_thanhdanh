        ...
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php //if (has_permission('spending_plan', '', 'create')) { ?>
                    ...
                    <a href="<?= admin_url('spending_plan/submit') ?>" class="btn btn-info mright5 pull-right H_action_button tnh-modal" data-tnh="modal" data-toggle="modal" data-target="#myModal">
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = tnhInitDataTable('.table-tb-main', '', {
            ...
            'responsive': false,
            "ajax": {
                "url": site.base_url + 'admin/spending_plan/',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/spending_plan/export_excel',
            data: {
