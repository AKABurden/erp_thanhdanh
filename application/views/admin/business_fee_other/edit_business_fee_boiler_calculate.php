...
<?php echo form_open('admin/business_fee_other/edit_business_fee_boiler_calculate', array('id' => 'payroll')); ?>
<div id="wrapper">
                ...
                <div class="panel" style="margin-bottom: 3px;">
                    <div class="panel-body" style="padding: 0px;">
                        <div class="row" style="padding: 1px;display:flex">
                            ...
                            <div class="col-md-2">
                                <?= lang('year', 'year') ?>
                                <select name="year" id="year" class="selectpicker none-event" data-placeholder="<?= lang('year') ?>"
                            ...
                            <div class="col-md-2">
                                <?= lang('month', 'month') ?>
                                <select name="month" id="month" class="selectpicker none-event" data-placeholder="<?= lang('month') ?>"
                                        style="width: 100%;" style="width: 100%;">
...
<script>
    ...
    function loadBusinessFeeCalculateEdit() {
        month = $('#month').val();
        year = $('#year').val();
        ids = $('.ids').val();
        ...
        if (month && year) {
            $.ajax({
                type: "POST",
                url: site.base_url + 'admin/business_fee_other/loadBusinessFeeCalculateEdit',
                data: {
                    month: month,
                    year: year,
                    ids: ids,
