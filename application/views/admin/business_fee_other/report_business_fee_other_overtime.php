            ...
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="clearfix"></div>
                        <table id="table-overtime-report"
                               class="table dt-tnh table-overtime-report-new" style="">
                            <thead>
                            <tr>
                                ...
                                <th class="text-center"><?= lang('Thơi gian tăng ca') ?><br><?= lang('Từ giờ - Đến giờ') ?></th>
                                <th class="text-center"><?= lang('Số giờ tăng ca') ?></th>
                                <th class="text-center"><?= lang('Số giờ tăng ca (CN)') ?></th>
                                <th class="text-center"><?= lang('Số giờ tăng ca (LT)') ?></th>
                                <th class="text-center"><?= lang('Tổng TG tăng ca') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
...
<script>
    ...
    function loadTableNew() {
        oTable = tnhInitDataTable('#table-overtime-report',
            '<?= site_url('admin/business_fee_other/getOvertimeReport') ?>', {
                'order': [
                    [0, 'desc'],
                ],
                "ordering": false,
                "ajax": {
                    "url": '<?= site_url('admin/business_fee_other/getOvertimeReport') ?>',
                    "type": "POST",
                    "data": function (d) {
                    ...
                    "dataSrc": function (json) {
                        $('#table-overtime-report tfoot tr td:nth-child(7)').html('<div class="text-center">'+(json.totalWeekday)+'</div>');
                        $('#table-overtime-report tfoot tr td:nth-child(8)').html('<div class="text-center">'+(json.totalSunday)+'</div>');
                        $('#table-overtime-report tfoot tr td:nth-child(9').html('<div class="text-center">'+(json.totalHoliday)+'</div>');
                        $('#table-overtime-report tfoot tr td:nth-child(10)').html('<div class="text-center">'+(json.totalAll)+'</div>');
    ...
    $('#table-overtime-report').on('draw.dt', function () {
