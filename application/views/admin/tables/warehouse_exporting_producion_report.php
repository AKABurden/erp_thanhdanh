...
if (!empty($warehouse_id)) {
    array_push($where_exportsx, 'AND tbl_suggest_exporting_items.warehouse_item_id IN (' . implode(',', $warehouse_id).')');
}
if (!empty($type_items)) {
    if($type_items == 'nvl'){
...
$join_exportsx         = array(
    ...
    'LEFT JOIN tbl_productions_orders_details ON tbl_productions_orders_details.id = tbl_suggest_exporting.productions_orders_details_id',
    'LEFT JOIN tbl_productions_orders ON tbl_productions_orders.id = tbl_suggest_exporting.po_id',
    'LEFT JOIN tblwarehouse ON tblwarehouse.id = tbl_suggest_exporting_items.warehouse_item_id',
    ...
    'LEFT JOIN tbl_products ON tbl_products.id = tbl_suggest_exporting_items.item_id and ( tbl_suggest_exporting_items.type_item = "semi_products" OR tbl_suggest_exporting_items.type_item = "products")',
