                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-synthetic_plan_department" class="table dt-tnh table-synthetic_plan_department-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Chi Nhánh') ?></th>
                                        <th class="text-center"><?= lang('Phòng Ban') ?></th>
                                        <th class="text-center"><?= lang('Phiếu Yêu Cầu Kế Hoạch Phòng Ban') ?></th>
                                        <th class="text-center"><?= lang('Phiếu Đề Xuất Nội Bộ') ?></th>
                                        <th class="text-center"><?= lang('Số Ngày Chi') ?></th>
                                        <th class="text-center"><?= lang('Ngày Chi') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-synthetic_plan_department',
        '<?= site_url('admin/reports_purchase/getSyntheticPlanDepartment') ?>', {
            'order': [
                [0, 'desc']
            ],
            scrollX: true,
            "ajax": {
                "url": '<?= site_url('admin/reports_purchase/getSyntheticPlanDepartment') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/reports_purchase/exportExcelSyntheticPlanDepartment',
            data: {
