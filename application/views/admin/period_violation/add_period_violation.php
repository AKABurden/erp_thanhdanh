...
<?php echo form_open('admin/period_violation/add_period_violation', array('id' => 'period_violation')); ?>
<div id="wrapper">
            ...
            <div class="col-md-12">
                <div class="panel" style="margin-bottom: 3px;">
                    <div class="panel-body" style="padding: 0px;">
                        ...
                        <br>
                        <div class="col-md-12 view-table-period-violation" style="padding: 1px; margin-top: 10px">
...
<script>
    ...
    function loadPeriodViolation() {
        ...
        if (month && year && branch_search) {
            $.ajax({
                type: "GET",
                url: site.base_url + 'admin/period_violation/loadPeriodViolation',
                data: {
                    month: month,
                    year: year,
                ...
                success: function(response) {
                    if (response) {
                        $('.view-table-period-violation').html(response);
    ...
    appValidateForm($('#period_violation'), {
        month: 'required',
        year: 'required',
    }, db);
        ...
        $.ajax({
            ...
            .done(function(data) {
                if (data.result) {
                    ...
                    window.location.href = site.base_url + 'admin/period_violation';
                } else {
