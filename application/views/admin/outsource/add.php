...
<?php echo form_open('admin/outsource/add', array('id' => 'outsource')); ?>
<div id="wrapper">
                                    ...
                                    <td style="width: 35%;">
                                        <div class="form-group">
                                            <div class="input-group">
                                                <span title="<?= lang('tnh_referesh') ?>" data-toggle="tooltip"
                                                    class="input-group-addon btn btn-danger referesh-reference">
                                        ...
                                        <div class="input-group">
                                            <div class="form-group">
                                                <input type="text" name="supplies"
                                                    ...
                                                    class="supplies" required style="width: 100%;" value="">
                                            </div>
                                            <?php  if (has_permission('suppliers', '', 'create')) { ?>
                                            <span class="input-group-addon">
                                                <a href="javascript:void(0)"
                                                    onclick="int_suppliers_view_new('','true'); return false;"><i
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tabset">
                    ...
                    <!-- Tab 2 -->
                    <input type="radio" name="tabset" id="tab3" aria-controls="items-export">
                                ...
                                <table id="tb-deliveries" class="dt-tnh table table-bordered table-hover"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 100px;"><?= lang('Tên/Mã thành phẩm') ?></th>
                                            <th style="width: 50px"><?= lang('tnh_images') ?></th>
                                            <th style="width: 50px;"><?= lang('tnh_unit') ?></th>
                                            <th style="width: 100px;"><?= lang(' Công đoạn gia công') ?></th>
                                    ...
                                    <tfoot>
                                        <tr class="bold">
                                            ...
                                            <th></th>
                                            <th></th>
                                            <th class="th-quantity-processing text-center"></th>
                                            <th></th>
                                            <th class="th-subtotal text-right"></th>
                                            <th></th>
                                            <th></th>
                                        </tr>
                                    </tfoot>
