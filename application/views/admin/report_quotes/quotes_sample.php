...
<div class="text-center uppercase">
    <h2><?= lang('Báo giá phát triển mẫu/Chi tiết phát triển mẫu') ?></h2>
</div>
<hr>
<div class="row">
    <div class="col-md-2">
...
<script type="text/javascript">
    ...
    function loadTableReport() {
        _oTableReport.draw();
        getTotalQuotesSample();
    };

    function getTotalQuotesSample() {
        var dataGET = {};
        ...
        $.ajax({
            type: "GET",
            url: site.base_url + 'admin/report_quotes/getTotalQuotesSample',
            data: dataGET,
            dataType: "json",
            success: function(response) {
                $('#tong-bao-gia-phat-trien-mau').html(response?.count_quotes);
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        _oTableReport = tnhInitDataTable('#tb-reports', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/report_quotes/getQuotesSample') ?>',
                "type": "POST",
                "data": function(d) {
