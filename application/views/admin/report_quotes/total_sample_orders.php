...
<div class="text-center uppercase">
    <h2><?= lang('Tổng số mẫu đánh lần 2 3') ?></h2>
</div>
<hr>
<div class="row">
    <div class="col-md-2">
    ...
    <div class="col-md-3">
        <div class="tnh-card tnh-text-white tnh-bg-success o-hidden h-100" style="height: 80px;">
            <div class="tnh-card-body">
                ...
                <div class="tnh-h3">Tổng Số mẫu đánh lần 2 3<br>
...
<script type="text/javascript">
    ...
    function loadTableReport() {
        _oTableReport.draw();
        getTotalSampleOrders();
    };

    function getTotalSampleOrders() {
        var dataGET = {};
        ...
        $.ajax({
            type: "GET",
            url: site.base_url + 'admin/report_quotes/getTotalSampleOrders',
            data: dataGET,
            dataType: "json",
    ...
    $(document).ready(function() {
        ...
        _oTableReport = tnhInitDataTable('#tb-reports', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/report_quotes/getDetailQuotesOrders') ?>',
                "type": "POST",
                "data": function(d) {
