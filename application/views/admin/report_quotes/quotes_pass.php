    ...
    <div class="col-md-3">
        <div class="tnh-card tnh-text-white tnh-bg-success o-hidden h-100" style="height: 80px;">
            <div class="tnh-card-body">
                ...
                <div class="tnh-h3">Tổng báo giá đạt<br>
                    <span id="tong-bao-gia-dat">0</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function getTotalQuotesPass() {
        ...
        $.ajax({
            type: "GET",
            url: site.base_url + 'admin/report_quotes/getTotalQuotesPass',
            data: dataGET,
            dataType: "json",
            success: function(response) {
                $('#tong-bao-gia-dat').html(response?.count_quotes);
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        _oTableReport = tnhInitDataTable('#tb-reports', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/report_quotes/getQuotesPass') ?>',
                "type": "POST",
                "data": function(d) {
