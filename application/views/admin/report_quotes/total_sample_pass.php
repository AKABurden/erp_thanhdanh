...
<script type="text/javascript">
    ...
    function loadTableReport() {
        _oTableReport.draw();
        getCountRequestSamplePass();
    };

    function getCountRequestSamplePass() {
        var dataGET = {};
        ...
        $.ajax({
            type: "GET",
            url: site.base_url + 'admin/report_quotes/getCountRequestSamplePass',
            data: dataGET,
            dataType: "json",
            success: function(response) {
                $('#tong-so-mau-dat').html(tnhFormatNumber(response?.count_request_template));
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        _oTableReport = tnhInitDataTable('#tb-reports', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/report_quotes/getTotalRequestSamplePass') ?>',
                "type": "POST",
                "data": function(d) {
