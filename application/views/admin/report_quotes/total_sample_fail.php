...
<div class="text-center uppercase">
    <h2><?= lang('Tổng số mẫu không đạt') ?></h2>
</div>
<hr>
<div class="row">
    <div class="col-md-2">
    ...
    <div class="col-md-3">
        <div class="tnh-card tnh-text-white tnh-bg-success o-hidden h-100" style="height: 80px;">
            <div class="tnh-card-body">
                ...
                <div class="tnh-h3">Tổng số mẫu không đạt<br>
...
<script type="text/javascript">
    ...
    function loadTableReport() {
        _oTableReport.draw();
        getCountRequestSampleFail();
    };

    function getCountRequestSampleFail() {
        var dataGET = {};
        ...
        $.ajax({
            type: "GET",
            url: site.base_url + 'admin/report_quotes/getCountRequestSampleFail',
            data: dataGET,
            dataType: "json",
            success: function(response) {
                $('#tong-so-mau-khong-dat').html(tnhFormatNumber(response?.count_request_template));
            }
        });
    }
    ...
    $(document).ready(function() {
        ...
        _oTableReport = tnhInitDataTable('#tb-reports', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/report_quotes/getTotalRequestSampleFail') ?>',
                "type": "POST",
                "data": function(d) {
