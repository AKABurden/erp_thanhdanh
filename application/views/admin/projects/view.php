                        ...
                        <div class="row">
                            <div class="col-md-7 project-heading">
                                ...
                                <div id="project_view_name" class="pull-left">
                                    <select class="selectpicker" id="project_top"
                                            data-width="fit"<?php if (count($other_projects) > 6) { ?> data-live-search="true" <?php } ?>>
                            ...
                            <div class="col-md-5 text-right">
								...
								<?php if (has_permission('invoices', '', 'create')) { ?>
                                    <a href="#"
                                       ...
                                       class="invoice-project btn btn-info<?php if ($project->client_data->active == 0) {
										   echo ' disabled';
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right width200 project-actions">
										...
										<?php if (has_permission('projects', '', 'create') || has_permission('projects', '', 'edit')) { ?>
											...
											<?php foreach ($statuses as $status) {
                                                ...
                                                <li>
                                                    <a href="#"
                                                       data-name="<?php echo _l('project_status_' . $status['id']); ?>"
