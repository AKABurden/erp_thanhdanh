                    ...
                    <div class="panel-body">
                        ...
                        <div class="tab-content" id="tab_content_procadure">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <?php echo render_select('room_id', $room, ['id', 'name'], 'Phòng') ?>
                                </div>
                                <div class="col-md-3">
...
<script>
    ...
    $(function() {
        ...
        $.each(CustomersServerParams, function(filterIndex, filterItem) {
            $('' + filterItem).on('change', function() {
                ...
                if ($('[name="room_id"]').val() != '') {
                    room_id = '&filter[room_id]=' + $('[name="room_id"]').val();
                } else {
                    room_id = '';
                }
                view_table(date_start, date_end, role_id, customer, room_id);
            });
        });
    ...
    function view_table(date_start = '', date_end = '', role_id = '', customer = '', room_id = '') {
        $('#table_html').html('');
        $.get(admin_url + 'production_report/get_incident_tracking_table/?' + date_start + date_end + role_id + customer+room_id).done(function(response) {
