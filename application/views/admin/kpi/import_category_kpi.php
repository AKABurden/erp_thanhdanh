<?php echo form_open('admin/kpi/import_category_kpi/', array('id' => 'import_category_kpi')); ?>
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank" href="<?= base_url('uploads/import_dt/mau_import_nhom_kpi.xlsx?vs=1.1') ?>">Download
                        file mẫu</a>
...
<script>
    $(function () {
        appValidateForm($('#import_category_kpi'), {
            file: 'required',
        }, handling);
