                    ...
                    <div class="table-responsive">
                        <table id="table_detail_production_report" class="table table-hover dataTable dont-responsive-table" style="width: 100%;">
                            ...
                            <tr style="">
                                ...
                                <th style="width: 100px;background-color: #D9F5D6 !important;" class="text-center"><?= lang('Vi Phạm') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    oTable = tnhInitDataTable('#table_detail_production_report', '<?= site_url('admin/kpi/getDetailProductionReport') ?>', {
        'order': [
            [0, 'desc']
        ],
        "ajax": {
            "url": '<?= site_url('admin/kpi/getDetailProductionReport') ?>',
            "type": "POST",
            "data": function(d) {
