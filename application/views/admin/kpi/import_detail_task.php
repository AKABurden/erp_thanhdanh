<?php echo form_open('admin/kpi/import_detail_task/', array('id' => 'import_detail_task')); ?>
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank" href="<?= base_url('uploads/import_dt/mau_import_mo_ta_cong_viec_theo_vị_tri.xlsx?vs=1.1') ?>">Download
                        file mẫu</a>
...
<script>
    $(function () {
        appValidateForm($('#import_detail_task'), {
            file: 'required',
        }, handling);
