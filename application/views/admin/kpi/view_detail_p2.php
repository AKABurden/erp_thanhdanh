            ...
            <div class="row">
                <div class="col-md-12 mtop10">
                    ...
                    <div class="table-responsive">
                        <table id="table_detail_p2" class="table table-hover dataTable dont-responsive-table" style="width: 100%;">
                            <thead>
                            <tr style="">
                                ...
                                <th style="width: 100px;background-color: #D9F5D6 !important;" class="text-center"><?= lang('Trọng số') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    oTable = tnhInitDataTable('#table_detail_p2', '<?= site_url('admin/kpi/table_detail_p2') ?>', {
        'order': [
            [0, 'desc']
        ],
        "ajax": {
            "url": '<?= site_url('admin/kpi/table_detail_p2') ?>',
            "type": "POST",
            "data": function(d) {
