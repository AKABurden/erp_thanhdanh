            ...
            <div class="row">
                <div class="col-md-12 mtop10">
                    ...
                    <div class="table-responsive">
                        <table id="table_detail_p3" class="table table-hover dataTable dont-responsive-table" style="width: 100%;">
                            <thead>
                            <tr style="">
                                ...
                                <th style="width: 100px;background-color: #D9F5D6 !important;" class="text-center"><?= lang('Trạng thái') ?></th>
                            </tr>
                            </thead>
                            <tbody>
                            </tbody>
...
<script type="text/javascript">
    ...
    oTable = tnhInitDataTable('#table_detail_p3', '<?= site_url('admin/kpi/getDetailP3') ?>', {
        'order': [
            [0, 'desc']
        ],
        "ajax": {
            "url": '<?= site_url('admin/kpi/table_detail_p3') ?>',
            "type": "POST",
            "data": function(d) {
