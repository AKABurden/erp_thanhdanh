<?php echo form_open('admin/kpi/import_list_criteria_department/', array('id' => 'import_list_criteria_department')); ?>
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank" href="<?= base_url('uploads/import_dt/mau_import_muc_tieu_kpi_phong_ban_vs1.xlsx?vs=1.4') ?>">Download
                        file mẫu</a>
                </div>
                <div class="col-md-12">
...
<script>
    $(function() {
        ...
        appValidateForm($('#import_list_criteria_department'), {
            file: 'required',
        }, handling);
