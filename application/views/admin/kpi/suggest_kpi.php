    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->perAddSuggestKpi): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/kpi/detail_suggest_kpi') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('Tạo mới'); ?>
                        </a>
                    </div>
                <?php endif ?>
                            ...
                            <div class="">
                                <table id="table-suggest-kpi" class="table dt-tnh table-suggest-kpi" style="width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Ngày Phiếu Yêu Cầu') ?></th>
                                        <th class="text-center"><?= lang('Mã Phiếu Yêu Cầu') ?></th>
                                        <th class="text-center"><?= lang('Người Yêu Cầu Đánh Giá') ?></th>
