...
<script id="code">
    ...
    $(function(){
        ...
        tAPI = initDataTableCustom('.table-purchase-order', admin_url+'purchase_order/table', [0], [0], CustomersServerParams,<?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(1,'desc'))); ?>, fixedColumns = {leftColumns: 5, rightColumns: 0}, false, true);
        $.each(CustomersServerParams, function(filterIndex, filterItem){
          $('' + filterItem).on('change', function(){
            tAPI.draw('page')
          });
        });
        tAPI.columns(0).visible(false, false);
        tAPI.columns(12).visible(false, false);
        tAPI.columns(13).visible(false, false);
    });
</script>