	...
	<div class="modal-dialog modal-xl">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="report_debt <?php if ($openEdit == 'true') {
											echo 'hide ';
										} ?>">
				...
				<div class="edit <?php if ($openEdit != 'true') {
										echo 'hide ';
									} ?>">
							...
							<div class="col-md-12">
								...
								<div class="wap-right" style="height: 500px;">
									...
									<div class="fieldset active" role-fieldset="1">
										...
										<div class="clearfix"></div>
										<div class="col-md-6">
											<?php $abbreviation = (isset($suppliers) ? $suppliers->abbreviation : ''); ?>
											<?php echo render_input('abbreviation', lang('Tên viết tắt'), $abbreviation); ?>
										</div>
										<div class="col-md-6">
											<?php $date_begin = (isset($suppliers) ? $suppliers->date_begin : ''); ?>
											<?php echo render_date_input('date_begin', lang('Ngày bắt đầu hoạt động'), $date_begin); ?>
										</div>
										<div class="clearfix"></div>
										<div class="col-md-6">
										...
										<div class="clearfix"></div>
										<div class="col-md-6">
											<?php $representative = (isset($suppliers) ? $suppliers->representative : ''); ?>
											<?php echo render_input('representative', 'client_representative', $representative); ?>
										</div>
										<div class="col-md-6">
										...
										<div class="clearfix"></div>
										<div class="col-md-6">
											<?php $renewal_date = (isset($suppliers) ? _d($suppliers->renewal_date) : ''); ?>
											<?php echo render_date_input("renewal_date", 'ch_renewal_date', $renewal_date); ?>
										</div>
										<div class="col-md-6">
											<?php $type_suppliers = (isset($suppliers) ? $suppliers->type_suppliers : ''); ?>
                                            <?php echo render_select('type_suppliers', $supplierClassify, array('id', 'name'), 'Chọn phân loại', $type_suppliers); ?>
										</div>
										<!-- ===== -->
										<div class="clearfix"></div>
										<div class="col-md-6">
											<?php $tax = (isset($suppliers) ? $suppliers->tax : ''); ?>
											<?php echo render_input('tax', 'VAT', $tax); ?>
										</div>
										<div class="col-md-6">
											<?php $code_nxk = (isset($suppliers) ? $suppliers->code_nxk : ''); ?>
											<?php echo render_input('code_nxk', 'ch_code_nxk', $code_nxk); ?>
										</div>
										<!-- ===== -->
										...
										<div class="col-md-6">
											<?php
											$selected = array();
											if (isset($branch_suppliers)) {
												foreach ($branch_suppliers as $value) {
										...
										<div class="col-md-6 col-xs-12">
                                            <?php $debt_begin = (isset($suppliers) ? number_format($suppliers->debt_begin) : 0); ?>
                                            <?php echo render_input('debt_begin', 'Công nợ đầu kì', $debt_begin, '', array('onchange' => "formatNumBerKeyUpCus(this)")); ?>
                                        </div>
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->quality_standards : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->certification : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->packing_regulations : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->package_specifications : ''); ?>
											<div class="form-group">
												<?= lang('Thông số kiện', 'package_specifications') ?>
												<input type="text" name="package_specifications" placeholder="<?= lang('Thông số kiện') ?>" id="package_specifications" class="form-control package_specifications" value="<?= $value ?>">
											</div>
										</div>
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->cost_id : ''); ?>
											<?php echo render_select('cost_id', $costs, array('id', 'name'), '
											Mã khoản/Nhóm chi phí', $value); ?>
										</div>
										<div class="row ">
											<div class="col-md-12">
												<div class="col-md-6 col-xs-12">
													<?php $value = (isset($suppliers) ? $suppliers->price_list_approval : ''); ?>
													<div class="form-group">
												...
												<div class="col-md-6 col-xs-12">
													<?php $value = (isset($suppliers) ? $suppliers->tm_ck : ''); ?>
													<div class="form-group mbot5">
														<?= lang('tnh_tm_ck', 'tm_ck') ?>
														<div style="display: flex;">
															<div class="radio radio-primary">
																<input type="radio" name="tm_ck" id="tm_ck_1" value="1" <?= !isset($suppliers) ? 'checked="checked"' : ($suppliers->tm_ck == 1 ? 'checked="checked"' : '') ?>>
																<label for="tm_ck_1"><?= lang('tnh_tm') ?></label>
															</div>
															<div class="radio radio-primary" style="margin-top: 10px; margin-left: 10px;">
																<input type="radio" name="tm_ck" id="tm_ck_2" <?= isset($suppliers) && $suppliers->tm_ck == 2 ? 'checked="checked"' : '' ?> value="2">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->time_payment : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->bank_account : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->name_account : ''); ?>
											<div class="form-group">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->name_account : ''); ?>
											<div class="form-group">
												<?= lang('ch_address_bank', 'address_bank') ?>
												<input type="text" name="address_bank" placeholder="<?= lang('ch_address_bank') ?>" id="address_bank" class="form-control address_bank" value="<?= $value ?>">
											</div>
										</div>
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->contract_number : ''); ?>
											<div class="form-group">
												<?= lang('ch_contract_number', 'contract_number') ?>
												<input type="text" name="contract_number" placeholder="<?= lang('ch_contract_number') ?>" id="contract_number" class="form-control contract_number" value="<?= $value ?>">
											</div>
										</div>
                                        <div class="col-md-6 col-xs-12">
                                            <?php $value = (isset($suppliers) ? _d($suppliers->deadline_contract) : ''); ?>
                                            <div class="form-group">
                                                <?= lang('Thời hạn hợp đồng', 'deadline_contract') ?>
                                                <div class="input-group date">
                                                    <input type="text" name="deadline_contract"
                                                       placeholder="<?= lang('Thời hạn hợp đồng') ?>"
                                                       id="deadline_contract" class="form-control datepicker" value="<?= $value ?>">
										...
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->number_contract : ''); ?>
											<div class="form-group">
												<?= lang('Hợp đồng số', 'number_contract') ?>
												<input type="text" name="number_contract" placeholder="<?= lang('Hợp đồng số') ?>" id="number_contract" class="form-control number_contract" value="<?= $value ?>">
											</div>
										</div>
										<div class="col-md-6 col-xs-12">
											<?php $value = (isset($suppliers) ? $suppliers->discount_id : ''); ?>
											<?php echo render_select('discount_id', $listDiscount, array('id', 'name'), 'Chiết khấu', $value); ?>
										</div>
										<!-- onkeyup="formatNumBerKeyUp(this)" -->
										<!-- <div class="col-md-6">
											<?php $address_delivery = (isset($suppliers) ? $suppliers->address_delivery : ''); ?>
											<?php echo render_textarea('address_delivery', 'ch_address_delivery', $address_delivery); ?>
										</div> -->
										<div class="col-md-6">
										...
										<?php if (!isset($suppliers)) { ?>
											<div class="col-md-12">
												<div class="checkbox checkbox-primary checkbox-templates">
													<input type="checkbox" <?= (isset($suppliers) ? ($suppliers->type == 1 ? 'checked' : '') : '') ?> class="field_client" id="type" name="type" value="1">
													...
													<div class="col-md-6">
														<div class="col-md-12 new_contact_form">
															...
															<div class="col-md-6 form-group">
																<input type="checkbox" value="1" <?php if ($value['receive_email'] == 1) {
																										echo 'checked';
																									} ?> name="contact[<?= $key ?>][receive_email]"><?= _l('get_email') ?>
															</div>
															<div class="col-md-6 form-group">
																<input type="checkbox" value="1" <?php if ($value['main_contact'] == 1) {
																										echo 'checked';
																									} ?> name="contact[<?= $key ?>][main_contact]"><?= _l('key_contact') ?>
															</div>
														</div>
													</div>
												<?php }
				...
				<div class="view <?php if ($openEdit == 'true') {
										echo 'hide ';
									} ?>">
					<div class="modal-body">
						<ul class="nav nav-tabs" role="tablist">
										...
										<div class="wap-right">
											<div class="fieldset active" role-fieldset="1">
												<div class="wap-content second">
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->type != 0 ? _l('tnh_transporters') : '') ?></span>
												</div>
												...
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo lang('Tên viết tắt'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->abbreviation != '' ? $suppliers->abbreviation : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo lang('Ngày bắt đầu hoạt động'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->date_begin != '' ? _d($suppliers->date_begin) : '-') ?></span>
												</div>
												<div class="wap-content firt">
												...
												<div class="wap-content second">
													...
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->tax != '' ? $suppliers->tax : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('ch_code_nxk'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->code_nxk != '' ? $suppliers->code_nxk : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('ch_renewal_date'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->renewal_date != '' ? _d($suppliers->renewal_date) : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('ch_type_suppliers'); ?>: </span>
                                                    <?php $dtSupplierClassif = get_table_where('tblsupplier_classify',['id' => $suppliers->type_suppliers],'','row_array') ?>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && $suppliers->type_suppliers != '' ? (!empty($dtSupplierClassif) ? $dtSupplierClassif['name'] : '') : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('invoice_add_edit_currency'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && !empty($suppliers->default_currency) ? $suppliers->default_currency : '-') ?></span>
												</div>
												<div class="wap-content firt">
												...
												<div class="wap-content second">
                                                    <span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('Công nợ đầu kì'); ?>: </span>
                                                    <span class="bold font-medium-xs"><?php echo (isset($suppliers) && !empty($suppliers->debt_begin) ? number_format($suppliers->debt_begin) : '-') ?></span>
                                                </div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('Chi nhánh'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) && !empty($branch_suppliers_name_html) ? $branch_suppliers_name_html : '-') ?></span>
												</div>
												<div class="wap-content firt">
												...
												<div class="wap-content second">
													...
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->quality_standards : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_certification'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->certification : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_packing_regulations'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->packing_regulations : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo lang('Thông số kiện'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->package_specifications : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo lang('Mã khoản/Nhóm chi phí'); ?>: </span>
													<span class="bold font-medium-xs"><?php 
														if (isset($suppliers)) {
															$data_cost = get_table_where('tblcosts', array('id' => $suppliers->cost_id), '', 'row_array');
															echo (!empty($data_cost) ? $data_cost['code'].'/'.$data_cost['name'] : '-');
														} else {
															echo '-';
														}
													?></span>
												...
												<div class="wap-content firt">
													...
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->price_list_approval : '-') ?></span>
												</div>

												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_tm_ck'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers) ? ($suppliers->tm_ck == 1 ? lang('tnh_tm') : ($suppliers->tm_ck == 2 ? lang('tnh_ck') : '-')) : '-') ?></span>
												</div>

												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_time_payment'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->time_payment : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_bank_account'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->bank_account : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_name_account'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->name_account : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('ch_address_bank'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->address_bank : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('ch_contract_number'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->contract_number : '-') ?></span>
												</div>
												<div class="wap-content firt">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo lang('Hợp đồng số'); ?>: </span>
													<span class="bold font-medium-xs"><?php echo (isset($suppliers)   ? $suppliers->number_contract : '-') ?></span>
												</div>
												<div class="wap-content second">
													<span class="text-muted lead-field-heading no-mtop bold"><?php echo _l('tnh_discount'); ?>: </span>
													<?php
														$rowDiscount = !empty($suppliers) ? $this->site_model->rowDiscount($suppliers->discount_id) : '';
													?>
			...
			<div class="modal-footer mtop10">
				...
				<button group="submit" id="view_submit" class="bt-view btn btn-info <?php if ($openEdit != 'true') {
																						echo 'hide ';
																					} ?>" onclick="sumbit()"><?php echo _l('submit'); ?></button>
			</div>
			<?php echo form_close(); ?>
		</div>
	</div>
...
<script type="text/javascript">
	function sumbit() {
		...
		setTimeout(function() {
			checkValidateForm_suppliers();
			$('#view_submit').button('reset');
		}, 500);
	}
	appValidateForm($('#suppliers-add-from'), {
		...
		company: {
			required: true,
			remote: {
				url: admin_url + "misc/suppliers_company_exists",
				type: 'post',
				data: {
					email: function() {
						return $('#suppliers-add-from input[name="company"]').val();
					},
					userid: function() {
	...
	<?php if (!empty($suppliers)) { ?>
		$('#items_combo').on('change', function(e) {
			...
			$.post(admin_url + 'suppliers/mainstream_items/<?= $suppliers->id ?>', {
				id_items: items_combo,
				type: type,
				[csrfData['token_name']]: csrfData['hash']
			}, function(data) {
	...
	function delete_items(id) {
		...
		if (r == false) {
			...
			$.post(admin_url + 'suppliers/delete_items/' + id, {
				[csrfData['token_name']]: csrfData['hash']
			}, function(data) {
