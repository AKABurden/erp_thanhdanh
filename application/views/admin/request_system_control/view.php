            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Loại Hệ Thống') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['type_system']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Phân Hệ') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['subsystem']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Danh Mục Hệ Thống') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['system']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Nhóm Hệ Thống') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['category_system'] ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Chi Tiết') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['detail_system'] ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            ...
                            <div class="ml-at t-bold"><?= get_staff_full_name($dtData['staff_request']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Người Tiếp Nhận') ?>: </div>
                            <div class="ml-at t-bold"><?= get_staff_full_name($dtData['staff_tn']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Người Hoàn Thành') ?>: </div>
                            <div class="ml-at t-bold"><?= get_staff_full_name($dtData['staff_ht']) ?></div>
                        </div>
                        <div class="row-contro">
