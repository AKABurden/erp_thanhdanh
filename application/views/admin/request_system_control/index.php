...
<style type="text/css">
    ...
    #table-request_system_control tr th:nth-child(2) {
        width: 100px;
    }

    #table-request_system_control tr th:nth-child(7) {
        width: 80px;
    }
    #table-request_system_control tr th:nth-child(9) {
        width: 100px;
    }
    #table-request_system_control tr th:nth-child(10) {
        width: 250px;
    }
</style>
    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestSystemControl) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_system_control/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-request_system_control" class="table dt-tnh table-request_system_control-new" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th class="text-center"><?= lang('STT') ?></th>
                                                <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                                <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                                <th class="text-center"><?= lang('Loại Hệ Thống') ?></th>
                                                <th class="text-center"><?= lang('Phân Hệ') ?></th>
                                                <th class="text-center"><?= lang('Danh Mục Hệ Thống') ?></th>
                                                <th class="text-center"><?= lang('Nhóm Hệ Thống') ?></th>
                                                <th class="text-center"><?= lang('Chi Tiết') ?></th>
                                                <th class="text-center"><?= lang('Người Yêu Cầu') ?></th>
                                                <th class="text-center"><?= lang('Người Tiếp Nhận') ?></th>
                                                <th class="text-center"><?= lang('Người Hoàn Thành') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-request_system_control',
        '<?= site_url('admin/request_system_control/getRequestSystemControl') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/request_system_control/getRequestSystemControl') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_system_control/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_system_control/exportExcel',
            data: {
