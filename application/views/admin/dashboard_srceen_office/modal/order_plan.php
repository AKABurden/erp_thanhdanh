<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= ($type == 1) ? lang('Kế hoạch đơn hàng chưa tạo giao hàng') : lang('Kế hoạch đơn hàng chưa duyệt') ?></h4>
        </div>
        <div class="modal-body">
            <style>

            </style>
            <table class="table table-order_plan dataTable ">
                <thead>
                    <tr>
                        <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                        <th class="text-center"><?= ucwords(_l('Ngày tạo')); ?></th>
                        <th class="text-center"><?= ucwords(_l('Mã đơn hàng')); ?></th>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-order_plan', '<?= base_url('dashboard_srceen_vp/table_order_plan/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>