...
<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-suggest_plan_purchase dataTable ">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?= ucwords(_l('Nhân viên lập')); ?></th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-suggest_plan_purchase', '<?= base_url('dashboard_srceen_vp/table_suggest_plan_purchase/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>