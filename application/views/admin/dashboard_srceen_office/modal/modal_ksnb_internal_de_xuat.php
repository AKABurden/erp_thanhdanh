<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_ksnb_internal_de_xuat dataTable" id="table_ksnb_internal_de_xuat">
                <thead>
                <tr>
                    <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Ngày')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Mã phiếu')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Nhóm đề xuất')); ?></th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_ksnb_internal_de_xuat', '<?= base_url('dashboard_srceen_office/getDetailModalKsnbInternalDeXuat?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
