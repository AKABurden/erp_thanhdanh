<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_qa_outsource dataTable" id="table_qa_outsource">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_qa_outsource', '<?= base_url('dashboard_srceen_office/getDetailModalQaOutsource?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
