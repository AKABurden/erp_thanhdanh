<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_hcns_production dataTable" id="table_hcns_production">
                <thead>
                <tr>
                    <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Ngày')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Mã phiếu')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Mã sản phẩm')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Tên sản phẩm')); ?></th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_hcns_production', '<?= base_url('dashboard_srceen_office/getDetailModalHcnsProduction?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
