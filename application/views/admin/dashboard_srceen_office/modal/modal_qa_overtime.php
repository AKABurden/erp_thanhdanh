<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_qa_overtime dataTable" id="table_qa_overtime">
                <thead>
                <tr>
                    <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Ngày')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Tên phiếu')); ?></th>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_qa_overtime', '<?= base_url('dashboard_srceen_office/getDetailModalQaOvertime?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
