<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title"><?= lang('Đơn chưa mở lệnh sản xuất') ?></h4>
        </div>
        <div class="modal-body">
            <style>

            </style>
            <table class="table table-open_production dataTable ">
                <thead>
                    <tr>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-open_production', '<?= base_url('dashboard_srceen_vp/table_open_production/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>