<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_technial_maintenance dataTable" id="table_technial_maintenance">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_technial_maintenance', '<?= base_url('dashboard_srceen_office/getDetailModalTechnialMaintenance?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
