<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-accounting_delivery dataTable ">
                <thead>
                    <tr>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-accounting_delivery', '<?= base_url('dashboard_srceen_vp/table_accounting_delivery/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>