<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_ksnb_overtime dataTable" id="table_ksnb_overtime">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_ksnb_overtime', '<?= base_url('dashboard_srceen_office/getDetailModalKsnbOvertime?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
