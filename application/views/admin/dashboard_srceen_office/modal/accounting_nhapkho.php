<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-accounting_nhapkho dataTable ">
                <thead>
                    <tr>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-accounting_nhapkho', '<?= base_url('dashboard_srceen_vp/table_accounting_nhapkho/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>