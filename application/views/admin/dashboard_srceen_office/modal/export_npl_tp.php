<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-export_npl_tp dataTable ">
                <thead>
                    <tr>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-export_npl_tp', '<?= base_url('dashboard_srceen_vp/table_export_npl_tp/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>