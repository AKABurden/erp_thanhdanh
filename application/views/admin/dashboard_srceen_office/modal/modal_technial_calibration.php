<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_technial_calibration dataTable" id="table_technial_calibration">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_technial_calibration', '<?= base_url('dashboard_srceen_office/getDetailModalTechnialCalibration?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
