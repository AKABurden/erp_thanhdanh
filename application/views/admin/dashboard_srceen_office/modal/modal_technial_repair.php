<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_technial_repair dataTable" id="table_technial_repair">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_technial_repair', '<?= base_url('dashboard_srceen_office/getDetailModalTechnialRepair?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
