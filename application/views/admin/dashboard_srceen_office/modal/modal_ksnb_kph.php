<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_ksnb_kph dataTable" id="table_ksnb_kph">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_ksnb_kph', '<?= base_url('dashboard_srceen_office/getDetailModalKsnbKPH?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
