<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_technial_rating_machines dataTable" id="table_technial_rating_machines">
                <thead>
                <tr>
                    <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Ngày')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Mã phiếu')); ?></th>
                    <th class="text-center"><?= ucwords(_l('Nội dung bảo trì')); ?></th>
                </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_technial_rating_machines', '<?= base_url('dashboard_srceen_office/getDetailModalTechnialRatingMachines?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
