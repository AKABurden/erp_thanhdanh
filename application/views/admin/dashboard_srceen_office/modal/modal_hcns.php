<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table_hcns dataTable" id="table_hcns">
                <thead>
                <tr>
...
<script>
    $(document).ready(function() {
        ...
        oTable = initDataTable_ch('.table_hcns', '<?= base_url('dashboard_srceen_office/getDetailModalHcns?csrf_protection=true') ?>', [0], [0], fnserverparams, [0, 'desc']);
