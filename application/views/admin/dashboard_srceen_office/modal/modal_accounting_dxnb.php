<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-accounting_dxnb dataTable ">
                <thead>
                    <tr>
                        ...
                        <th class="text-center"><?= ucwords(_l('Nhân viên đề xuất')); ?></th>
                        <th class="text-center"><?= ucwords(_l('Quy trình')); ?></th>
                    </tr>
                </thead>
                <tbody></tbody>
            </table>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-accounting_dxnb', '<?= base_url('dashboard_srceen_vp/table_accounting_dxnb/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>