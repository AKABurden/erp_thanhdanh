    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestPlanRecruitment): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_plan_recruitment/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-plan-recruitment" class="table dt-tnh table-suggest-plan-recruitment" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Nhóm Kế Hoạch') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-plan-recruitment',
        '<?= site_url('admin/suggest_plan_recruitment/getSuggestPlanRecruitment') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_plan_recruitment/getSuggestPlanRecruitment') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_plan_recruitment/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_plan_recruitment/exportExcel',
            data: {
