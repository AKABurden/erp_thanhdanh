				...
				<div class="col-md-12">
					<div class="form-group">
						<div class="checkbox checkbox-info">
							<input type="checkbox" <?= $category['recipe'] ? 'checked' : '' ?> name="recipe" id="recipe" value="1">
							<label for="recipe"><?= lang('tnh_recipe') ?></label>
						</div>
						<div class="text-danger">(Giá nhập NVL x Hight x Wieght )/10000</div>
					</div>
				</div>
				<div class="col-md-12">
					<div class="form-group">
						<div class="checkbox checkbox-info">
							<input type="checkbox" <?= $category['is_vtsx'] ? 'checked' : '' ?> name="is_vtsx" id="is_vtsx" value="1">
							<label for="is_vtsx"><?= lang('Vật tư sản xuất') ?></label>
						</div>
					</div>
				</div>
				<div class="col-md-12">
