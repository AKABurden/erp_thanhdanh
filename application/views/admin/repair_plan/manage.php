    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRepairPlan) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/repair_plan/detail') ?>" class="c_modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-repair-plan" class="table dt-tnh table-repair-plan" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th class="text-center"><?= lang('STT') ?></th>
                                                <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                                <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                                <th class="text-center"><?= lang('Đơn vị bảo dưỡng') ?></th>
                                                <th class="text-center"><?= lang('Nhóm bảo dưỡng') ?></th>
                                                <th class="text-center"><?= lang('Bộ Phận bảo dưỡng') ?></th>
                                                ...
                                                <th class="text-center"><?= lang('Người đề nghị') ?></th>
...
<script>
    ...
    $(function() {
        oTable = initDataTable('.table-repair-plan', admin_url + 'repair_plan/table', [0], [0], filterList, [0, 'desc']);
    })
    
    $(document).on('change', '#end_date_search, #start_date_search',
        function(
            event) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/repair_plan/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/repair_plan/exportExcel',
            data: {
