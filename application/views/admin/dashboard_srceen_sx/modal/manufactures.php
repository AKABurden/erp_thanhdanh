<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-manufactures dataTable ">
                <thead>
                    <tr>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-manufactures', '<?= base_url('dashboard_srceen/table_manufactures/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>