<div class="modal-dialog modal-lg" style="width: 100%; max-width: 70vw;">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <table class="table table-delivery dataTable ">
                <thead>
                    <tr>
                        <th class="text-center"><?= ucwords(_l('STT')); ?></th>
                        <th class="text-center"><?= ucwords(_l('Ngày tạo')); ?></th>
                        <th class="text-center"><?= ucwords(_l('Mã đơn')); ?></th>
...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTable_ch('.table-delivery', '<?= base_url('dashboard_srceen/table_delivery/' . $type . '?csrf_protection=true') ?>', [0], [0], CustomersServerParams, [1, 'desc']);
    });
</script>