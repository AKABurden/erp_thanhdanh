                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            ...
                            <div class="ml-at t-bold"><?= $dtData['name_staff'] ?></div>
                        </div>
                        <div class="row-contro">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Mức lương cơ bản') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['salary']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Mức lương BHXN') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['salary_bhxh']) ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <div><?= lang('BHXH') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['bhxh_salary']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('BHTN') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['bhtn_salary']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('BHYT') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['bhyt_salary']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Công đoàn') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['union_salary']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Tổng cộng') ?>: </div>
