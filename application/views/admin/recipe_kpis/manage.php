    ...
    <div class="panel_s mbot10 H_scroll">
        <div class="panel-body _buttons">
            ...
            <div class="pull-right mright5 H_border">
                <a href="<?= base_url('admin/recipe_kpis/modal_excel/') . $type ?>" class="btn btn-info pull-right mright10 H_action_button c_modal">
                    <i class="fa fa-upload" style="display: initial;" aria-hidden="true"></i>
                    <?php echo _l('IMPORT EXCEL'); ?>
                </a>
                <a href="<?= base_url('admin/recipe_kpis/handling/0/') . $type ?>" class="btn btn-info H_action_button tnh-modal">
                    <?php echo _l('add'); ?>
                </a>
            </div>
        </div>
                            ...
                            <table id="table-standard" class="table table-hover table-standard dataTable" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Mã nhóm KPIs') ?></th>
                                        <th class="text-center"><?= lang('Tên nhóm KPIs') ?></th>
                                        <th class="text-center"><?= lang('KPIs') ?></th>
                                        <th class="text-center"><?= lang('Target') ?></th>
                                        <th class="text-center"><?= lang('Trọng số (%)') ?></th>
                                        <th class="text-center"><?= lang('Công Thức Quy Đổi') ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        oTable = tnhInitDataTable('#table-standard', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/recipe_kpis/getRecipe_kpis') ?>',
                "type": "POST",
                "data": function(d) {
