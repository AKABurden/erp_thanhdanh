                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-probationary-evaluate" class="table dt-tnh table-probationary-evaluate-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-probationary-evaluate',
        '<?= site_url('admin/probationary_evaluate/getProbationaryEvaluate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/probationary_evaluate/getProbationaryEvaluate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    <?php if ($this->type == 2){ ?>
    oTable.columns(7).visible(false, false);
