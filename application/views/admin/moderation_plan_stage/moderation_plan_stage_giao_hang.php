                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation-plan-stage-giao-hang" class="table dt-tnh table-moderation-plan-stage-giao-hang-new" style="width:2200px;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-plan-stage-giao-hang',
        '<?= site_url('admin/moderation_plan_stage/getModerationPlanStagesGiaoHang') ?>', {
            'order': [
                [0, 'desc']
            ],
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation_plan_stage/getModerationPlanStagesGiaoHang') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation-plan-stage-giao-hang').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateModerationPlanStageGiaoHang(_this,po_id,item_id,type_productionlist_id,order_id,stage_id,name){
        var dataPOST = {};
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/moderation_plan_stage/updateModerationPlanStageGiaoHang',
            data: dataPOST,
            dataType: "json",
