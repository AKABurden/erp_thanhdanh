<script>
    ajaxSelectParams('#pod_id', 'admin/suggest_ticket_purchase_products/searchPod', $("#pod_id").val(), true, true);
    $("#branch_id").select2();
    $("#employee_id").select2();
    ajaxSelectCallBack($('#items_search'), 'admin/suggest_ticket_purchase_products/searchProductsSelect2', 0);
    ...
    appValidateForm($('#suggest_ticket_purchase_product'), {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.result) {
                    ...
                    window.location.href = site.base_url+'admin/suggest_ticket_purchase_products';
                } else {
