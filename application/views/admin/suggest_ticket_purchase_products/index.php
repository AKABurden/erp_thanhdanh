    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestTicketPurchaseProduct): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_ticket_purchase_products/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-ticket-purchase-product" class="table dt-tnh table-suggest-ticket-purchase-product-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Mã Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Mã Lệnh SX') ?></th>
                                        <th class="text-center"><?= lang('Mã Đơn Hàng') ?></th>
                                        <th class="text-center"><?= lang('Ngày Nhập') ?></th>
                                        <th class="text-center"><?= lang('Trạng thái') ?></th>
                                        <th class="text-center"><?= lang('Người Phụ Trách Kiểm') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-ticket-purchase-product',
        '<?= site_url('admin/suggest_ticket_purchase_products/getSuggestTicketPurchaseProducts') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_ticket_purchase_products/getSuggestTicketPurchaseProducts') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_purchase_id, status,) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_ticket_purchase_products/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_ticket_purchase_products/exportExcel',
            data: {
