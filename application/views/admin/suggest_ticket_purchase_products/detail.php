...
<?php echo form_open('admin/suggest_ticket_purchase_products/detail/' . $id . '',
    array('id' => 'suggest_ticket_purchase_product')); ?>
<div id="wrapper">
...
<?php $this->load->view('admin/suggest_ticket_purchase_products/script_js.php') ?>
