...
<?php echo form_open('admin/production_order_request/submit/' . ($id ?? '') . '', array('id' => 'submit_form')); ?>
<div>
                            ...
                            <?php $counter = 0; if(!empty($value['items'])) {
                                foreach($value['items'] as $itemRow => $itemValue) {
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="time_norm text-right"><input name="time_norm[<?= $counter ?>]" class="time_norm form-control" type="text" value="<?= $itemValue['time_norm'] ?>"></div></td>
...
<script type="text/javascript">
    ...
    function loadItem(item = {}){
        ...
        timeNorms = `<div class="time_norm text-right"><input name="time_norm[${counter}]" class="time_norm form-control" type="text"></div>`;
    ...
    function submit(form) {
        ...
        .done(function(data) {
            ...
            if (data.result) {
                ...
                // window.location.href = site.base_url+'admin/production_order_request';
