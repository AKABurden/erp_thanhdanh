<div id="modal_import_excel" class="modal fade" role="dialog">
    <form action="<?= admin_url('roles/excel_import_permission') ?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?= base_url('uploads/template/excel_import_permission.xls?vs=1.8') ?>">Download file mẫu</a>
                    ...
                    <div class="checkbox checkbox-primary">
                        <input type="checkbox" id="append_staff" name="append_staff" value="1">
                        <label for="append_staff">Áp dụng ngay cho nhân viên (của vị trí Import)</label>
                    </div>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'roles/excel_import_permission';
        ...
        form_data.append('append_staff', $('#append_staff').val());
