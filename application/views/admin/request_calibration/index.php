    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestCalibration) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_calibration/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-rating-machines',
        '<?= site_url('admin/request_calibration/getRequestCalibration') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/request_calibration/getRequestCalibration') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_calibration/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function agreeFinish(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/request_calibration/agreeFinish',
            data: dataPOST,
            dataType: "json",
            success: function (response) {
                if (response.result) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_calibration/exportExcel',
            data: {
