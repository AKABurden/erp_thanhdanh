...
--
-- Table structure for table `tbl_request_export_products`
--

DROP TABLE IF EXISTS `tbl_request_export_products`;
CREATE TABLE IF NOT EXISTS `tbl_request_export_products` (
