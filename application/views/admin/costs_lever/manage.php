                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="type_cost" id="type_cost" class="form-control selectpicker type_cost" data-none-selected-text="<?= lang('Chọn loại') ?>" data-placeholder="<?= lang('Chọn loại') ?>">
                                    ...
                                    <option value="3" <?= ($type_cost == 3 ? 'selected' : '') ?>><?= lang('Chi Phí Hợp Lý') ?></option>
                                    <option value="4" <?= ($type_cost == 4 ? 'selected' : '') ?>><?= lang('Chi Phí Ngoài') ?></option>
                                    <option value="5" <?= ($type_cost == 5 ? 'selected' : '') ?>><?= lang('Chi Phí Khấu Trừ') ?></option>
                                    <option value="6" <?= ($type_cost == 6 ? 'selected' : '') ?>><?= lang('Chi Phí Giảm Trừ') ?></option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select name="type" class="form-control selectpicker" data-none-selected-text="<?= lang('type') ?>" data-placeholder="<?= lang('type') ?>">
                                    ...
                                    <option value="1"><?= lang('tnh_cpncsx') ?></option>
                                    <option value="2"><?= lang('tnh_cpsxc') ?></option>
                                    <option value="3"><?= lang('Chi Phí Hợp Lý') ?></option>
                                    <option value="4"><?= lang('Chi Phí Ngoài') ?></option>
                                    <option value="5"><?= lang('Chi Phí Khấu Trừ') ?></option>
                                    <option value="6"><?= lang('Chi Phí Giảm Trừ') ?></option>
                                </select>
                            </div>
                        </div>
        ...
        < </div>
            ...
            <script>
                $(function() {
                    ...
                    oTable = tnhInitDataTable('#table-costs', '<?= site_url('admin/costs_lever/getCosts') ?>', {
                        'order': [
                            [1, 'asc']
                        ],
                        'fixedHeader': {
                        ...
                        "ajax": {
                            "url": '<?= site_url('admin/costs_lever/getCosts') ?>',
                            "type": "POST",
                            "data": function(d) {
                ...
                function edit_costs(id, code, name, parent_id, cType) {
                    $('#type').modal('show');
