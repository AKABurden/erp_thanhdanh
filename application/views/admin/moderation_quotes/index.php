                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_quotes" class="table dt-tnh table-moderation_quotes-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2"><?= lang('STT') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Ngày Lập Phiếu') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Phiếu Yêu Cầu Báo Giá') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_quotes',
        '<?= site_url('admin/moderation_quotes/getModerationQuotes') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation_quotes/getModerationQuotes') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_quotes').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id,name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_quotes/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_quotes/exportExcel',
            data: {
