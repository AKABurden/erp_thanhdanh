<?php echo form_open('admin/category_regulations/importQuestionBank/', array('id' => 'import_job_detail')); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank"
                       href="<?= base_url('uploads/import_dt/import_ngan_hang_cau_hoi.xlsx?vs=1.2') ?>">Download
                        file mẫu</a>
                </div>
                <div class="col-md-12">
...
<script>
    $(function () {
        appValidateForm($('#import_job_detail'), {
            file: 'required',
        }, handling);
