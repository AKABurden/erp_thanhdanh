<?php echo form_open('admin/category_regulations/importSalaryGrade/', array('id' => 'import_job_detail')); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank"
                       href="<?= base_url('uploads/import_dt/import_salary_grade.xlsx?vs=1.1') ?>">Download
                        file mẫu</a>
                </div>
                <div class="col-md-12">
