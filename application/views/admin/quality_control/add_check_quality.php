...
<?php echo form_open('admin/quality_control/add_check_quality', array('id' => 'check_quality')); ?>
    <div id="wrapper">
                        ...
                        <div class="panel-body">
                            <table class="tnh-tb table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 35%;">
                                        <div class="form-group">
                                            <input type="text" name="reference_no" class="form-control"
                                                   id="reference_no" value="<?= $reference_no ?>" readonly=""
                                                   aria-invalid="false">
                                        </div>
                                    </td>
                                    <td style="width: 15%;">
                                    ...
                                    <td style="width: 35%;">
                                        <?= form_input('date',
                                            set_value('date') ? set_value('date') : date('d/m/Y H:i'),
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" name="customer_id" id="customer_id" class=" customer_id"
                                            value="" data-placeholder="<?= lang('Chọn khách hàng') ?>"
                                            required="required" style="width: 100%;" title="">
                                    </td> -->
                                    <td><?= lang('Chi nhánh xưởng', '') ?></td>
                                    <td>
                                        <?php $branchs = get_table_where('tblbranch', ['id !=' => 1], '',
                                            'result_array');
                                        $branch_id = 0;
                                        $staff = get_table_where('tblstaff', ['staffid' => get_staff_user_id()], '',
                                            'row_array');
                                    ...
                                    <td>
                                        <textarea name="note" id="note" class="form-control note" rows="3"></textarea>
                                    </td>
                                </tr>
                                <!-- <tr>
                                    <td><?= lang('note', 'note') ?></td>
                        ...
                        <div class="tab-panels">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="text" name="productions" id="productions"
                                               data-placeholder="<?= lang('Lệnh tổng') ?>"
                                               class="productions modal-select2"
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="text" name="items" id="items"
                                               data-placeholder="<?= lang('tnh_items') ?>" class="items modal-select2"
                                               value=""
                                               style="width: 100%;">
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="tb-height mtop10">
                                <div class="table-responsive">
                                    <table id="tb-check-quality" class="dt-tnh table table-hover" style="width: 100%">
                                        <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" style="width: 150px;"><?= lang('Thông tin') ?>
                                            </th>
                                            ...
                                            <!-- <th class="text-center" style="width: 100px;"><?= lang('SL phế') ?>
                                            </th> -->
...
<?php init_tail(); ?>
    ...
    <script type="text/javascript">
        ...
        var product_manu = <?= isset($product_manu) ? json_encode($product_manu) : [] ?>;
        var product_manu_detail = <?= isset($product_manu_detail) ? json_encode($product_manu_detail) : [] ?>;
    </script>

    <script type="text/javascript" src="<?= js('check_quality.js?vs=1.7') ?>"></script>
<?php $this->load->view('admin/quality_control/load_pois_qc'); ?>