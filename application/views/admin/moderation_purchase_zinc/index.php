                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_purchase_zinc" class="table dt-tnh table-moderation_purchase_zinc-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2"><?= lang('STT') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Ngày Lập Phiếu') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Phiếu Yêu Cầu Ghi Kẽm') ?></th>
                                            ...
                                            <th class="text-center" rowspan="2"><?= lang('Mã File') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Đường Link') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_purchase_zinc',
        '<?= site_url('admin/moderation_purchase_zinc/getModerationPurchaseZinc') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation_purchase_zinc/getModerationPurchaseZinc') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_purchase_zinc').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id, name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_purchase_zinc/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_purchase_zinc/exportExcel',
            data: {
