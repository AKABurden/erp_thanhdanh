...
<?php echo form_open(
    'admin/request_printed_page_layout/detail/' . $id . '',
    array('id' => 'request_printed_page_layout')
); ?>
<div id="wrapper">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="code_item">
                                                ...
                                                <input type="hidden" name="request_printed_page_layout_id[<?= $counter ?>]" class="request_printed_page_layout_id" value="<?= $value['id'] ?>">
                                                <?= $machines['code'] ?>
                                            </div>
                                        </td>
...
<?php $this->load->view('admin/request_printed_page_layout/script_js.php') ?>