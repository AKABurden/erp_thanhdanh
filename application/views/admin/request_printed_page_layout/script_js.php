<script>
    ...
    $("#branch_id").select2();
    $("#supplier_id").select2();
    ajaxSelectParams('#po_id', 'admin/request_printed_page_layout/searchPo', $("#po_id").val(), true, true);
    ajaxSelectCallBack($('#items_search'), 'admin/request_printed_page_layout/searchMachines', 0);
    ...
    if (edit == 1) {
        for (i = 0; i < counter; i++) {
            ajaxSelectParams($(`#operating_equipment_${i}`), 'admin/request_printed_page_layout/searchOperating_equipment', $(`#operating_equipment_${i}`).val());
        }
    }
    ...
    function loadItem(item = {}) {
        ...
        ajaxSelectParams($(`#operating_equipment_${counter}`), 'admin/request_printed_page_layout/searchOperating_equipment', 0);
    ...
    appValidateForm($('#request_printed_page_layout'), {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.result) {
                    ...
                    window.location.href = site.base_url + 'admin/request_printed_page_layout';
                } else {
