<table class="table detail_supplier" style="width: 100%;">
    ...
    <tr>
        ...
        <th rowspan="2"  class="text-center tdType" style="width: 10%;">Đơn vị tính</th>
        ...
        <th rowspan="2"  class="text-center tdType" style="width: 10%;">Đơn vị tiền tệ</th>
	...
	<?php if(!empty($data)) {?>
		<?php foreach ($data as $key => $value) {?>
            ...
            <tr>
                ...
                <td><?php echo $value->name_unit?></td>
                ...
                <td><?php echo $value->name_currencies?></td>
                <td class="text-center">
