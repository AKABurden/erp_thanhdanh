...
<div id="wrapper">
    <div class="panel_s mbot10 H_scroll" id="H_scroll">
        <div class="panel-body _buttons">
            <div class="_buttons">
                <span class="bold uppercase fsize18 H_title in-title">Import bảng giá đơn vị gia công (bằng file excel)</span>
                <div class="col-md-6 mtop5 pull-right">
                    <div class="text-right">
                        <a style="float: right;margin-top: 7px;font-size: 16px;padding-left: 5px;" href="<?=admin_url('stage_price_list')?>"> Quay lại</a>
                        <a class="pull-right" href="<?=admin_url('stage_price_list')?>">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo base_url('uploads/template/stage_price_list.xlsx?vs=1.2') ?>" target="_blank" class="btn btn-success">Tải Mẫu import</a>
                                <hr />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="id_supplier" data-placeholder="<?= lang('Nhà cung cấp') ?>" id="id_supplier" class="id_supplier" style="width: 100%;" value="">
                                    </div>
                                    <div class="col-md-3">
...
<script>
    $(function() {
        ajaxSelectParams('#id_supplier', 'admin/stage_price_list/SearchSupplier', 0, true, true);
