        ...
        <div class="panel-body _buttons">
            <div class="_buttons">
                ...
                <?php if ($this->HasCreate) { ?>
                    ...
                    <a href="<?php echo admin_url('stage_price_list/import'); ?>" class="btn btn-info mright5 test pull-right H_action_button">
                        <i class="lnr lnr-plus-circle" aria-hidden="true"></i>
                        <?php echo _l('dt_import_price'); ?></a>
                <?php } ?>
                <div class="pull-right mright5 H_border">
                    <a onclick="" href="<?= base_url('admin/stage_price_list/export_excel') ?>" class="btn btn-info pull-right mright10 H_action_button">
            ...
            <div class="col-md-12">
                <div id="search-tnh" class="collapse" aria-expanded="true" style="">
                    <div class="col-md-3">
                        ...
                        <input type="text" name="supplier_search" data-placeholder="<?= lang('Nhà Cung Cấp') ?>" id="supplier_search" class="supplier_search" style="width: 100%;" value="">
                    </div>
                    <div class="clearfix"></div>
                    <hr />
                </div>
...
<?php init_tail(); ?>
<script>
    ajaxSelectParams('#supplier_search', 'admin/stage_price_list/SearchSupplier', 0, true, true);
    ...
    $(function() {
        var CustomersServerParams = {
            ...
            'supplier_search': '[name="supplier_search"]',
        ...
        tAPI = initDataTable('.table-stage_price_list', admin_url + 'stage_price_list/table', [0], [0], CustomersServerParams, <?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(0, 'desc'))); ?>);
