<?php echo form_open('admin/category_salary/import_contract_labor', array('id' => 'importExcel')); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank"
                       href="<?= base_url('uploads/import_c/import_hop_dong_lao_dong.xlsx?vs=1') ?>">Download
                        file mẫu</a>
                </div>
                <div class="col-md-12">
