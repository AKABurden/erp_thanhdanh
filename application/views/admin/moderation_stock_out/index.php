                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_stock_out" class="table dt-tnh table-moderation_stock_out-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2"><?= lang('STT') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Ngày Lập Phiếu') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Phiếu Yêu Cầu Xuất Kho') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_stock_out',
        '<?= site_url('admin/moderation_stock_out/getModerationStockOut') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/moderation_stock_out/getModerationStockOut') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_stock_out').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id,name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_stock_out/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_stock_out/exportExcel',
            data: {
