    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestOvercomeProduct): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_overcome_products/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-ticket-purchase-product',
        '<?= site_url('admin/suggest_overcome_products/getSuggestOvercomeProducts') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_overcome_products/getSuggestOvercomeProducts') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_purchase_id, status,) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_overcome_products/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_overcome_products/exportExcel',
            data: {
