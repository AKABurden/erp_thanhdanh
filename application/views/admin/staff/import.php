...
<div id="wrapper">
    ...
    <?php echo form_open('admin/staff/impot_staff', array('id' => 'impot-staff')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="text-danger">
                            <div>
                                ...
                                <a href="<?= base_url('uploads/template/template_Nhan_vien.xlsx?vs=1.2') ?>" title=""><?= lang('tnh_file_sample') ?></a>
                            </div>
                            <div>
                                ...
                                - Email với SDT không được trùng, Email là bắt buộc.</br>
                                - Dữ liệu sẽ cập nhật dựa trên mã nhân viên</br>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function importBom(form) {
            ...
            var url = form.action;
            $.ajax({
                    url: site.base_url + 'admin/staff/import_staff',
                    type: 'POST',
                    dataType: 'JSON',
                    cache: false,
                    contentType: false,
