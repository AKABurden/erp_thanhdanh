...
<div id="wrapper">
    ...
    <?php echo form_open('admin/columns/import',array('id'=>'import-bom')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="text-danger">
                            <div>
                                ...
                                <a href="<?= base_url('file/products/import_columns.xlsx?vs=1.1') ?>" title=""><?= lang('tnh_file_sample') ?></a>
                            </div>
                            <div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function importBom(form) {
            ...
            var url = form.action;
            $.ajax({
                url : site.base_url+'admin/columns/import',
                type : 'POST',
                dataType: 'JSON',
                cache : false,
                contentType : false,
