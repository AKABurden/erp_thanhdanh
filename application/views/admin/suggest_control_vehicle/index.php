...
<?php init_head(); ?>
<style type="text/css">
    #table-suggest-control-vehicle tr th:nth-child(1) {
        width: 80px;
        text-align: center;
    }
    #table-suggest-control-vehicle tr th:nth-child(6) {
        width: 150px;
        text-align: center;
    }
</style>
    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestControlVehicle): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_control_vehicle/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-control-vehicle" class="table dt-tnh table-suggest-control-vehicle-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-control-vehicle',
        '<?= site_url('admin/suggest_control_vehicle/getSuggestControlVehicles') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_control_vehicle/getSuggestControlVehicles') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_control_vehicle/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_control_vehicle/exportExcel',
            data: {
