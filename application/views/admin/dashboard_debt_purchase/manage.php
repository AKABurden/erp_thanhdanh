                                    ...
                                    <div class="content-wrapper">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card text-white bg-warning o-hidden h-100">
                                                    <div class="card-body">
                                                        ...
                                                        <h3 class="mr-5"> Hoá Đơn Mua Hàng <br><span style="font-size: 16px" id="count_purchase_invoice">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                                <div style="height: 118px;" class="col-md-4">
                                                <div class="card text-white bg-success o-hidden h-100">
                                                    <div class="card-body">
                                                    <img src="<?= base_url('assets/images/circle.svg')?>" class="card-img-absolute" alt="circle-image" />
                                                    <h3 class="mr-5">Phiếu Chi Mua Hàng<br><span style="font-size: 16px" id="pay_slips">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                                <div style="height: 118px;" class="col-md-4">
                                                <div class="card text-white bg-primary o-hidden h-100" style="background-color: #ff4015;">
                                                    <div class="card-body">
                                                    <img src="<?= base_url('assets/images/circle.svg')?>" class="card-img-absolute" alt="circle-image" />
                                                    <h3 class="mr-5">Công Nợ <?=_l('supplier')?><br><span style="font-size: 16px" id="debt_total">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="border-radius-4 wrap_box">
                                                    <strong><h4 class="text-center text-capitalize"><?=_l('sum_top')?> 5 <?=_l('supplier')?> Có Tổng Chi Cao Nhất</h4></strong>
                                                    <hr/>
                                                    <div>
                                                    <div style="float: left; padding: 0 0 0 10px;">
                                                        <span style="font-size: 10px;">Tên <?=_l('supplier')?></span>
                                                    </div>
                                                    <div style="float: right; padding: 0 10px 0 0;">
                                                        <span style="font-size: 10px;"><?=_l('ch_total_expenses')?></span>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    </div>
                                                    <br/>
                                            ...
                                            <div class="col-md-6">
                                                <div class="border-radius-4 wrap_box">
                                                    <strong><h4 class="text-center text-capitalize"><?=_l('sum_top')?> 5 <?=_l('supplier')?> nhập hàng nhiều nhất</h4></strong>
                                                    <hr/>
                                                    <div>
                                                    <div style="float: left; padding: 0 0 0 10px;">
                                                        <span style="font-size: 10px;">Tên <?=_l('supplier')?></span>
...
<script>
    ...
    function top_pay_slips() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_debt_purchase/top_pay_slips/",
            data: dataString,
            cache: false,
            success: function (data) {
              data = JSON.parse(data);
    ...
    function get_total_limit() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_debt_purchase/count_all/",
            data: dataString,
            cache: false,
            success: function (data) {
                data = JSON.parse(data);
                $('#count_purchase_invoice').html(data.count_purchase_invoices);
                $('#pay_slips').html(data.pay_slips);
                $('#debt_total').html(data.total_imports);
            },
...
<option selected value=""><?php echo _l('report_sales_months_all_time'); ?></option>
