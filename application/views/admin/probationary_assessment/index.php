    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddProbationaryAssessment): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/probationary_assessment/detail?type='.$type.'') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="horizontal-scrollable-tabs">
                                ...
                                <input type="hidden" name="type" id="type"
                                       class="form-control type" value="<?= $type ?>">
                            </div>
                            <div class="view_list">
                                <table id="table-probationary_assessment" class="table dt-tnh table-probationary_assessment" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Ngày bắt đầu (TV)') ?></th>
                                        <th class="text-center"><?= lang('Ngày kết thúc (TV)') ?></th>
...
<script>
    ...
    function initList(){
        oTable = tnhInitDataTable('#table-probationary_assessment',
            '<?= site_url('admin/probationary_assessment/getEvaluationEmployee') ?>', {
                'order': [
                    [0, 'desc']
                ],
                "ajax": {
                    "url": '<?= site_url('admin/probationary_assessment/getProbationaryAssessment') ?>',
                    "type": "POST",
                    "data": function(d) {
                ...
                "createdRow": function(row, data, index) {
                    $('td', row).eq(8).css('background-color', data[10]);
                },
                "columnDefs": [
                    {
    ...
    function initDashboard(){
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/personnel_assessment/initDashboard',
            data: {
