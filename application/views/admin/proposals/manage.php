...
<div id="wrapper">
  <div class="panel_s mbot10 H_scroll" id="H_scroll">
     <div class="panel-body _buttons">
        ...
        <a href="<?php echo admin_url('proposals/proposal'); ?>" class="btn btn-info pull-left H_action_button">
          <i class="lnr lnr-plus-circle" aria-hidden="true"></i>
          <?php echo _l('create_add_new'); ?>
        </a>
        <div class="line-sp"></div>
        <?php } ?>
        <a href="<?php echo admin_url('proposals/pipeline/'.$switch_pipeline); ?>" class="btn btn-info mleft5 pull-left hidden-xs H_action_button"><?php echo _l('switch_to_pipeline'); ?></a>
