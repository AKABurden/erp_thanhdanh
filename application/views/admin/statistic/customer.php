                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-device" class="table dt-tnh table-customer" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?= lang('STT') ?></th>
                                            <th class="text-center"><?= lang('Nhóm KH') ?></th>
                                            ...
                                            <th class="text-center"><?= lang('Thời Hạn Thu') ?></th>
                                            <th class="text-center"><?= lang('Ngày Thu') ?></th>
...
<script>
    ...
    oTable = initDataTableCustom('.table-customer', admin_url + 'statistic/getCustomer', [0], [0], CustomersServerParams,[0, 'desc'], fixedColumns = {leftColumns: 0, rightColumns: 0});
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/statistic/getCustomerExcel',
            data: {
