    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddPurchaseRequestZinc): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/purchase_request_zinc/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-plan-overtime',
        '<?= site_url('admin/purchase_request_zinc/getPurchaseRequestZinc') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/purchase_request_zinc/getPurchaseRequestZinc') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/purchase_request_zinc/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/purchase_request_zinc/exportExcel',
            data: {
