<script>
    ...
    $("#branch_id").select2();
    $("#supplier_id").select2();
    ajaxSelectParams('#po_id', 'admin/purchase_request_zinc/searchPo', $("#po_id").val(), true, true);
    ajaxSelectCallBack($('#items_search'), 'admin/purchase_request_zinc/searchProductByOrders', 0);
    ...
    if (edit == 1){
        for (i = 0; i < counter; i++) {
            ajaxSelectParams($(`#operating_equipment_${i}`), 'admin/purchase_request_zinc/searchOperating_equipment', $(`#operating_equipment_${i}`).val());
        }
    }
    ...
    function loadItem(item = {}) {
        ...
        tdCodeFile = `<div class="td-code_file"><input type="text" name="code_file[${counter}]" class="code_file form-control" value=""></div>`;
        tdLinkFile = `<div class="td-link_file"><input type="text" name="link_file[${counter}]" class="link_file form-control" value=""></div>`;
        ...
        trItem = `<tr>
            ...
            <td style="width: 150px">${tdCodeFile}</td>
            <td style="width: 150px">${tdLinkFile}</td>
        ...
        ajaxSelectParams($(`#operating_equipment_${counter}`), 'admin/purchase_request_zinc/searchOperating_equipment', 0);
    ...
    appValidateForm($('#purchase_request_zinc'), {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.result) {
                    ...
                    window.location.href = site.base_url + 'admin/purchase_request_zinc';
                } else {
