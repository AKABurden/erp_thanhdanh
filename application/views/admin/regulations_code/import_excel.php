<div id="modal_import_excel_machines" class="modal fade" role="dialog">
    <form action="<?= admin_url('import_excel/action_imports_client') ?>" id="regulations_code_import" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?= base_url('uploads/template/Template_regulations_code.xlsx?vs=1.3') ?>">Download file mẫu</a>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'regulations_code/import/<?= $type ?>';
        var file_data = $('#regulations_code_import input#file_import').prop('files');
