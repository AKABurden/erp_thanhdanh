                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                	...
                                	<input type="text" name="customer_id" id="customers" class="customers" style="width: 100%;" data-placeholder="<?= lang('customers') ?>"  value="" required="required">
                                </div>
                                <div class="form-group">
                                	<?= lang('contact', 'contactid') ?>
                                	<input type="text" name="contactid" id="contactid" class="contactid" style="width: 100%;" data-placeholder="<?= lang('contact') ?>"  value="<?= !empty($contact) ? $contact['id'] : '' ?>" required="required">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="tags" class="control-label"><i class="fa fa-tag" aria-hidden="true"></i> <?php echo _l('classify_complain'); ?>
                                    </label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                    	...
                                    	<input type="text" name="order_id" id="order_id" class="order_id" style="width: 100%;" data-placeholder="<?= lang('orders') ?>"  value="">
                                    </div>
                                </div>
