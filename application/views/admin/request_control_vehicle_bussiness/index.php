    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestControlVehicleBussiness) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_control_vehicle_bussiness/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="">
                                    <table id="table-request_control_vehicle_bussiness" class="table dt-tnh table-request_control_vehicle_bussiness-new" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-request_control_vehicle_bussiness',
        '<?= site_url('admin/request_control_vehicle_bussiness/getRequestControlVehicleBussiness') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/request_control_vehicle_bussiness/getRequestControlVehicleBussiness') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_control_vehicle_bussiness/exportExcel',
            data: {
