                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-synthetic-purchase" class="table dt-tnh table-synthetic-purchase-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-synthetic-purchase',
        '<?= site_url('admin/purchases/getSyntheticPurchase') ?>', {
            'order': [
                [0, 'desc'],
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/purchases/getSyntheticPurchase') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $(document).on('change',
        '#search_code,#custom_item_select,[name="search_id_suppliers[]"],#end_date_search,#start_date_search',
        function(
            event) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/purchases/exportExcelSyntheticPurchase',
            data: {
                ...
                custom_item_select: custom_item_select,
                export_excel: 1,
            },
            dataType: "json",
