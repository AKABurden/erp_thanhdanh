                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation-evaluate-skill" class="table dt-tnh table-moderation-evaluate-skill-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-evaluate-skill',
        '<?= site_url('admin/moderation/getModerationEvaluateSkill') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation/getModerationEvaluateSkill') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation/exportExcelModerationEvaluateSkill',
            data: {
