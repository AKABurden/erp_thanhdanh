                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation-evaluate" class="table dt-tnh table-moderation-evaluate-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Tên Đánh Giá') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-evaluate',
        '<?= site_url('admin/moderation/getModerationEvaluateSupplier') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation/getModerationEvaluateSupplier') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation/exportExcelModerationEvaluateSupplier',
            data: {
