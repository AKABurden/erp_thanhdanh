...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-evaluate',
        '<?= site_url('admin/moderation/getModerationEvaluate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation/getModerationEvaluate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation/exportExcelModerationEvaluate',
            data: {
