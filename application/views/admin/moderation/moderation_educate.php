                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation-educate" class="table dt-tnh table-moderation-educate-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Mã Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Tên Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Vị Trí Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Chi Tiết Đạo Tạo') ?></th>
                                        <th class="text-center"><?= lang('Số Người Tham Gia') ?></th>
                                        <th class="text-center"><?= lang('Người Phụ Trách Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Đơn Vị Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Chi Phí Đào Tạo') ?></th>
                                        <th class="text-center"><?= lang('Thuế Vat') ?></th>
                                        <th class="text-center"><?= lang('Tổng Vat') ?></th>
                                        <th class="text-center"><?= lang('Thành Tiền') ?></th>
                                        <th class="text-center"><?= lang('Kết Quả') ?></th>
                                        <th class="text-center"><?= lang('Tiểu Chuẩn/ Quy Định') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-educate',
        '<?= site_url('admin/moderation/getModerationEducate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation/getModerationEducate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation/exportExcelModerationEducate',
            data: {
