                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation-check" class="table dt-tnh table-moderation-check-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Khu Vực/ Thiết Bị') ?></th>
                                        <th class="text-center"><?= lang('Tên Khu vực/ Tên Thiết bị') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation-check',
        '<?= site_url('admin/moderation/getModerationCheck') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation/getModerationCheck') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation/exportExcelModerationCheck',
            data: {
