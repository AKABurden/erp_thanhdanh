    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestUnion) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_union/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-suggest_union" class="table dt-tnh table-suggest_union" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest_union',
        '<?= site_url('admin/suggest_union/getSuggestUnion') ?>', {
            'order': [
                [0, 'desc']
            ],
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/suggest_union/getSuggestUnion') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_union/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_union/exportExcel',
            data: {
