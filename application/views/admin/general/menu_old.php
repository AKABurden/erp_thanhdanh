        ...
        <div class="div-box-menu">
            ...
            <?php if (!empty($items)) : ?>
                <?php foreach ($items as $i => $v) : ?>
                    ...
                    ?>
                    <?php if (empty($is_sub)) : ?>
                        <div style="<?= $is_not_click ? 'pointer-events: none;' : '' ?>"  class="<?= $i ?> click_localStorage uppercase div-label p-relative <?= $activeCategory ?>" data-value="<?= $i ?>">
                            <?= $v['name'] ?>
                            <?php if ($is_not_click) : ?>
                    ...
                    <?php } else { ?>
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="filter_month1" id="filter_month1" onchange="view_kpi_evaluation1()" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98" data-placeholder="<?= lang('month') ?>" class="selectpicker">
                                    <?php for ($i = 1; $i <= 12; $i++) : ?>
