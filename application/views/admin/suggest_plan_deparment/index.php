    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestPlanDeparment): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_plan_deparment/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest_plan_deparment" class="table dt-tnh table-suggest_plan_deparment" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Ngày Tái Thực Hiện') ?></th>
                                        <th class="text-center"><?= lang('Ngày Nhắc Việc') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest_plan_deparment',
        '<?= site_url('admin/suggest_plan_deparment/getSuggestPlanDeparment') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_plan_deparment/getSuggestPlanDeparment') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_plan_deparment/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_plan_deparment/exportExcel',
            data: {
