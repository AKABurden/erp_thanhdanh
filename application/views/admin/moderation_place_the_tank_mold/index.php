                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_place_the_tank_mold" class="table dt-tnh table-moderation_place_the_tank_mold-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center" rowspan="2"><?= lang('STT') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Ngày Lập Phiếu') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Số Phiếu') ?></th>
                                            ...
                                            <th class="text-center" rowspan="2"><?= lang('ĐVT') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tổng số lượng') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Thiết Bị Vận Hành') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Định Mức Năng Suất/Giờ') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Thời Gian Dự Kiến') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Thời Gian Bắt Đầu') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Thời Gian Kết Thúc') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_place_the_tank_mold',
        '<?= site_url('admin/moderation_place_the_tank_mold/getModerationPlaceTheTankMold') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/moderation_place_the_tank_mold/getModerationPlaceTheTankMold') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_place_the_tank_mold').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id, name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_place_the_tank_mold/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_place_the_tank_mold/exportExcel',
            data: {
