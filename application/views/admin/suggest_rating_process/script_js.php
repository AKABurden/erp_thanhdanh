<script>
    ...
    $("#staff_agree").select2();
    ajaxSelectCallBack($('#items_search'), 'admin/suggest_rating_system/SearchSystems', 0,2);
    ...
    appValidateForm($('#suggest_rating_process'), {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                if (data.result) {
                    ...
                    window.location.href = site.base_url+'admin/suggest_rating_process';
                } else {
