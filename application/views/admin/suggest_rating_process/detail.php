...
<?php echo form_open('admin/suggest_rating_process/detail/' . $id . '',
    array('id' => 'suggest_rating_process')); ?>
<div id="wrapper">
    ...
    <div class="content ae-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div>
                    <label for="items_search"><?= lang('Mã quy trình') ?></label>
                    <input type="text" name="items_search" id="items_search" class="items_search" style="width: 100%;"
                           data-placeholder="<?= lang('Mã quy trình') ?>" value="">
                </div>
                <div class="table-responsive">
                    <table id="tb-purchases" class="dt-tnh table table-hover" style="width: 100%;">
                        ...
                        <tr>
                            ...
                            <th style="width: 100px;"><?= lang('Mã quy trình') ?></th>
                            <th style="width: 100px;"><?= lang('Tên quy trình') ?></th>
                            <th style="width: 150px;"><?= lang('Chi tiết quy trình') ?></th>
                            ...
                            <?php foreach ($dtItems as $key => $value){ ?>
                                ...
                                <tr>
                                    ...
                                    <td><div class="code_item">
                                            ...
                                            <input type="hidden" name="suggest_rating_process_item_id[<?= $counter ?>]" class="suggest_rating_process_item_id" value="<?= $value['id'] ?>">
                                            <?= $value['code_system'] ?>
                                        </div>
                                    </td>
...
<?php $this->load->view('admin/suggest_rating_process/script_js.php') ?>
