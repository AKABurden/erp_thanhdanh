            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Thu nhập chịu thuế') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['total_taxable']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Thu nhập tính thuế') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['total_tax_calculation']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Thuế') ?>: </div>
                            <div class="ml-at t-bold"><?= formatMoney($dtData['total_tax']) ?></div>
                        </div>
                    </div>
                </div>
