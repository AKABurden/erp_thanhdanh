...
<script>
    ...
    $(function() {
        ...
        tAPI = initDataTableCustom('.table-other_payslips', admin_url + 'detail_payslips/table/<?=$type?>', [0], [0], CustomersServerParams, <?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(0, 'desc'))); ?>, fixedColumns = {
            leftColumns: 2,
            rightColumns: 1
        });
    ...
    function get_total_limit() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?= admin_url() ?>detail_payslips/count_all/<?=$type?>",
            data: dataString,
            cache: false,
