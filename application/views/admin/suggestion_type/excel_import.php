<div id="modal_import_excel" class="modal fade" role="dialog">
    <form action="<?= admin_url('suggestion_type/excel_import') ?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?= base_url('uploads/template/template_Loai_de_xuat.xlsx?vs=1.1') ?>">Download file mẫu</a>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'suggestion_type/excel_import';
