...
<div class="panel_s mbot10 H_scroll" id="H_scroll">
  <div class="panel-body _buttons">
    <?php if($has_permission_create){ ?>
     <a href="<?php echo admin_url('knowledge_base/article'); ?>" class="btn btn-info mright5 pull-left H_action_button">
     ...
     <a href="<?php echo admin_url('knowledge_base/manage_groups'); ?>" class="btn btn-info mright5 H_action_button"><?php echo _l('als_kb_groups'); ?></a>
     <?php } ?>
