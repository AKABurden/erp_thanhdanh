<?php echo form_open('admin/recruitment/importRequirements/', array('id' => 'importRequirements')); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank"
                       href="<?= base_url('uploads/import_c/import_yeu_cau_tuyen_dung.xlsx?vs=1.2') ?>">Download
                        file mẫu</a>
                </div>
                <div class="col-md-12">
...
<script>
    $(function () {
        appValidateForm($('#importRequirements'), {
            file: 'required',
        }, handling);
