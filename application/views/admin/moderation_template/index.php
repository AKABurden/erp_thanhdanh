                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_template" class="table dt-tnh table-moderation_template-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" rowspan="2"><?= lang('Mã Số Báo Giá') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tên Brand') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Phân Loại Khách Hàng') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã Khách Hàng') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tên Khách Hàng') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tên Nhóm SP') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tên Chủng Loại') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('ĐV Tính SP') ?></th>
                                            <th class="text-center" colspan="2"><?= lang('Kích Thước SP') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('ĐV Đo SP') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Mã thành phẩm') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tên thành phẩm') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Tiêu Chuẩn Đóng Gói') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Số Lượng Tồn Cho Phép') ?></th>
                                            <th class="text-center" rowspan="2"><?= lang('Thời Gian Tồn Kho') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_template',
        '<?= site_url('admin/moderation_template/getModerationTemplate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/moderation_template/getModerationTemplate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_template').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id,name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_template/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_template/exportExcel',
            data: {
