...
<?php if (isset($stats)) extract($stats); ?>
<meta charset="UTF-8">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:18px;margin-bottom:28px;">
            ...
            <div class="stat-card card-blue anim anim-d1">
                ...
                <div>
                    ...
                    <div class="card-value"><?= number_format($tasks_completed_process) ?></div>
                </div>
                <?php
                ...
                <div class="card-delta" style="color:<?= $delta_color ?>;">
                    ...
                    <?= $delta_sign . number_format($diff) ?> CV
            ...
            <div class="stat-card card-red anim anim-d4">
                ...
                <div>
                    ...
                    <div class="card-value"><?= number_format($production_report) ?></div>
                </div>
                <div class="card-delta">
                    ...
                    ?>
                    <i data-lucide="<?= $delta_icon ?>" style="width:14px;height:14px;"></i> <?= $delta_sign . number_format($diff) ?>
                    <span class="muted">so với tháng trước</span>
                </div>
            </div>
            ...
            <!-- <div class="stat-card card-orange anim anim-d5">
                ...
                <div>
                    ...
                    <div class="card-value"><?= number_format($tasks_incomplete_process) ?></div>
                </div>
                <?php
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(ctx) {
                                        return ' ' + ctx.parsed.y + ' nhà cung cấp';
                                    }
                                }
                            }
                        },
