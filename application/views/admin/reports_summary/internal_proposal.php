                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-device" class="table dt-tnh table-internal_proposal" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?= lang('Lập Đề Xuất') ?></th>
                                            <th class="text-center"><?= lang('Duyệt Đề Xuất') ?></th>
                                            <th class="text-center"><?= lang('Duyệt Thực Thi') ?></th>
...
<script>
    ...
    oTable = initDataTableCustom('.table-internal_proposal', admin_url+'reports_summary/getInternalProposal', [4,5,6,7,8,9,10,11,12], [4,5,6,7,8,9,10,11,12], CustomersServerParams,[0, 'desc'], fixedColumns = {leftColumns: 0, rightColumns: 0});
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/reports_summary/getInternalProposal',
            data: {
