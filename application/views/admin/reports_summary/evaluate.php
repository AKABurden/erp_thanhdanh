                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-device" class="table dt-tnh table-evaluate" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?= lang('STT') ?></th>
                                            <th class="text-center"><?= lang('Mã Đề Xuất Nội Bộ') ?></th>
                                            <th class="text-center"><?= lang('Nhóm Giấy Phép-Chứng Nhận') ?></th>
                                            <th class="text-center"><?= lang('Mã') ?></th>
                                            <th class="text-center"><?= lang('Tên Giấy Phép-Chứng Nhận') ?></th>
                                            <th class="text-center"><?= lang('Ngày Cấp') ?></th>
                                            <th class="text-center"><?= lang('Thời Hạn Sử Dụng') ?></th>
                                            <th class="text-center"><?= lang('Ngày Tái Cấp') ?></th>
                                            <th class="text-center"><?= lang('Chi Phí') ?></th>
                                            <th class="text-center"><?= lang('Đơn Vị Cấp') ?></th>
                                            <th class="text-center"><?= lang('Đơn Vị Đào Tạo') ?></th>
                                            <th class="text-center"><?= lang('Đơn Vị Công Chứng') ?></th>
                                            <th class="text-center"><?= lang('Ngày Cập Nhật Foso') ?></th>
                                            <th class="text-center"><?= lang('Ngày Điều Chỉnh') ?></th>
                                            <th class="text-center"><?= lang('Đang Sử Dụng') ?></th>
...
<script>
    ...
    oTable = initDataTableCustom('.table-evaluate', admin_url+'reports_summary/getEvaluate', [0], [0], CustomersServerParams,[0, 'desc'], fixedColumns = {leftColumns: 0, rightColumns: 0});
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/reports_summary/getEvaluateExcel',
            data: {
