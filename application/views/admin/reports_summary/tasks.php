                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-device" class="table dt-tnh table-tasks" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?= lang('STT') ?></th>
                                            <th class="text-center"><?= lang('Mã Phòng Ban') ?></th>
                                            <th class="text-center"><?= lang('Mã Công Việc') ?></th>
                                            <th class="text-center"><?= lang('Tên Công Việc') ?></th>
                                            <th class="text-center"><?= lang('Có Qui Trình') ?></th>
                                            <th class="text-center"><?= lang('Có Qui Chuẩn') ?></th>
                                            <th class="text-center"><?= lang('Ngày Ban Hành/Có Cam Kết') ?></th>
                                            <th class="text-center"><?= lang('Ngày Áp Dụng') ?></th>
...
<script>
    ...
    oTable = initDataTableCustom('.table-tasks', admin_url+'reports_summary/getTasks', [0], [0], CustomersServerParams,[0, 'desc'], fixedColumns = {leftColumns: 0, rightColumns: 0});
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/reports_summary/getTasksExcel',
            data: {
