                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-device" class="table dt-tnh table-fixation" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th class="text-center"><?= lang('STT') ?></th>
                                            <th class="text-center"><?= lang('Mã Đề Xuất Nội Bộ') ?></th>
                                            <th class="text-center"><?= lang('Nhóm Qui Định-Qui Chế') ?></th>
                                            <th class="text-center"><?= lang('Mã') ?></th>
                                            <th class="text-center"><?= lang('Tên Qui Định-Qui Chế') ?></th>
                                            <th class="text-center"><?= lang('Ngày Ban Hành') ?></th>
                                            <th class="text-center"><?= lang('Thời Hạn Sử Dụng') ?></th>
                                            <th class="text-center"><?= lang('Ngày Tái Ban Hành') ?></th>
...
<script>
    ...
    oTable = initDataTableCustom('.table-fixation', admin_url+'reports_summary/getFixation', [0], [0], CustomersServerParams,[0, 'desc'], fixedColumns = {leftColumns: 0, rightColumns: 0});
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/reports_summary/getFixationExcel',
            data: {
