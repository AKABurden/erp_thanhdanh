        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="book-title"><?php echo _l('Tất toán tạm ứng'); ?> </span>
                </h4>
            </div>
                ...
                <table class="tnh-tb table-bordered table-hover dont-responsive-table m-group0" style="table-layout: fixed;">
                    <tbody>
                            ...
                            <td>
                                ...
                                <div class="form-group">
                                    <select id="id_costs" name="id_costs" class="selectpicker" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98">
                                        <option value=""></option>
                                        <?php
                                        $id_costs = (isset($items) ? $items->id_costs : 14);
                        ...
                        <tr >
                            ...
                            <td>
                                ...
                                <select class="selectpicker no-margin" data-width="100%" id="type_vouchers" data-none-selected-text="<?php echo _l('Loại chứng từ'); ?>" name="type_vouchers" data-live-search="true" <?= (isset($items) ? 'disabled' : '') ?>>
                                    <?php foreach ($type_vouchers as $product) { ?>
                                        <option <?= (isset($items) ? (($product['id'] == $items->type_vouchers) ? 'selected' : 12) : 12) ?> value="<?php echo $product['id']; ?>" data-subtext=""><?php echo $product['name']; ?></option>
                                    <?php
                                    } ?>
                                </select>
                            </td>
                            ...
                            <td>
                                <select class="selectpicker no-margin" data-width="100%" id="vouchers_id" data-none-selected-text="<?php echo _l('ch_list_code'); ?>" name="vouchers_id" data-live-search="true">
...
<script type="text/javascript">
    ...
    $("#objects").change(function() {
        ...
        if (!empty($other_payslips)) { ?>
            id_objects_id = <?= $other_payslips->objects_id; ?>;
        <?php
        }
        ?>
        if (id == 1) {
