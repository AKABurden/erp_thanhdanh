                                    ...
                                    <table class="tnh-tb table-bordered table-hover dont-responsive-table m-group0">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $value = (isset($items) ? number_format($items->delivery_cost) : 0);
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php
                                                    $value = (isset($items) ? number_format($items->reduce_cost) : 0);
                                        ...
                                        <table class="dt-tnh table item-purchase_order table-bordered table-hover" style="width: 100%;table-layout: fixed;">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;" class="hide text-center">
                                                ...
                                                ?>
                                                        <tr class="sortable item">
                                                            <td class="dragger" style="text-align: center;">
                                                                ...
                                                                <input type="hidden" id="plan_id" name="items[<?php echo $i; ?>][plan_id]" value="<?php echo $value['plan_id']; ?>">
                                                            ...
                                                            <td>
                                                                <select style="width: 100%;" id="custom_item_select_<?= $i ?>" class=" custom_item_select" data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                                            ...
                                                            <td class="hide"><input style="width: 100px" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input mainQuantity" type="text" name="items[<?php echo $i; ?>][quantity]" data-store="<?= $value['quantity'] ?>" value="<?= $value['quantity'] ?>" /></td>
                                                            ...
                                                            <td class="hide center quantity_warehoues"></td>
                                                            <td class="hide"><?= $value['unit'] ?></td>
                                                            <td class="hide"><input style="width: 100px" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_expected" type="text" name="items[<?php echo $i; ?>][price_expected]" value="<?= number_format($value['price_expected']) ?>" /></td>
                                                            <td><input style="width: 100px" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_suppliers " type="text" name="items[<?php echo $i; ?>][price_suppliers]" value="<?= number_format($value['price_suppliers']) ?>" />
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="hide align_right total_expected">
                                                                <?= number_format($value['total_expected']) ?></td>
                                                            <td class="hide"><input style="width: 100px" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right promotion_expected" type="text" name="items[<?php echo $i; ?>][promotion_expected]" value="<?= number_format($value['promotion_expected']) ?>" />
                                                            </td>

                                                            <td class="align_right total_suppliers">
                                                                <?= number_format($value['total_suppliers']) ?></td>
                                ...
                                <td style="width: 13%;">
                                    <div>
                                        ...
                                        <div style="display: flex; align-items: center; float: left;">
                                            ...
                                            <input placeholder="Chiết khấu" class="form-control" id="discount_percent_suppliers" value="<?= (isset($items) ? $items->discount_percent_suppliers : 0) ?>" name="discount_percent_suppliers" style="width: 100%;float: left;" onchange="formatNumBerKeyUpCus(this)">
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
                                </td>
...
<script>
    ...
    function load() {
        ...
        if (empty(id_array)) {
            alert_float('warning', 'Bạn chưa chọn mặt hàng nhanh!');
            return;
        }
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                ...
                $.each(items, (index, value) => {
                    ...
                    if ($(value).find('td:nth-child(1)').find('input#type').val() == 'hau') {
                        console.log($(value).find('td:nth-child(1)').find('input#type').val());
                    }
                });
            }
        });
        ...
        $('[id="type_items_ch[]"]').selectpicker('val', '');
    }
    ...
    function load_html(id = '', type = '', h) {
        ...
        $.each(_html, function(key, value) {
            if (key == 0) {
                __html += '<optgroup data-text="' + value.name + '" label="' + value.name + '">';
            } else if (value.id == 'h') {
                __html += '</optgroup>';
                __html += '<optgroup data-text="' + value.name + '" label="' + value.name + '">';
            } else {
                if (value.type_items == type && value.id == id) {
                    if (value.type_items == 'nvl' || value.type_items == 'product') {
                        __html += '<option  data-mode="' + value.mode + '" selected quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value
                            .type_items + ' data-type_items=' + value
                            .type_items + ' data-text="[' + value.code_item + '] ' + value.name +
                            '" value="' + value.id + '">[' + value.code_item + '] ' + value.name +
                            '</option>';
                    } else {
                        __html += '<option selected quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value
                            .type_items + ' data-text="[' + value.code_item + '] ' + value.name +
                            '" value="' + value.id + '">[' + value.code_item + '] ' + value.name +
                            '</option>';
                    }
                } else {
                    __html += '<option data-text="[' + value.code_item + '] ' + value.name +
                        '" quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value
                        .type_items + ' value="' + value.id + '">[' + value.code_item + '] ' + value.name +
                        '</option>';
                }
    ...
    $(document).on('change', '.custom_item_select', (e) => {
        ...
        if (id == '') {} else {
            ...
            var id_purchases = $('#id_purchases').val();
            var suppliers_id = $('#suppliers_id').val();
            $.post(admin_url + 'purchase_order/get_items_order/' + id + '/' + type + '/' + id_purchases + '/' +
                suppliers_id, {
                    [csrfData['token_name']]: csrfData['hash']
                },
                function(item) {
    ...
    var createTrItemfist = (item) => {
        ...
        var td7 = $(
            '<td class="hide"><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input mainQuantity" type="text" name="items[' +
        ...
        var td9 = $('<td  class="hide center quantity_warehoues"></td>');
        var td10 = $('<td class="unit_name hide"></td>');
        var td11 = $(
            '<td class="hide"><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_expected" type="text" name="items[' +
            uniqueArray + '][price_expected]" value="0" /></td>');
        var td12 = $(
            '<td ><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_suppliers "  type="text" name="items[' +
        ...
        var td15 = $(
            '<td ><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right promotion_expected" type="text" name="items[' +
    ...
    var createTrItemload = (item) => {
        ...
        $.each(table_price, (index, value) => {
            if (value.product_id == item.product_id && value.product_type == item.type) {
        ...
        var td1 = $('<td class="dragger" style="text-align: center;">' + name_type +
            ...
            <input type="hidden" id="product_id" name="items[' + uniqueArray + '][id]" value="' + item.product_id + '" />\
        ...
        var td2 = $('<td><input type="hidden" class="count" value="' + uniqueArray + '" />\
        	<div class="form-group">\
	             <select class="custom_item_select" style="width:300px" id="custom_item_select_' + uniqueArray +
            '" name="items[' + uniqueArray + '][id_item]"  data-width="100%" data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">\
	             </select>\
	        </div></td>');
        var td3 = $('<td class="hide">???</td>');
        var td4 = $('<td class="hide">???</td>');
        ...
        var td7 = $('<td class="hide"><input data-store="' + item.quantity_net +
            '" style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input mainQuantity" type="text" name="items[' +
        ...
        var td11 = $(
            '<td class="hide"><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_expected" type="text" name="items[' +
            uniqueArray + '][price_expected]" value="' + tnhFormatNumber(item.price) + '" /></td>');
        var td12 = $(
            '<td ><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right price_suppliers "   type="text" name="items[' +
            uniqueArray + '][price_suppliers]" value="' + tnhFormatNumber(price_suppliers) + '" /></td>');
        var total_expected = Number(price_suppliers) * Number(item.quantity_net);
        var taxTemplate = taxes_dropdown_template;
        taxTemplate = taxTemplate.replace('name=""', 'name="items[' + uniqueArray + '][tax_id]"');
        var td13 = $('<td class="hide">' + taxTemplate + '<input type="hidden" class="tax_rate" name="items[' + uniqueArray +
            '][tax_rate]" value="0"></td>');
        var td14 = $('<td class="hide align_right total_expected">' + tnhFormatNumber(total_expected) + '</td>');
        var td15 = $(
            '<td ><input style="width: 100%" onchange="formatNumBerKeyUpCus(this)" class="height_auto H_input align_right promotion_expected" type="text" name="items[' +
            uniqueArray + '][promotion_expected]" value="0" /></td>');
    ...
    var createTrItem = (item, currentQuantityInput, type) => {
        ...
        new_tr.find('td.avatar').html(name_type + '\
            ...
            <input type="hidden" class="id_purchases_items" id="id_purchases_items" name="items[' + count + '][id_purchases_items]" value="' + item.id_purchases_items + '" />\
        ...
        new_tr.find('td > input.mainQuantity').val(tnhFormatNumber(item.quantity_net));
        new_tr.find('td > input.mainQuantity').attr('data-store', tnhFormatNumber(item.quantity_net));
        new_tr.find('td > input.mainQuantity_suppliers').val(tnhFormatNumber(item.quantity_net));
    ...
    function getTotalPrice() {
        ...
        $('.total_sub_suppliers').text(tnhFormatNumber(total_sub_suppliers_ch));
    ...
    function countrow() {
        ...
        $.each(items, (index, value) => {
            ...
            $(value).find('input.mainQuantity_suppliers').change();
    ...
    $(document).on('keyup', '.mainQuantity', (e) => {
        ...
        currentQuantityInput.parent().parent('tr').find('td > input.mainQuantity_suppliers').val(
            currentQuantityInput.val());
        if (parseInt(unformat_number(currentQuantityInput.val())) > parseInt(elementToCompare.attr('data-store'))) {
            ...
            currentQuantityInput.attr('title', 'Số lượng vượt mức theo phiếu yêu cầu! Dưới hoặc bằng: ' + parseInt(
        ...
        } else if (parseInt(unformat_number(currentQuantityInput.val())) <= 0) {
            currentQuantityInput.attr("style", "width: 100%;border: 1px solid red !important");
            currentQuantityInput.attr('data-toggle', 'tooltip');
            currentQuantityInput.attr('data-trigger', 'manual');
    ...
    function formatss(item) {
        ...
        if ($(originalOption).data('type_items') == 'tools' || $(originalOption).data('type_items') == 'items') {
            return "<b>" + $(originalOption).data('text') + "</b>"
        } else if ($(originalOption).data('type_items') == 'product' || $(originalOption).data('type_items') == 'nvl') {
            return "<b>" + $(originalOption).data('text') + "</b><br>" +
                "<span style='font-style: italic'><?= _l('ch_items_specification') ?>: </span>" + $(originalOption).data('mode')
        } else {
            return "<b>" + $(originalOption).data('text') + "</b>"
        }
    }
    ...
    //     $.each(_html, function (key, value) {
    //         if (key == 0) {
    //             __html += '<optgroup data-text="' + value.name + '">';
    //         } else if (value.id == 'h') {
    //             __html += '</optgroup>';
    //             __html += '<optgroup data-text="' + value.name + '">';
    //         } else {
    ...
    //                     __html += '<option selected data-text = "[' + value.code_item + '] ' + value.name + '" data-type_items="' + value.type_items + '" quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value.type_items + ' value="' + value.id + '">[' + value.code_item + '] ' + value.name + '</option>';
    //                 } else if (value.type_items == 'product' || value.type_items == 'nvl') {
    //                     __html += '<option selected data-text = "[' + value.code_item + '] ' + value.name + '" data-type_items="' + value.type_items + '"  data-mode="' + value.get_items.mode + '" quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value.type_items + ' value="' + value.id + '">[' + value.code_item + '] ' + value.name + '</option>';
    //                 } else {
    ...
    //             } else {
    //                 if (value.type_items == 'tools' || value.type_items == 'items') {
    //                     __html += '<option  data-text = "[' + value.code_item + '] ' + value.name + '" data-type_items="' + value.type_items + '" quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value.type_items + ' value="' + value.id + '">[' + value.code_item + '] ' + value.name + '</option>';
    //                 } else if (value.type_items == 'product' || value.type_items == 'nvl') {
    //                     __html += '<option  data-text = "[' + value.code_item + '] ' + value.name + '" data-type_items="' + value.type_items + '"  data-mode="' + value.get_items.mode + '" quantity_warehoue=' + value.quantity_warehoue + ' data-id=' + value.type_items + ' value="' + value.id + '">[' + value.code_item + '] ' + value.name + '</option>';
    //                 } else {
