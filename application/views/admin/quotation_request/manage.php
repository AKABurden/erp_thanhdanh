        ...
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php //if (has_permission('spending_plan', '', 'create')) { ?>
                    ...
                    <a href="<?= admin_url('quotation_request/submit') ?>" class="btn btn-info mright5 pull-right H_action_button">
...
<script>
    ...
    $(document).ready(function() {
        ...
        oTable = tnhInitDataTable('.table-tb-main', '', {
            ...
            'responsive': false,
            "ajax": {
                "url": site.base_url + 'admin/quotation_request/',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/quotation_request/export_excel',
            data: {
