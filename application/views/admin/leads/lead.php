                    ...
                    <div class="horizontal-tabs">
                        ...
                        <ul class="nav-tabs-horizontal nav nav-tabs<?php if (!isset($lead)) { echo ' lead-new'; } ?>" role="tablist">
                            ...
                            <?php if (isset($lead)) { ?>
                                ...
                                <?php } ?>
                                <?php if(!empty($bianroi)){ ?> <!--không sử dụng đến -->
                                    <li role="presentation">
                                ...
                                <!--Công bổ sung-->
                                <li role="presentation">
                                    <a href="#tab_contacts_lead" onclick="initDataTable('.table-contacts_lead', admin_url + 'leads/tableContactsLead/' + <?php echo $lead->id; ?>,'undefined', 'undefined','undefined',[0,'desc']);" aria-controls="tab_contacts_lead" role="tab" data-toggle="tab">
                                        <?php echo _l('cong_contacts'); ?>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="#tab_assigned" onclick="init_assigned_lead(<?php echo $lead->id; ?>)" aria-controls="tab_assigned" role="tab" data-toggle="tab">
                                        <?php echo _l('cong_lead_asigned_procedure_lead'); ?>
                                    </a>
                                </li>
                                <!--END công bổ sung-->
                ...
                <?php if (isset($lead)) { ?>
                                ...
                                <div class="lead-email-activity">
                                    ...
                                    <div class="media-body">
                                        <h4 class="bold no-margin lead-mail-activity-subject">
                                            <?php echo $_mail_activity['subject']; ?><br/>
                        ...
                        <div class="panel_s no-shadow">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="text-right">
                                    <button id="lead_enter_activity" class="btn btn-info">
                                        <?php echo _l('submit'); ?>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="tab_proposals_leads">
                        <?php if (has_permission('proposals', '', 'create')) { ?>
                            <a href="<?php echo admin_url('proposals/proposal?rel_type=lead&rel_id=' . $lead->id); ?>" class="btn btn-info mbot25">
                        ...
                        <?php if (total_rows(db_prefix() . 'proposals', array('rel_type' => 'lead', 'rel_id' => $lead->id)) > 0 && (has_permission('proposals', '', 'create') || has_permission('proposals', '', 'edit'))) { ?>
                            <a href="#" class="btn btn-info mbot25" data-toggle="modal" data-target="#sync_data_proposal_data">
                    ...
                    <!--Cong bổ sung-->
                    <?php
                        include_once(APPPATH . 'views/admin/leads/cong_tab/assigned.php');
                    ?>
                    <?php
                        include_once(APPPATH . 'views/admin/leads/cong_tab/contacts_lead.php');
                    ?>

                    <?php
                        include_once(APPPATH . 'views/admin/leads/cong_tab/advisory_lead.php');
                    ?>
                    <!--END Cong bổ sung-->


                    <div role="tabpanel" class="tab-pane" id="lead_reminders">
                        <a href="#" data-toggle="modal" class="btn btn-info" data-target=".reminder-modal-lead-<?php echo $lead->id; ?>">
                            <i class="fa fa-bell-o"></i> <?php echo _l('lead_set_reminder_title'); ?>
                        </a>
                        <hr/>
                                        ...
                                        <div class="media-body">
                                            ...
                                            <div data-note-edit-textarea="<?php echo $note['id']; ?>" class="hide mtop15">
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    <button type="button" class="btn btn-info" onclick="edit_note(<?php echo $note['id']; ?>);">
...
<?php
    include_once(APPPATH . 'views/admin/leads/lead_js.php');
?>
