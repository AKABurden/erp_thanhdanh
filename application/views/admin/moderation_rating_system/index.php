                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_rating_system" class="table dt-tnh table-moderation_rating_system-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?= lang('Mã hệ thống') ?></th>
                                            <th class="text-center"><?= lang('Tên hệ thống') ?></th>
                                            <th class="text-center"><?= lang('Chi tiết hệ thống') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_rating_system',
        '<?= site_url('admin/moderation_rating_system/getModerationEvaluate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/moderation_rating_system/getModerationEvaluate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_rating_system').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id, name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_rating_system/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_rating_system/exportExcel',
            data: {
