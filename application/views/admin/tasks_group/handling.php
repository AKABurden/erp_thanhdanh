<div class="modal-dialog modal-lg" style="min-width: 30%;">
    <?php echo form_open(
        admin_url('tasks_group/handling/' . $id . '/' . $type),
        ['id' => 'tasks_group']
    ); ?>
...
<script type="text/javascript">
    ...
    ajaxSelectParams('#machines_id', 'admin/tasks_group/searchMachines', $("#machines_id").val(), $("#category_machine_id").val(), true);
    $("#branch_id").select2();
    ...
    $("#category_machine_id").change(function() {
        ajaxSelectParams('#machines_id', 'admin/tasks_group/searchMachines', 0, $("#category_machine_id").val(), true);
    });
    $("#machines_id").change(function() {
        ...
        if (machines_id) {
            $.ajax({
                    url: site.base_url + 'admin/tasks_group/getMaintenaceMachines',
                    type: 'POST',
                    dataType: 'json',
                    data: {
