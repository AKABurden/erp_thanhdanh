    ...
    <div class="panel_s mbot10 H_scroll">
        <div class="panel-body _buttons">
            ...
            <div class="pull-right mright5 H_border">
                <a href="<?= base_url('admin/categories_other/handlingPlanningGroup/0/'.$status) ?>" class="btn btn-info H_action_button tnh-modal">
                    <?php echo _l('add'); ?>
                </a>
            </div>
        </div>
                                ...
                                <thead>
                                    <tr>
                                        <th class="text-center" style="width: 50px;">
                                            <div class="checkbox mass_select_all_wrap checkbox-info"><input type="checkbox" id="mass_select_all" data-to-table="planning-group"><label for="mass_select_all"></label>
                                            </div>
                                        </th>
                                        <th class="text-center"><?= lang('Mã nhóm kế hoạch') ?></th>
                                        <th class="text-center"><?= lang('Tên nhóm kế hoạch') ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        oTable = tnhInitDataTable('#table-planning-group', '', {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/categories_other/getPlanningGroup') ?>',
                "type": "POST",
                "data": function(d) {
