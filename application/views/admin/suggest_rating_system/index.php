...
<?php init_head(); ?>
<style type="text/css">
    #table-suggest-rating-system tr th:nth-child(1) {
        width: 40px;
    }
    #table-suggest-rating-system tr th:nth-child(4) {
        width: 150px;
    }
    #table-suggest-rating-system tr th:nth-child(5) {
        width: 150px;
    }
</style>
    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestRatingSystem): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_rating_system/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-rating-system" class="table dt-tnh table-suggest-rating-system-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-rating-system',
        '<?= site_url('admin/suggest_rating_system/getSuggestRatingSystems') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_rating_system/getSuggestRatingSystems') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_rating_system/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_rating_system/exportExcel',
            data: {
