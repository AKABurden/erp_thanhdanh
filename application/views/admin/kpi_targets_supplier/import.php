<?php echo form_open('admin/kpi_targets_supplier/excel_import/', array('id' => 'FormImportKPI', 'enctype' => 'multipart/form-data')); ?>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row">
                <div class="col-md-12">
                    <a target="_blank"
                       href="<?= $fileTemplate ?? '' ?>">Download file mẫu</a>
                </div>
                <div class="col-md-12">
