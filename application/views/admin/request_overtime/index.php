    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestOvertime): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_overtime/detail') ?>" class="btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-request-overtime" class="table dt-tnh table-request-overtime-new" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Lệnh Sản Xuất/Đơn Hàng') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-request-overtime',
        '<?= site_url('admin/request_overtime/getRequestOvertimes') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/request_overtime/getRequestOvertimes') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/request_overtime/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_overtime/exportExcel',
            data: {
