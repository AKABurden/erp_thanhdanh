                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-moderation_rating_process" class="table dt-tnh table-moderation_rating_process-new" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center"><?= lang('Mã quy trình') ?></th>
                                            <th class="text-center"><?= lang('Tên quy trình') ?></th>
                                            <th class="text-center"><?= lang('Chi tiết quy trình') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-moderation_rating_process',
        '<?= site_url('admin/moderation_rating_process/getModerationEvaluate') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/moderation_rating_process/getModerationEvaluate') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    $('#table-moderation_rating_process').on('draw.dt', function(event) {
        init_datepicker();
    });
    ...
    function updateDate(_this, id, name) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_rating_process/updateDate',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/moderation_rating_process/exportExcel',
            data: {
