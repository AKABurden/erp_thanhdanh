...
if (empty($start_date) || empty($end_date)) {
    echo 'Vui lòng nhập ngày bắt đầu và ngày kết thúc'; die;
}
...
<?php if (!empty($dtStaff)) : ?>
    ...
    <?php if($kpi_criteria): ?>
        ...
        <!-- <tr class="not-tr bold" style="background: #8080804a;">
            <td colspan="5" class="text-center"><?//= lang('Nhận xét của Trưởng Bộ phận') ?></td>
            <td colspan="8" class="text-center"><?//= lang('Thang điểm') ?></td>
        </tr> -->
        <tr class="not-tr text-center bold">
            <!-- <td colspan="5" rowspan="2" class="text-center">
                <textarea name="note" id="note" class="form-control note" rows="3"><?//= !empty($kpi) ? $kpi['note'] : '' ?></textarea>
            </td> -->
            <td colspan="2">
                <?php
        ...
        <tr class="not-tr">
            <td colspan="99" class="bold"><?= lang('Nhận xét tổng thể') ?></td>
        </tr>
        <tr class="not-tr">
            <td colspan="2" class="bold"><?= lang('Ưu điểm:') ?></td>
            <td colspan="99">
        ...
        <tr class="not-tr">
            <td colspan="2" class="bold"><?= lang('Những mặt cần khác phục, cố gắng hơn:') ?></td>
            <td colspan="99">
        ...
        <tr class="not-tr">
            <td colspan="2" class="bold"><?= lang('Các nhận xét khác:') ?></td>
            <td colspan="99">
