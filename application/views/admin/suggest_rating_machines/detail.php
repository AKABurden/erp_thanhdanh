<div class="modal-dialog modal-lg" style="min-width: 60%;">
    <?php echo form_open(admin_url('suggest_rating_machines/detail/' . $id),
        ['id' => 'suggest_rating_machines']); ?>
        ...
        <div class="modal-body">
            <table class="tnh-tb table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        <select name="result_id" id="result_id" class="result_id"
                                data-placeholder="<?= lang('Kết quả') ?>" style="width: 100%;">
                            <option value=""></option>
                    ...
                    <td colspan="1">
                        <input type="text" name="standard" id="standard" class="standard form-control"
                               data-placeholder="<?= lang('Tiêu Chuẩn/ Quy Định') ?>" value="<?= !empty($dtData) ? $dtData['standard'] : '' ?>"
                               title="">
                    </td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $("#branch_id").select2();
    $("#result_id").select2();
    appValidateForm($('#suggest_rating_machines'), {
        date: 'required',
