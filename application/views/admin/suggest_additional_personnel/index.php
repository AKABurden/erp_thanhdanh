    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestAdditionalPersonnel): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_additional_personnel/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-suggest_additional_personnel" class="table dt-tnh table-suggest_additional_personnel" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th class="text-center"><?= lang('Lý Do Yêu Cầu') ?></th>
                                        <th class="text-center"><?= lang('Người Tiếp Nhận') ?></th>
                                        <th class="text-center"><?= lang('Người Duyệt') ?></th>
                                        <th class="text-center"><?= lang('Vị Trí Cần Bổ Sung') ?></th>
                                        <th class="text-center"><?= lang('Số Lượng Người Bổ Sung') ?></th>
                                        <th class="text-center"><?= lang('Thời Gian Bổ Sung') ?></th>
                                        <th class="text-center"><?= lang('Người Quản Lý Tạm Thời') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest_additional_personnel',
        '<?= site_url('admin/suggest_additional_personnel/getSuggestAdditionalPersonnel') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/suggest_additional_personnel/getSuggestAdditionalPersonnel') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_additional_personnel/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_additional_personnel/exportExcel',
            data: {
