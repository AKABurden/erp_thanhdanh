            ...
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestCheck): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_check/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-check',
        '<?= site_url('admin/suggest_check/getSuggestChecks') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_check/getSuggestChecks') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_check/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_check/exportExcel',
            data: {
