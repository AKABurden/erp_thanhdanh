                    ...
                    <div class="wap-content mtop20">
                        <table class="table dataTable">
                            ...
                            <tr>
                                ...
                                <th style="" class="text-center">Quy định 5S</th>
                                        ...
                                        <tr class="rowID_<?=$rowID?>">
                                            ...
                                            <td>
                                                ...
                                                <div class="check_production_report_false_<?=$value['id']?> <?=(empty($value['result_id']) || $value['result_id'] == 1) ? 'hide' : ''?>">
                                                    <a class="btn btn-info btn-icon mbot10" href="<?=admin_url('production_report/detail?id_suggest_check_detail=' . $value['id'])?>" target="_blank">Tạo phiếu báo cáo</a>
                                                </div>
                                            </td>
...
<script type="text/javascript">
    ...
    function checkResult(id, _this) {
        ...
        data['id'] = id;
        data['result'] = result;
        $.get(admin_url + 'suggest_check/check_result', data, function(resultData) {
