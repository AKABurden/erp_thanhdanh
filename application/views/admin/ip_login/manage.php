        ...
        <div class="col-md-4 offset-md-4">
            <div class="panel_s">
                <div class="panel-body">
                    <?php echo form_open(admin_url('config_ip/confim'), ['id' => 'add_notes-form', 'class' => '_transaction_form invoice-form']); ?>
                        <?php echo render_input('code_active', 'Mã đăng nhập (6 chữ số)')?>
                        <?php $date_now = date('Y-m-d H:i:s');?>
                        <?php $seconds = (strtotime($date_end_code) - strtotime(date('Y-m-d H:i:s')));?>
                        <div class="outTime"><?=$seconds?></div>
                        <button type="submit" class="btn-info btn"> Kích hoạt</button>
                        <button type="button" class="btn-warning btn" onclick="logout(); return false;"> Vào lại trang đăng nhập</button>
                    <?php echo form_close();?>
                </div>
            </div>
        </div>
