                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            <a href="#" onclick="new_department(); return false;" class="btn btn-info pull-left display-block">
								<?php echo _l('Bộ phận mới'); ?>
                            </a>
                            <a class="btn btn-info pull-left H_action_button mleft5" onclick="ViewPDF(); return false;"><i class="fa fa-print"></i> <?php echo _l('In QR'); ?></a>
                        </div>
                        ...
                        <div class="col-md-4 hide">
                            <div class="hide_not_active">
                                <div class="checkbox checkbox-primary">
                                    <input type="checkbox" value="1" name="hide_not_active" id="hide_not_active" checked>
                                    <label for="hide_not_active">Ẩn các phòng ban không kích hoạt</label>
                                </div>
                                <hr>
                            </div>
                        </div>
						...
						<?php render_datatable(array(
							'<span class="hide"> - </span><div class="checkbox mass_select_all_wrap"><input type="checkbox" id="mass_select_all" data-to-table="departments"><label></label></div>',
							_l('Mã bộ phận'),
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">
                    <span class="edit-title"><?php echo _l('Sửa bộ phận'); ?></span>
                    <span class="add-title"><?php echo _l('Bộ phận mới'); ?></span>
                </h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
						...
						<?php echo render_input('code', 'Mã bộ phận'); ?>
						<?php echo render_input('name', 'Tên bộ phận'); ?>
                        ...
                        <hr/>
						<?php echo render_input('email', 'Email bộ phận', '', 'email'); ?>
...
<script>
    $(function () {
        initDataTable('.table-departments', window.location.href, [4], [0,4], {"hide_not_active" : "[name='hide_not_active']:checked"}, [1, 'asc']);
        $("[name='hide_not_active']").change(function() {
        ...
        appValidateForm($('form'), {
            ...
            code: {
                required: true,
                remote: {
                    url: admin_url + "departments/code_exists",
                        type: 'post',
                        data: {
                        email: function () {
    ...
    function ViewPDF() {
        var ids = '';
        var rows = $('.table-departments').find('tbody tr');
        $.each(rows, function() {
        ...
        if (!ids) {
            bootbox.alert('Xin vui lòng chọn bộ phận cần in mã vạch');
            return;
        }
        url = admin_url + 'departments/print_pdf_html?ids=' + ids;
