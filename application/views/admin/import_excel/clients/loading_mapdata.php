...
<div id="wrapper">
    <div class="panel_s">
            ...
            <h1 class="text-center"><?= _l('cong_system_map_data_client_list_fb')?></h1>
            ...
            <div class="col-md-6 col-md-offset-3">
                <div class="col-md-4"><?= _l('cong_data_to_map_success') ?></div>
                <div class="col-md-4"><?= _l('cong_data_to_map_not_found')?></div>
                <div class="col-md-4"><?=_l('cong_data_to_map_false')?></div>
            </div>
            <div class="col-md-6 col-md-offset-3">
...
<script>
    ...
    if(DataClients.length > 0) {
        ...
        console.log(countClients - nowData - 1)
        if (typeof(csrfData) !== 'undefined') {
            data[csrfData['token_name']] = csrfData['hash'];
        }
        $.post("<?=admin_url('import_excel/MapClient')?>", data, function(result) {
