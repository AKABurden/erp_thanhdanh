                ...
                <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="radio radio-primary pull-left">
                            <input type="radio" name="type_import" value="1" checked>
                                <label for="single"><?=_l('ADD')?></label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="radio radio-primary pull-left mbot10 mleft20" style="margin-top: 10px !important;">
                            <input type="radio" name="type_import" value="2" >
                            <label for="single"><?=_l('UPDATE')?> (Bắt buộc phải có Mã Khách Hàng tồn tại trong hệ thống)</label>
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<script>
    ...
    $('body').on('change', 'select.fieldsColums', function(e){
        ...
        var ListArray = ['dt' ,'type_client', 'kt', 'marriage', 'religion', 'city', 'district', 'ward', 'sources', 'ward', 'groups_in'];
