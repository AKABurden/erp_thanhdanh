<div class="modal-dialog modal-lg" style="min-width: 60%;">
    <?php echo form_open(
        admin_url('suggest_personal_income_tax/detail/' . $id),
        ['id' => 'suggest_personal_income_tax']
    ); ?>
    <div class="modal-content">
        ...
        <div class="modal-body">
            <table class="tnh-tb table-bordered table-hover">
                ...
                <tr>
                    <td>
                        <?= lang('Thu nhập chịu thuế', 'total_taxable') ?>
                    </td>
                    <td colspan="1">
                        <input type="text" name="total_taxable" class="total_taxable form-control number-format" value="<?= !empty($dtData) ? formatMoney($dtData['total_taxable']) : 0 ?>">
                    </td>
                    <td>
                        <?= lang('Thu nhập tính thuế', 'total_tax_calculation') ?>
                    </td>
                    <td colspan="1">
                        <input type="text" name="total_tax_calculation" class="total_tax_calculation form-control number-format" value="<?= !empty($dtData) ? formatMoney($dtData['total_tax_calculation']) : 0 ?>">
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="3">
                        <input type="text" name="total_tax" class="total_tax form-control number-format" value="<?= !empty($dtData) ? formatMoney($dtData['total_tax']) : 0 ?>">
                    </td>
                </tr>
                </tbody>
            </table>
...
<script type="text/javascript">
    ...
    $("#branch_id").select2();
    appValidateForm($('#suggest_personal_income_tax'), {
        date: 'required',
