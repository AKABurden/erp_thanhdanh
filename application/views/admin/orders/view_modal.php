      ...
      <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">
                <span class="book-title"><?=!empty($title) ? $title : ''?> <b class="text-<?=$type?>">(<?=!empty($orders) ? $orders->name_status : '';?>) </b></span>
            </h4>
          </div>
            ...
            <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="row-contro">
                                            <div><?=_l('cong_code_orders')?>: </div>
                                            <div class="ml-at t-bold"><?php echo $orders->prefix.$orders->code ?></div>
                                        </div>
                                        <div class="row-contro">
                                                <div><?=_l('cong_customer_orders')?>: </div>
                                                <div class="ml-at t-bold"><?php echo $orders->company?>
                                        </div>
                                        <div class="row-contro">
                                                <div><?=_l('cong_note')?>: </div>
                                                <div class="ml-at t-bold"><?php echo $orders->note?></div>
                                        </div>
                                    </div>
                                    <md- class="col-md-6">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8">
                                            <?php echo staff_profile_image( (!empty($orders->create_by) ? $orders->create_by : ''), [
                                                'staff-profile-image-small'], 'small',[
                                                'data-toggle' => 'tooltip',
                                                'data-title' => !empty($orders->create_by) ? get_staff_full_name($orders->create_by) : ''
                                            ])  ?>
                                        </div>
                                        ...
                                        <div class="col-md-8">
                                            <?php echo _dt($orders->date_create) ?>
                                        </div>
                                        <div class="clearfix"></div>
                                        ...
                                        <div class="col-md-8">
                                            <?php echo staff_profile_image( (!empty($orders->assigned) ? $orders->assigned : ''), [
                                                'staff-profile-image-small'], 'small',[
                                                'data-toggle' => 'tooltip',
                                                'data-title' => !empty($orders->create_by) ? get_staff_full_name($orders->assigned) : ''
                                            ])  ?>
                                        </div>
                                        <div class="clearfix"></div>
                                    </div>
              ...
              <div class="col-md-12">
                  <div class="table-responsive">
                      <table  class="table table-bordered table-hover table-striped table-color dont-responsive-table" style="width: 100%; margin-bottom: 5px;">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                    <?php foreach($orders->detail as $key => $Vorder){?>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-center"><img src="<?=base_url($Vorder->avatar);?>" class="c_img_item_30"></p>
                                            </td>
                                            <td>
