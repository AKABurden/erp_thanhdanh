<div id="inventory_tp_hs-report" class="hide">
    <div class="row">
        <div class="col-md-3">
            <div class="form-group" style="width:100%;">
                <label for="products_id_hs"><?php echo _l('Thành phẩm'); ?></label>
                <input style="width:100%;" data-placeholder="<?= _l('dropdown_non_selected_tex') ?>" name="products_id_hs" class="products_id_hs" id="products_id_hs" name="products_id_hs" style="width: 100%">
            </div>
        </div>
    </div>
    <br>
    <table class="table table table-striped table-inventory_tp_hs-report">
        <thead>
            <tr>
