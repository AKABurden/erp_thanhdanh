      ...
      <table class="table table table-striped table-stock-card-report">
         <thead>
            <tr class="bold" style="text-align: center;font-weight: bold;">
               ...
               <th style="text-align: center;"><?php echo ucwords(_l('tnh_reference_productions_orders_details')); ?></th>
               ...
               <th style="text-align: center;"><?php echo ucwords(_l('ch_quantity_accumulated')); ?></th>
            </tr>
         </thead>
         <tbody></tbody>
         <tfoot>
