...
<div class="text-center uppercase">
    <h2><?= lang('report_productions_orders_detail_1') ?></h2>
</div>
<hr>
    ...
    <table id="tb-reports" class="table" style="width: 100%;">
        <thead>
            <tr>
                ...
                <th class="text-center"><?= lang('tnh_category_code') ?></th>
                <th class="text-center"><?= lang('tnh_category_name') ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        oTable = tnhInitDataTable('#tb-reports', '<?= site_url('admin/reports_tnh/getProductionsCategory') ?>', {
            'order': [
                [2, 'desc']
            ],
            'fixedHeader': {
            ...
            'responsive': true,
            "ajax": {
                "url": '<?= site_url('admin/reports_tnh/getProductionsCategory') ?>',
                "type": "POST",
                "data": function(d) {
