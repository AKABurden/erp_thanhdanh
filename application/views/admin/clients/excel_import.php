<div id="modal_import_excel" class="modal fade" role="dialog">
    <form action="<?= admin_url('roles/excel_import') ?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'clients/excel_import_group';
