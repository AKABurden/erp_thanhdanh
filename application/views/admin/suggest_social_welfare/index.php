    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestSocialWelfare) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_social_welfare/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-suggest_social_welfare" class="table dt-tnh table-suggest_social_welfare" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center"><?= lang('Nội Dung Diễn Giải') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest_social_welfare',
        '<?= site_url('admin/suggest_social_welfare/getSuggestSocialWelfare') ?>', {
            'order': [
                [0, 'desc']
            ],
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/suggest_social_welfare/getSuggestSocialWelfare') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_social_welfare/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/suggest_social_welfare/exportExcel',
            data: {
