...
<?php echo form_open(
    'admin/request_place_the_tank_mold/detail/' . $id . '',
    array('id' => 'request_place_the_tank_mold')
); ?>
<div id="wrapper">
                    ...
                    <table id="tb-purchases" class="dt-tnh table table-hover dataTable" style="width: 100%;">
                        <thead>
                            <tr>
                                ...
                                <th style="width: 80px;"><?= lang('Height NPL') ?></th>
                                <th style="width: 80px;"><?= lang('Width NPL') ?></th>
                                <th style="width: 80px;"><?= lang('Đơn vị tính') ?></th>
                                <th style="width: 80px;"><?= lang('Tổng số lượng') ?></th>
                                <th style="width: 100px;"><?= lang('Mã thiết bị vận hành') ?></th>
                                <th style="width: 80px;"><?= lang('Định Mức Năng Suất/Giờ') ?></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="code_item">
                                                ...
                                                <input type="hidden" name="request_place_the_tank_mold_id[<?= $counter ?>]" class="request_place_the_tank_mold_id" value="<?= $value['id'] ?>">
                                                <?= $info['code'] ?>
                                            </div>
                                        </td>
                                        <td class="text-left">
...
<?php $this->load->view('admin/request_place_the_tank_mold/script_js.php') ?>