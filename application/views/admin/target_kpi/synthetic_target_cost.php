                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                                ...
                                <div id="search-tnh" class="collapse in" aria-expanded="true">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select name="department_search" id="department_search" data-live-search="true" class="form-control selectpicker department_search"  data-none-selected-text="<?= lang('Phòng ban') ?>" data-placeholder="<?= lang('Phòng ban') ?>">
                            ...
                            <div class="table-responsive"  style="margin-bottom: 100px;">
                                <table id="table_synthetic_tagert_cost" class="table dt-tnh table_synthetic_tagert_cost" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        ...
                                        <th rowspan="2" class="text-center"><?= lang('Tổng hợp') ?></th>
                                    </tr>
                                    <tr>
                                        <?php for($i = 1; $i <= 12; $i++) {?>
...
<script>
    ...
    oTable = tnhInitDataTable('#table_synthetic_tagert_cost', '<?= site_url('admin/target_kpi/getSyntheticTagertCost') ?>', {
        'order': [
            [0, 'asc'],
            [3, 'desc']
        ],
        ...
        scrollX:true,
        "ajax": {
            "url": '<?= site_url('admin/target_kpi/getSyntheticTagertCost') ?>',
            "type": "POST",
            "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/target_kpi/excelSyntheticTagertCost',
            data: {
