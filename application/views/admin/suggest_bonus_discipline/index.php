...
<?php init_head(); ?>
<style type="text/css">
    #table-suggest-bonus-discipline tr th:nth-child(3) {
        width: 120px;
    }

    #table-suggest-bonus-discipline tr th:nth-child(7) {
        width: 200px;
        text-align: center;
    }
</style>
    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddSuggestBonusDiscipline): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/suggest_bonus_discipline/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="clearfix"></div>
                            <div class="">
                                <table id="table-suggest-bonus-discipline" class="table dt-tnh table-suggest-bonus-discipline" style="width: 100%;">
                                    <thead>
                                    <tr>
                                        <th class="text-center"><?= lang('STT') ?></th>
                                        <th class="text-center"><?= lang('Mã Số Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Phiếu Đề Xuất Đánh Giá KPI') ?></th>
                                        <th class="text-center"><?= lang('Ngày Lập Phiếu') ?></th>
                                        <th class="text-center"><?= lang('Đối Tượng') ?></th>
                                        <th class="text-center"><?= lang('Số Tiền') ?></th>
                                        <th class="text-center"><?= lang('Loại Đinh mức') ?></th>
                                        <th class="text-center"><?= lang('Định Mức Khen Thưởng-Kỷ Luật') ?></th>
                                        <th class="text-center"><?= lang('Phiếu báo cáo') ?></th>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-suggest-bonus-discipline',
        '<?= site_url('admin/suggest_bonus_discipline/getSuggestBonusDisciplines') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/suggest_bonus_discipline/getSuggestBonusDisciplines') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url+'admin/suggest_bonus_discipline/agree',
            data: dataPOST,
            dataType: "json",
