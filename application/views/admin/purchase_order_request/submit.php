...
<?php echo form_open('admin/purchase_order_request/submit/' . ($id ?? '') . '', array('id' => 'submit_form')); ?>
<div>
                            ...
                            <?php $counter = 0; if(!empty($value['items'])) {
                                foreach($value['items'] as $itemRow => $itemValue) {
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="code_item"><input type="text" name="link[<?= $counter ?>]" class="link form-control" value="<?= $itemValue['link'] ?>"></div></td>
                                        <td class="text-left">
                                            <div class="td-timequota"><input type="text" name="timequota[<?= $counter ?>]" class="number-format timequota form-control" value="<?= formatNumber($itemValue['timequota']) ?>"></div>
                                        </td>
...
<script type="text/javascript">
    ...
    function loadItem(item = {}){
        ...
        tdLink = `<div class="code_item"><input type="text" name="link[${counter}]" class="link form-control" value=""></div>`;
    ...
    function submit(form) {
        ...
        .done(function(data) {
            ...
            if (data.result) {
                ...
                // window.location.href = site.base_url+'admin/purchase_order_request';
