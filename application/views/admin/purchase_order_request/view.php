            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        <div class="row-contro">
                            <?php
                            $client = get_table_where('tblclients',['userid' => $value['client_id']],'','row_array');
                            ?>
                            <div><?= lang('Khách hàng') ?>: </div>
                            <div class="ml-at t-bold"><?= $client['zcode'] . ' ('. $client['company'].')' ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('note') ?>: </div>
                                        ...
                                        <?php if (!empty($value['items'])){ ?>
                                            <?php foreach($value['items'] as $itemRow => $itemValue) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><div class="link_item"><?= $itemValue['link'] ?></div></td>
                                                    <td><div class="quota_time_change_one_item text-right"><?= (!empty($itemValue['timequota']) ? formatNumber($itemValue['timequota']) : 0) ?></div></td>
