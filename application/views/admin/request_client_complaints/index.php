...
<style type="text/css">
    ...
    #table-request_client_complaints tr th:nth-child(2) {
        width: 100px;
    }

    #table-request_client_complaints tr th:nth-child(7) {
        width: 80px;
    }
    #table-request_client_complaints tr th:nth-child(9) {
        width: 100px;
    }
    #table-request_client_complaints tr th:nth-child(10) {
        width: 250px;
    }
</style>
    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestClientComplaints) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_client_complaints/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-request_client_complaints" class="table dt-tnh table-request_client_complaints-new" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-request_client_complaints',
        '<?= site_url('admin/request_client_complaints/getRequestClientComplaints') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            "ajax": {
                "url": '<?= site_url('admin/request_client_complaints/getRequestClientComplaints') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function agree(_this, suggest_id, status) {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_client_complaints/agree',
            data: dataPOST,
            dataType: "json",
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_client_complaints/exportExcel',
            data: {
