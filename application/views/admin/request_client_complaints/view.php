            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Tên Brand') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['name_brand']) ?></div>
                        </div>
                        <div class="row-contro">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Người Khiếu Nại') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['fullname']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Nhóm Khiếu Nại') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['category_complaints'] ?></div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="lead-view" id="leadViewWrapper">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Chi Tiết Khiếu Nại') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['detail_complaints']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Người Tiếp Nhận (TD)') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['staff_tn']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Định Mức Thời Gian') ?>: </div>
                            <div class="ml-at t-bold"><?= ($dtData['timequota']) ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Nguyên Nhân') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['causal'] ?></div>
                        </div>
                        <div class="row-contro">
                            <div><?= lang('Quy Trình Xử Lý') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['processing_procedures'] ?></div>
                        </div>
                        <div class="row-contro">
                        ...
                        <div class="row-contro">
                            <div><?= lang('Quy Trình Phòng Ngừa') ?>: </div>
                            <div class="ml-at t-bold"><?= $dtData['prevention_procedures'] ?></div>
                        </div>
                    </div>
                </div>
