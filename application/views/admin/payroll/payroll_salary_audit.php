...
<?php echo form_open('admin/payroll/add_payroll_salary_audit', array('id' => 'payroll')); ?>
<div id="wrapper">
...
<script>
    ...
    function loadPayrollSalary() {
        ...
        if (month && year && branch_search) {
            $.ajax({
                type: "GET",
                url: site.base_url + 'admin/payroll/loadPayrollSalaryAudit',
                data: {
                    month: month,
                    year: year,
        ...
        $.ajax({
            ...
            .done(function(data) {
                if (data.result) {
                    ...
                    window.location.href = site.base_url + 'admin/payroll/payroll_salary_audit';
                } else {
