...
<div id="wrapper">
    <div class="panel_s mbot10 H_scroll" id="H_scroll">
        <div class="panel-body _buttons">
            <div class="_buttons">
                <span class="bold uppercase fsize18 H_title"><?= lang('Kế hoạch thu') ?></span>
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <?php echo render_date_input('date_start', 'Từ ngày', '', ['placeholder' => 'Từ ngày']) ?>
                            </div>
                            <div class="col-md-3">
                                <?php echo render_date_input('date_end', 'Đến ngày', '', ['placeholder' => 'Từ ngày']) ?>
                            </div>
                        </div>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-horizontal" role="tablist">
                                        <li class="active">
                                            <a class="H_filter" data-id="">
                                                <?= _l('cong_all') ?> <b class="filter_all hide"></b>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="H_filter" data-id="1">
                                                Chưa hoàn thành <b class="filter_0 hide"></b>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="H_filter" data-id="2">
                                                Đã hoàn thành <b class="filter_1 hide"></b>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                        ...
                        <table id="data-table" class="table-plan_propose table dt-tnh table-hover" style="width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center"><?= lang('Phiếu ĐXNB/Hóa đơn') ?></th>
...
<script>
    ...
    $(function() {
        ...
        oTable = tnhInitDataTable('.table-plan_propose', '', {
        'ordering': false,
        'fixedHeader': {
            header: true,
        },
        'responsive': true,
        "ajax": {
            "url": '<?= site_url('admin/plan_propose/table_plan_propose') ?>',
            "type": "POST",
            "data": function(d) {
