                    ...
                    <div class="panel-body">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table id="table-synthetic-releases" class="table dt-tnh table-synthetic-releases-new" style="width: 100%;">
                                    <thead>
                                    <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-synthetic-releases',
        '<?= site_url('admin/releases/getSyntheticDelivery') ?>', {
            'order': false,
            'fixedHeader': {
                header: true,
            },
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/releases/getSyntheticDelivery') ?>',
                "type": "POST",
                "data": function(d) {
                ...
                "dataSrc": function(json) {
                    $('.table-synthetic-releases-new tfoot tr td:nth-child(19)').html('<div class="text-center">'+tnhFormatMoney(json.total_quantity)+'</div>');
                    $('.table-synthetic-releases-new tfoot tr td:nth-child(22)').html('<div class="text-right">'+tnhFormatMoney(json.grand_total)+'</div>');
                    return json.aaData;
                }
            },
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/releases/exportExcelSyntheticDelivery',
            data: {
