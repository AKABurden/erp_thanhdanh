...
<?php echo form_open('admin/releases/add_delivery', array('id' => 'orders')); ?>
<div id="wrapper">
						...
						<table class="tnh-tb table-bordered table-hover">
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<input type="text" name="reference_orders[]" data-placeholder="<?= lang('tnh_reference_orders') ?>" id="reference_orders" class="reference_orders" required style="width: 100%;" value="">
										</div>
									</td>
