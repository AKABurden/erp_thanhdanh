    ...
    <div class="panel_s mbot10 H_scroll" id="" style="margin-bottom: unset">
        <div class="panel-body ">
            <div class="_buttons">
                ...
                <?php if ($this->preAddRequestPlanCalibration) : ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/request_plan_calibration/detail') ?>" class=" tnh-modal btn btn-info H_action_button">
                            <?php echo _l('add'); ?>
                        </a>
                    </div>
                <?php endif ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <div class="table-responsive">
                                    <table id="table-request_plan_calibration" class="table dt-tnh table-request_plan_calibration-new" style="width: 100%;">
                                        <thead>
                                            <tr>
...
<script>
    ...
    oTable = tnhInitDataTable('#table-request_plan_calibration',
        '<?= site_url('admin/request_plan_calibration/getRequestPlanCalibration') ?>', {
            'order': [
                [0, 'desc']
            ],
            'fixedHeader': {
            ...
            scrollX:true,
            "ajax": {
                "url": '<?= site_url('admin/request_plan_calibration/getRequestPlanCalibration') ?>',
                "type": "POST",
                "data": function(d) {
    ...
    function exportExcel() {
        ...
        $.ajax({
            type: "POST",
            url: site.base_url + 'admin/request_plan_calibration/exportExcel',
            data: {
