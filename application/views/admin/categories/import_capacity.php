<div id="modal_import_excel_capacity" class="modal fade" role="dialog">
    <form action="<?=admin_url('categories/import_capacity')?>" id="capacity_import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?=base_url('uploads/template/template_Danh_muc_loi.xlsx?vs=1.1')?>">Download file mẫu</a>
...
<script>
    $('#modal_import_excel_capacity').modal('show');
    function get_data_file_excel() {
        ...
        var url = admin_url + 'categories/import_capacity';
        var file_data = $('#capacity_import_form input#file_import').prop('files');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#modal_import_excel_capacity').modal('hide');
