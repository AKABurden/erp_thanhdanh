<?php echo form_open('admin/categories/add_transportation_vehicles',array('id'=>'add-transportation-vehicles')); ?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title"><?= _l('tnh_add_transportation_vehicles'); ?></h4>
		</div>
...
<script>
    $(function(){
       	appValidateForm($('#add-transportation-vehicles'), {
           code: 'required',
           name: 'required'
        }, addTransportationVehicles);

        function addTransportationVehicles(form) {
            ...
            var url = form.action;
            $.ajax({
            	url: site.base_url+'admin/categories/add_transportation_vehicles',
            	type: 'POST',
            	dataType: 'JSON',
            	data: data,
            })
