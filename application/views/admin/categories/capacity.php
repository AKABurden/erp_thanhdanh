...
<div id="wrapper">
    ...
    <!-- <div> -->
        <div class="panel-body _buttons">
            ...
            <a href="<?= base_url('admin/categories/modal_excel_capacity') ?>" class="btn btn-info pull-right mright10 H_action_button c_modal">
    ...
    $(document).ready(function() {
        oTable = tnhDatatable(
            '#table-capacity',
            {
                ...
                buttons: get_datatable_buttons('#table-capacity'),
            }
        );
