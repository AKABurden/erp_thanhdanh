...
{
    $table = '<table class="table dont-responsive-table customizable-table dt-table-loading ' . ($name == '' ? 'tickets-table' : $name) . ' table-tickets" id="table-tickets" data-last-order-identifier="tickets" data-default-order="' . get_table_last_order('tickets') . '">';
    $table .= '<thead>';
    $table .= '<tr>';
    ...
    $table .= '<th class="toggleable" id="th-tags">' . _l('classify_complain') . '</th>';
    ...
    $table .= '<th class="toggleable" id="th-order">' . _l('tnh_orders') . '</th>';
