...
function app_init_customer_profile_tabs()
{
    ...
    $CI->app_tabs->add_customer_profile_tab('coupon_support', [
        'name'     => _l('coupon_support'),
        'icon'     => 'lnr lnr-file-empty',
        'view'     => 'admin/clients/groups/coupon_support',
        'position' => 11,
    ]);
    ...
    $CI->app_tabs->add_customer_profile_tab('orders', [
        'name'     => _l('orders'),
        'icon'     => 'lnr lnr-cart',
        'view'     => 'admin/clients/groups/orders',
        'visible'  => (has_permission('orders', '', 'view') || has_permission('orders', '', 'view_own')),
        'position' => 26,
        'table'    => 'tbl_orders',
    ]);
    ...
    $CI->app_tabs->add_customer_profile_tab('contracts', [
        ...
        'visible'  => (has_permission('contracts_sales', '', 'view') || has_permission('contracts_sales', '', 'view_own')),
        'position' => 60,
        'table'    => 'tbl_contracts_sales',
    ]);

    $CI->app_tabs->add_customer_profile_tab('deliveries', [
        'name'     => _l('deliveries'),
        'icon'     => 'lnr lnr-car',
        'view'     => 'admin/clients/groups/deliveries',
        'position' => 61,
        'table'    => 'tbl_deliveries',
    ]);

    $CI->app_tabs->add_customer_profile_tab('vouchers_coupon', [
        'name'     => _l('vouchers_for_coupon'),
        'icon'     => 'lnr lnr-file-empty',
        'view'     => 'admin/clients/groups/vouchers_coupon',
        'position' => 62,
        'table'    => 'tblvouchers_coupon',
    ]);

    $CI->app_tabs->add_customer_profile_tab('other_payslips_coupon', [
        'name'     => _l('other_payslips_coupon'),
        'icon'     => 'lnr lnr-file-empty',
        'view'     => 'admin/clients/groups/other_payslips_coupon',
        'table'    => 'tblother_payslips_coupon',
        'position' => 63,
    ]);
    ...
    //Công bổ sung
     $CI->app_tabs->add_customer_profile_tab('care_of_clients', [
         'name'     => _l('cong_care_of_client'),
         'icon'     => 'lnr lnr-history',
         'view'      => 'admin/clients/groups/care_of_clients',
         'position' => 11,
     ]);
     $CI->app_tabs->add_customer_profile_tab('advisory_lead', [
         'name'     => _l('cong_advisory_lead'),
         'icon'     => 'lnr lnr-history',
         'view'      => 'admin/clients/groups/advisory_lead',
         'position' => 11,
     ]);
     //Công bổ sung
     $CI->app_tabs->add_customer_profile_tab('history_deal', [
         'name'     => _l('cong_history_deal'),
         'icon'     => 'lnr lnr-list',
         'view'     => 'admin/clients/groups/history_deal',
         'position' => 12,
     ]);
     $CI->app_tabs->add_customer_profile_tab('recommendations', [
         'name'     => _l('cong_product_recommendations'),
         'icon'     => 'lnr lnr-mustache',
         'view'     => 'admin/clients/groups/recommendations',
         'position' => 13,
     ]);
    $CI->app_tabs->add_customer_profile_tab('history_active', [
        'name'     => _l('Lịch sử hoạt động'),
        'icon'     => 'fa fa-product-hunt',
        'view'     => 'admin/clients/groups/history_active',
        'position' => 96,
    ]);
    //end công bổ sung
}
