...
function app_init_settings_tabs()
{
    ...
    $CI->app_tabs->add_settings_tab('config_ip', [
        'name'     => _l('config_ip'),
        'view'     => 'admin/settings/includes/config_ip',
        'position' => 6,
    ]);

    $CI->app_tabs->add_settings_tab('software_extension', [
        'name'     => _l('software_extension'),
        'view'     => 'admin/settings/includes/software_extension',
        'position' => 7,
    ]);
    ...
    $CI->app_tabs->add_settings_tab('social', [
        'name'     => _l('Social'),
        'view'     => 'admin/settings/includes/social',
        'position' => 95,
    ]);
    ...
    $CI->app_tabs->add_settings_tab('dashboard_srceen', [
        'name'     => _l('Trang Dashboard'),
        'view'     => 'admin/settings/includes/dashboard_srceen',
        'position' => 105,
    ]);
    $CI->app_tabs->add_settings_tab('orders', [
        'name'     => _l('orders'),
        'view'     => 'admin/settings/includes/orders',
        'position' => 105,
    ]);
    $CI->app_tabs->add_settings_tab('quotes', [
        'name'     => _l('quotes'),
        'view'     => 'admin/settings/includes/quotes',
        'position' => 105,
    ]);
    $CI->app_tabs->add_settings_tab('production_report', [
        'name'     => _l('Báo cáo không phù hợp'),
        'view'     => 'admin/settings/includes/production_report',
        'position' => 106,
    ]);
    $CI->app_tabs->add_settings_tab('salary', [
        'name'     => _l('tnh_salary'),
        'view'     => 'admin/settings/includes/salary',
        'position' => 106,
    ]);
    $CI->app_tabs->add_settings_tab('warehouse', [
        'name'     => _l('warehouse'),
        'view'     => 'admin/settings/includes/warehouse',
        'position' => 105,
    ]);
    $CI->app_tabs->add_settings_tab('input_tax', [
        'name'     => _l('Thuế đầu vào'),
        'view'     => 'admin/settings/includes/input_tax',
        'position' => 106,
    ]);
    $CI->app_tabs->add_settings_tab('download_app', [
        'name'     => _l('Tải link phiên bản app'),
        'view'     => 'admin/settings/includes/download_app',
        'position' => 110,
    ]);
}
