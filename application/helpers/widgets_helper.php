...
function get_dashboard_widgets()
{
    $widgets = [
        ...
        // ],
        [
            'path'      => 'admin/dashboard/widgets/dashboard_chart',
            'container' => 'top-12',
        ],
        [
            'path'      => 'admin/dashboard/widgets/birthday_staff',
            'container' => 'right-4',
        ],
        [
            'path'      => 'admin/dashboard/widgets/birthday_client',
            'container' => 'right-4',
        ],
        [
...
function get_dashboard_widgets_client()
{
    $widgets = [
        [
            'path'      => 'admin/clients/dashboard/official_client',
            'container' => 'top-left-md-3',
        ],
        [
            'path'      => 'admin/clients/dashboard/potential_client',
            'container' => 'top-middle-left-md-3',
        ],
        [
            'path'      => 'admin/clients/dashboard/contact_client',
            'container' => 'top-middle-right-md-3',
        ],
        [
            'path'      => 'admin/clients/dashboard/group_client',
            'container' => 'top-right-md-3',
        ],
        [
            'path'      => 'admin/clients/dashboard/list_client',
            'container' => 'second-left-md-6',
        ],
        [
            'path'      => 'admin/clients/dashboard/birthday_client',
            'container' => 'second-right-md-6',
        ],
        [
            'path'      => 'admin/clients/dashboard/chart_clients',
            'container' => 'third-left-md-6',
        ],
        [
            'path'      => 'admin/clients/dashboard/chart_leads',
            'container' => 'third-right-md-6',
        ],
        [
            'path'      => 'admin/clients/dashboard/activity_log',
            'container' => 'second-left-md-4',
        ],
        // [
        //     'path'      => 'admin/clients/dashboard/flowChart_client',
        //     'container' => 'second-md-12',
        // ],
        // [
        //     'path'      => 'admin/dashboard/widgets/user_data',
        //     'container' => 'left-8',
    ...
    return hooks()->apply_filters('get_dashboard_widgets_client', $widgets);
}
 ...
 * @return mixed
 */
function render_dashboard_widgets_client($container)
{
    $widgets = get_dashboard_widgets_client();
    ...
    $staff_dashboard = get_staff_meta(get_staff_user_id(), 'dashboard_widgets_order_client');
    $staff_dashboard = !$staff_dashboard ? [] : unserialize($staff_dashboard);
...
function get_dashboard_widgets_suppliers()
{
    $widgets = [
        [
            'path'      => 'admin/suppliers/dashboard/official_suppliers',
            'container' => 'top-left-md-3',
        ],
        [
            'path'      => 'admin/suppliers/dashboard/contact_suppliers',
            'container' => 'top-middle-left-md-3',
        ],
        [
            'path'      => 'admin/suppliers/dashboard/invoice_item_suppliers',
            'container' => 'top-middle-right-md-3',
        ],
        [
            'path'      => 'admin/suppliers/dashboard/debt_suppliers',
            'container' => 'top-right-md-3',
        ],
        [
            'path'      => 'admin/suppliers/dashboard/table_purchase_order',
            'container' => 'table_purchase_order',
        ],
        // [
        //     'path'      => 'admin/suppliers/dashboard/flowChart_suppliers',
        //     'container' => 'second-md-12',
        // ],
        // [
        //     'path'      => 'admin/suppliers/dashboard/chart_debt',
        //     'container' => 'third-left-md-6',
        // ],
        // [
        //     'path'      => 'admin/suppliers/dashboard/number_invoice',
        //     'container' => 'third-right-md-6',
        // ],
    ];

    return hooks()->apply_filters('get_dashboard_widgets_suppliers', $widgets);
}
 ...
 * @return mixed
 */
function render_dashboard_widgets_suppliers($container)
{
    $widgets = get_dashboard_widgets_suppliers();
    ...
    $staff_dashboard = get_staff_meta(get_staff_user_id(), 'dashboard_widgets_order_suppliers');
    $staff_dashboard = !$staff_dashboard ? [] : unserialize($staff_dashboard);
...
function get_dashboard_widgets_screen_work_customer()
{
    $widgets = [
        [
            'path'      => 'admin/screen_work/dashboard/leads',
            'container' => 'top-left-md-6',
        ],
        [
            'path'      => 'admin/screen_work/dashboard/after_receiving',
            'container' => 'top-right-md-6',
        ],
        [
            'path'      => 'admin/screen_work/dashboard/order',
            'container' => 'second-left-md-6',
        ],
        [
            'path'      => 'admin/screen_work/dashboard/support',
            'container' => 'second-right-md-6',
        ],
    ];

    return hooks()->apply_filters('get_dashboard_widgets_screen_work_customer', $widgets);
}
 ...
 * @return mixed
 */
function render_dashboard_widgets_screen_work_customer($container)
{
    $widgets = get_dashboard_widgets_screen_work_customer();
    ...
    $staff_dashboard = get_staff_meta(get_staff_user_id(), 'dashboard_widgets_screen_work_customer');
    $staff_dashboard = !$staff_dashboard ? [] : unserialize($staff_dashboard);
