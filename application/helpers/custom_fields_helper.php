...
/**
 * [deleteCustomFields description]
 * @param  [type] $fieldto [fields]
 * @param  [type] $relid   [id]
 * @return [true]          [description]
 * sign Trịnh ngọc hoàng
 */
function deleteCustomFields($fieldto, $relid)
{
    $CI = & get_instance();
    $CI->db->where('fieldto', $fieldto);
    $CI->db->where('relid', $relid);
    return $CI->db->delete('tblcustomfieldsvalues');
}
