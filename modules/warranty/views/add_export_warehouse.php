...
<div class="modal fade in" id="add_export_warehouse" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="false">
  <div class="modal-dialog modal-xl">
    <?php echo form_open('admin/warranty/add_export_warehouse/'.$id, array('id'=>'add-export-warehouse')); ?>
                  ...
                  <table class="tnh-tb table-bordered table-hover dont-responsive-table m-group0">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <input type="text" class="form-control" value="<?= _l('BẢO HÀNH') ?>" readonly>
                          <input type="hidden" name="object_export_warehouse" value="5">
                          <input type="hidden" name="type_items_export_warehouse" value="-1">
                        </td>
                        <td>
                    ...
                    <table class="tnh-tb table-export-warehouse table-bordered table-hover m-group0" style="table-layout: fixed;">
                      <thead>
                        <tr>
                          ...
                          <th style="width: 200px;" class="text-center"><?=_l('name_supplies')?></th>
                          ...
                          <th style="width: 100px;" class="text-center"><?=_l('ch_warehouse_reports')?></th>
...
<script type="text/javascript">
  ...
  $(document).on('change', '.localtion_warehouses_id', (e)=>{
    ...
    var type = currentQuantityInput.parents('tr').find('.type_item').val();
    ...
    if(id == '') {
      ...
      $.post(admin_url + 'return_suppliers/get_quantity/'+items+'/'+warehouse_id+'/'+id+'/'+type,{[csrfData['token_name']] : csrfData['hash']}, function(item){
  ...
  function manage_warehouse(form) {
      ...
      $.post(url, data).done(function(response) {
          ...
          if (response.success == true) {
              ...
              $('#add_export_warehouse').modal('hide');
              tAPI.draw('page');
          }
