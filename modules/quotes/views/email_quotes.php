<?php echo form_open('admin/quotes/email_quotes/'.$id, array('id'=>'send-email')); ?>
			...
			<div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo form_input('title', lang('quotes').' '.$quote['reference_no'], 'placeholder="'.lang('tnh_title_email').'" id="title" class="form-control input-tip" required'); ?>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <?php echo form_textarea('content', (isset($_POST['content']) ? $_POST['content'] : ''), 'placeholder="'.lang('email_template_email_message').'" id="content" class="form-control input-tip tinymce"'); ?>
                    </div>
                </div>
            </div>
		</div>
