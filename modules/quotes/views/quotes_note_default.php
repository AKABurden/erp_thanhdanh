...
<div id="wrapper">
    ...
    <!-- <div> -->
        <div class="panel-body _buttons">
            ...
            <a href="<?= base_url('admin/quotes/add_quote_note_default') ?>" class="btn btn-info pull-right H_action_button tnh-modal" data-tnh="modal" data-toggle="modal" data-target="#myModal">
                            ...
                            <table id="table-category" class="table table-hover table-bordered table-condensed dataTable table-category" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?= lang('code_quote_note_default') ?></th>
                                        <th><?= lang('note') ?></th>
                                        <th><?= lang('actions') ?></th>
                                    </tr>
                                </thead>
    ...
    $(document).ready(function() {
        oTable = tnhDatatable(
            '#table-category',
            {
                ...
                scrollX: true,
                "serverSide": true,
                'sAjaxSource': '<?= site_url('admin/quotes/getQuotesNoteDefault') ?>',
