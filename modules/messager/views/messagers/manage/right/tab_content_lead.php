...
<style>
    ...
    <div class="customer-info" id="customer-info">
        <div class="left-info col-md-12">
            ...
            <?php
            if(!empty($data->id)){?>
                <button class="mtop15 btn btn-success btn-icon font10" onclick="convert_lead_to_customerFB(<?=$data->id?>)" type="button">
                    <?=_l('cong_convert_client')?>
                </button>
                <button class="mtop15 btn btn-info btn-icon font10" onclick="CreateOrders(<?=$data->id?>, 'lead')" type="button">
        ...
        <div class="right-info mleft5">
            <div class="view_customer">
                <div class="wap-content second">
                    <span class="text-muted lead-field-heading no-mtop"><?=_l('cong_name_lead')?>: </span>
                    <span class="bold font-medium-xs mbot15">
                        <?=!empty($data->name) ? $data->name : '-'?>
                    </span>
                    <?php
                    $DataInput =
                        "<input type='text' id='name' name='name' class='name_client form-control'  placeholder='"._l('cong_name_lead')."' value='".(!empty($data->name) ? $data->name : '')."'>
                            <div class='mtop10'>
                ...
                <div class="wap-content firt">
                    ...
                    <?php
                    $DataInput = "
                            <input type='text' id='email_client' class='email_client form-control' name='email' placeholder='"._l('cong_email')."' value='".(!empty($data->email) ? $data->email : '')."'>
                            <div class='mtop10'>
                                <button type='submit' class='btn btn-icon btn-info'> "._l('submit')."</button>
                                <button type='button' class='btn btn-icon btn-default'>"._l('close')."</button>
                            </div>
                ...
                <div class="wap-content second">
                    <span class="text-muted lead-field-heading no-mtop"><?=_l('cong_birtday')?>: </span>
                    <span class="bold font-medium-xs mbot15">
                ...
                <div class="wap-content firt">
                    <span class="text-muted lead-field-heading no-mtop"><?=_l('cong_zcode')?>: </span>
                    <span class="bold font-medium-xs mbot15">
    ...
    <div class="col-md-12">
        <div class="form-group">
            ...
            <input type="text" class="tagstype" id="tag" name="tag" value="<?=!empty($data->id) ? GetDataTag($data->id, 'lead') : ''?>" data-role="tagstype">
        </div>
    </div>
</form>
<?php
