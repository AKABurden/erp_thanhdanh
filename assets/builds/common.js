...
function decimalToHM(e) {
    var t = parseInt(Number(e)), a = Math.round(60 * (Number(e) - t));
...
function tilt_direction(e) {
    setTimeout(function () {
        var t = e.position().left, a = function (a) {
...
function appProgressBar() {
    ...
    e.length && e.each(function () {
        var e = $(this), t = e.attr("data-percent");
...
function _table_jump_to_page(e, t) {
    var a = e.DataTable().page.info(), n = $("body").find("#dt-page-jump-" + t.sTableId);
    if (n.length && n.remove(), a.pages > 1) {
        for (var i = $("<select></select>", {
            "data-id": t.sTableId,
            class: "dt-page-jump-select form-control",
            id: "dt-page-jump-" + t.sTableId
        }), o = "", r = 1; r <= a.pages; r++) o += "<option value='" + r + "'" + (a.page + 1 === r ? "selected" : "") + ">" + r + "</option>";
    ...
    if (0 !== n.length) {
        var i = {
            ...
            fnDrawCallback: function (e) {
                _table_jump_to_page(this, e), 0 == e.aoData.length || 0 == e.aiDisplay.length ? $(e.nTableWrapper).addClass("app_dt_empty") : $(e.nTableWrapper).removeClass("app_dt_empty"), "function" == typeof o.onDrawCallback && o.onDrawCallback(e, this)
            },
        ...
        }, o = $.extend({}, i, t), r = [10, 25, 50, 100], s = [10, 25, 50, 100];
        o.pageLength = parseFloat(o.pageLength), -1 == $.inArray(o.pageLength, r) && (r.push(o.pageLength), s.push(o.pageLength)), r.sort(function (e, t) {
            return e - t
        }), s.sort(function (e, t) {
            return e - t
        }), r.push(-1), s.push(o.dtLengthMenuAllText);
        var l, d, p;
        o.lengthMenu = [r, s], o.supportsButtons || (o.dom = o.dom.replace("lB", "l")), $.each(n, function () {
            if ($(this).addClass("dt-inline"), ($(this).hasClass("scroll-responsive") || 1 == o.scrollResponsive) && (o.responsive = !1), l = $(this).attr("data-order-col"), d = $(this).attr("data-order-type"), p = $(this).attr("data-s-type"), l && d && (o.order = [[l, d]]), p) {
                p = JSON.parse(p);
                var e = $(this).find("thead th"), t = e.length;
                o.aoColumns = [];
                for (var a = 0; a < t; a++) {
                    var n = $(e[a]), i = p.find(function (e) {
...
function get_datatable_buttons(e) {
    ...
    var n = {
        body: function (e, t, a, n) {
            var i = $("<div></div>", e);
            if (i.append(e), i.find("[data-note-edit-textarea]").length > 0 && (i.find("[data-note-edit-textarea]").remove(), e = i.html().trim()), i.find(".row-options").length > 0 && (i.find(".row-options").remove(), e = i.html().trim()), i.find(".table-export-exclude").length > 0 && (i.find(".table-export-exclude").remove(), e = i.html().trim()), e) {
                var o = new RegExp("([0-9]{1,3})(,)([0-9]{" + app.options.decimal_places + "," + app.options.decimal_places + "})", "gm");
    ...
    "function" == typeof table_export_button_is_hidden && table_export_button_is_hidden() || o.push({
        ...
        buttons: [{
            ...
            customize: function (xlsx) {
                ...
                var date_export_ch = $('#date_export_ch').val();
                var type_export_ch = $('#type_export_ch').val();
                if(type_export_ch == 'limit_user_date_btp' || type_export_ch == 'report_all_of_stock' || type_export_ch == 'report_all_of_stock_product' || type_export_ch == 'limit_user_date' ){
                    type_export_ch = '';
                }
                ...
                var downrows = 0;
                if (((date_export_ch != '')&&(date_export_ch != undefined))) {
                    var downrows = 3;
                ...
                // if ($('[name="months-report"]').length > 0) {
                //     var date_text = '';
                //     $.post(admin_url + 'warehouse/GetDate/', data).done(function (response) {
                //         date_text = response;
                //         //insert
                //         var r1 = Addrow(2, [{ k: 'A', v: 'Kho: ' }, { k: 'B', v: warehouse_id }]);
                //         var r2 = Addrow(3, [{ k: 'A', v: date_text }, { k: 'B', v: "" }]);
                ...
                if (((date_export_ch != '')&&(date_export_ch != undefined))) {
                    var r2 = Addrow(3, [{ k: 'A', v: date_export_ch }, { k: 'B', v: "" }, { k: 'C', v: "" }]);
                }
    ...
    return $.each(r, function () {
        var t = $(this);
        t.length && t.attr("data-table") && $(e).is(t.attr("data-table")) && o.push({
            text: t.text().trim(),
            className: "btn btn-default-dt-options",
...
function appDatepicker(e) {
    ...
    var t = {
        ...
        }, a = $.extend({}, t, e), n = void 0 !== a.element_date ? a.element_date : $(a.date_picker_selector),
        i = void 0 !== a.element_time ? a.element_time : $(a.date_time_picker_selector);
    0 === i.length && 0 === n.length || ($.each(n, function () {
        var e = $(this),
            t = {timepicker: !1, scrollInput: !1, lazyInit: !0, format: a.date_format, dayOfWeekStart: a.week_start},
            n = e.attr("data-date-end-date"), i = e.attr("data-date-min-date"), o = e.attr("data-lazy");
        o && (t.lazyInit = "true" == o), n && (t.maxDate = n), i && (t.minDate = i), e.datetimepicker(t), e.parents(".form-group").find(".calendar-icon").on("click", function () {
            e.focus(), e.trigger("open.xdsoft")
        })
    }), $.each(i, function () {
        var e = $(this), t = {lazyInit: !0, scrollInput: !1, validateOnBlur: !1, dayOfWeekStart: a.week_start};
        24 == a.time_format ? t.format = a.date_format + " H:i" : (t.format = a.date_format + " g:i A", t.formatTime = "g:i A");
        var n = e.attr("data-date-end-date"), i = e.attr("data-date-min-date"), o = e.attr("data-lazy");
        o && (opt.lazyInit = "true" == o), n && (t.maxDate = n), i && (t.minDate = i), e.datetimepicker(t), e.parents(".form-group").find(".calendar-icon").on("click", function () {
            e.focus(), e.trigger("open.xdsoft")
        })
    }))
}
...
function _dropzone_defaults() {
    ...
    return "safari" === app.browser && e.indexOf(".jpg") > -1 && -1 === e.indexOf(".jpeg") && (e += ",.jpeg"), {
...
!function (e) {
    ...
    e.fn.appFormValidator = function (a) {
        var n = this, i = {email: {remote: e.fn.appFormValidator.internal_options.localization.email_exists}}, o = {
            rules: [], messages: [], ignore: [], onSubmit: !1, submitHandler: function (t) {
                var a = e(t);
        ...
        return void 0 === r.messages.email && (r.messages.email = i.email), n.configureJqueryValidationDefaults = function () {
            if (t) return !0;
            t = !0, e.validator.setDefaults({
            ...
            }), n.addMethodFileSize(), n.addMethodExtension()
        }, n.addMethodFileSize = function () {
            e.validator.addMethod("filesize", function (e, t, a) {
            ...
            e.validator.addMethod("extension", function (e, t, a) {
            ...
            e.each(t.find(e.fn.appFormValidator.internal_options.required_custom_fields_selector), function () {
                if (!e(this).parents("tr.main").length && (e(this).rules("add", {required: !0}), e.fn.appFormValidator.internal_options.on_required_add_symbol)) {
                    var t = e(this).parents("." + e.fn.appFormValidator.internal_options.field_wrapper_class).find('[for="' + e(this).attr("name") + '"]');
                    t.length > 0 && 0 === t.find(".req").length && t.prepend('<small class="req text-danger">* </small>')
                }
            })
        }, n.addRequiredFieldSymbol = function (t) {
            e.fn.appFormValidator.internal_options.on_required_add_symbol && e.each(r.rules, function (e, a) {
        ...
        }, n.configureJqueryValidationDefaults(), n.each(function () {
            var t = e(this);
    ...
    highlight: function (e, t, a, n) {
        ...
        } else if (1 === e.nodeType && e.childNodes && !/(script|style)/i.test(e.tagName) && (e.tagName !== a.toUpperCase() || e.className !== n)) for (var l = 0; l < e.childNodes.length; l++) l += jQuery.highlight(e.childNodes[l], t, a, n);
        return 0
    }
    ...
    var n = a.caseSensitive ? "" : "i", i = "(" + e.join("|") + ")";
    a.wordsOnly && (i = "\\b" + i + "\\b");
        ...
        var a, n = !1, i = {
            initGooglePickerAPI: function (e) {
                ...
                if (n && a) {
                    ...
                    o.mimeTypes && (t.setMimeTypes(o.mimeTypes), r.setMimeTypes(o.mimeTypes)), (new google.picker.PickerBuilder).addView(t).addView(r).setOAuthToken(a).setDeveloperKey(o.developerKey).setCallback(i.pickerCallback).build().setVisible(!0), setTimeout(function () {
                        e(".picker-dialog").css("z-index", 10002)
                    }, 10)
                }
            }, pickerCallback: function (e) {
                if (e[google.picker.Response.ACTION] == google.picker.Action.PICKED) {
                    var t = e[google.picker.Response.DOCUMENTS][0], a = [{
    ...
    $("body").on("click", ".add_more_attachments", function () {
        ...
        if ($(this).next().hasClass("dropdown-menu")) {
            var t = $(this).next(), a = $(document).height(), n = ($(document).width(), $(this).offset()),
                i = $(this).outerWidth(), o = $(this).outerHeight(), r = t.outerWidth(), s = t.outerHeight(),
                l = $(".table-responsive").offset(), d = $(".table-responsive").width(),
                p = $(".table-responsive").height(), c = (l.left, p + l.top), u = n.left, f = (n.left, n.top + o),
                m = u - l.left < r, h = (n.top, c - f < s), _ = a - (l.top + p);
            n.top, l.top;
...
$.fn.isInViewport = function () {
    var e = $(this).offset().top, t = e + $(this).outerHeight(), a = $(window).scrollTop(), n = a + $(window).height();
    return t > a && e < n
}, String.prototype.matchAll = function (e) {
    var t = [];
    return this.replace(e, function () {
        var e = [].slice.call(arguments, 0), a = e.splice(-2);
...
function appTagsPhone(e) {


    void 0 === e && (e = $("body").find("input.phonesinput")), e.length && e.tagit({
        availableTags: [],
        allowSpaces: !0,
        animate: !1,
        placeholderText:  '',
