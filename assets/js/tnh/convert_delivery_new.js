...
function createdRowOrderItem(order_item, counter) {
    ...
    if (order_item) {
        ...
        thChild = '';
        if (order_item.arrColumsNew.length > 0){
            $.each(order_item.arrColumsNew, function (k, v) {
                thChild += `<th>${v}</th>`;
            })
        }
                ...
                if (data) {
                    ...
                    if (data.orderItemsColumnsNew.length > 0) {
                        $.each(data.orderItemsColumnsNew, function (k, vv) {
                            colum_delivery = vv.colum_delivery;
                            ...
                            tdChild = '';
                            if (colum_delivery.length > 0){
                                $.each(colum_delivery, function (kkk, vvv) {
                                    tdChild += `<td>${vvv}</td>`;
                                })
                            }
                            trItemChild += `<tr>
