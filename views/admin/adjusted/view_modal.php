    ...
    <div style="z-index: 999999999999;" class="modal fade in" id="view_adjusted" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static" data-keyboard="false" aria-hidden="false">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">
                        <?php if ($items->type == 1) { ?>
                            <span class="book-title"><?php echo _l('ch_adjusted_warehouse_t_up'); ?> </span>
                        <?php } else { ?>
                            <span class="book-title"><?php echo _l('ch_adjusted_warehouse_t_down'); ?> </span>
                        <?php } ?>
                    </h4>
                </div>
                            ...
                            <table id="view-enquiry" class="table table-bordered table-hover" style="width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <?php if ($items->type == 1) { ?>
                                            <th class="text-center"><?php echo _l('ch_quantity_up'); ?></th>
                                        <?php } else { ?>
                                            <th class="text-center"><?php echo _l('ch_quantity_down'); ?></th>
                                        <?php } ?>
                                ...
                                <tbody>
                                    <?php foreach ($items->items as $key => $value) { ?>
                                        <tr>
                                            <td class="center">
                                                <div class="preview_image text-center" style="width: 80px;margin-bottom:0;margin-top:0">
                                            ...
                                            <td class="center">
                                                <?php if ($items->type == 1) { ?>
                                                    <?php echo formatNumber($value['quantity'] + $value['quantity_net']);
                            ...
                            <table class="table table-bordered table-condensed totals" style="margin-bottom:0;">
                                <tbody>
                                    <tr class="success">
                                        ...
                                        <td><?= _l('ch_adjusted_total') ?>:<span class="pull-right"><?= formatNumber($total) ?></span></td>
                                        <td><?= _l('ch_quantity_time_total') ?>:<span class="pull-right"><?= formatNumber($totalQuantity_time) ?></span></td>
