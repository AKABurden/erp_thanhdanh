...
<!--                                                  <span style="font-size: 10px;color: red;font-weight: 500;">SL DVTT: --><?//= formatNumber($value['quantity_payment']); ?><!--</span>-->
                                              </td>
                                              <td class="center">
                                  ...
                                  <tfoot class="bold">
                                      <tr>
                                          <th class="text-center" style="text-transform: uppercase;" colspan="7"><?= lang('tnh_grand_total') ?></th>
                                          <th></th>
                                          <th></th>
