<?php echo form_open('admin/categories/add_mode_materials',array('id'=>'add-mode_materials')); ?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title"><?= _l('tnh_add_mode_materials'); ?></h4>
		</div>
...
<script>
    $(function(){
       	...
       	appValidateForm($('#add-mode_materials'), {
           code: 'required',
           name: 'required'
        }, addmode_materials);
        ...
        function addmode_materials(form) {
            ...
            var url = form.action;
            $.ajax({
            	url: site.base_url+'admin/categories/add_mode_materials',
            	type: 'POST',
            	dataType: 'JSON',
            	data: data,
            })
