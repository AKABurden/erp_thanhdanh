...
<div id="wrapper">
    ...
    <!-- <div> -->
        <div class="panel-body _buttons">
            ...
            <a href="<?= base_url('admin/categories/handlingAllowance/0/add') ?>" class="btn btn-info pull-right H_action_button tnh-modal" data-tnh="modal" data-toggle="modal" data-target="#myModal">
                ...
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-allowance" class="table table-hover table-bordered table-condensed dataTable table-allowance" style="width: 100%;">
                                <thead>
                                    <tr>
    ...
    $(document).ready(function() {
        oTable = tnhDatatable(
            '#table-allowance',
            {
                ...
                // },
                "serverSide": true,
                'sAjaxSource': '<?= site_url('admin/categories/getAllowance') ?>',
