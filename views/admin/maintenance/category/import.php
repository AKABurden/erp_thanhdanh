<div id="modal_import_excel_category" class="modal fade" role="dialog">
    <form action="<?=admin_url('maintenance/import_category')?>" id="category_import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?=base_url('uploads/template/template_hang_muc_bao_tri.xlsx')?>">Download file mẫu</a>
...
<script>
    $('#modal_import_excel_category').modal('show');
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'maintenance/import_category';
        var file_data = $('#category_import_form input#file_import').prop('files');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#modal_import_excel_category').modal('hide');
