<?php echo form_open('admin/warning_warehouse/add_purchase', array('id'=>'add-purchase-new')); ?>
<div class="modal fade in" id="create_purchase_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    data-backdrop="static" data-keyboard="false" aria-hidden="false">
    <div class="modal-dialog modal-lg" style="width: 70%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><?= _l('Thêm yêu cầu mua hàng'); ?></h4>
            </div>
                            ...
                            <thead>
                                <tr>
                                    <th class="text-center" style="width: 50px;"><a
                                            ...
                                            <?= lang('tnh_add_row') ?></a></th>
                                    <th class="text-center" style="width: 170px;"><?= lang('tnh_item_code') ?></th>
                                    <th class="text-center" style="width: 100px;" class="text-center">
                                        <?= lang('type') ?></th>
                                    <th class="text-center" style="width: 70px;" class="text-center"><?= lang('unit') ?>
                                    </th>
                                    <th style="width: 170px;" class="text-center"><?= lang('tnh_quantity_purchase') ?>
                                    </th>
...
function chonseItem(el, idEl) {
    ...
    if (dataItem) {
        ...
        trCurItem.find('.td-type-item').html(dtType_item);
...
function createRow(dataItem = false) {
    ...
    tdQuantity = '<div class="td-quantity"><input type="text" name="quantity[' + counter +
        ']" id="quantity[]" class="form-control quantity number-format" style="width: 100%;" value="' + tnhFormatNumber(
            dtQuantity) + '"></div>';
    tdActions =
    ...
    if (txtJsonItemsId) {
        ...
        ajaxSelectParamsCallback($('#items_' + counter + ''), 'admin/warning_warehouse/getItemsWarningWarehouse', 0, {
            id_item: id_item
        });
    }
    counter++;
