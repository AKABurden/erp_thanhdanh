<div id="import_import_excel_category_stages" class="modal fade" role="dialog">
    <form action="<?=admin_url('products/import_category_stages')?>" id="machines_import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?=base_url('uploads/template/template_category_stages.xlsx?vs=1.1')?>">Download file mẫu</a>
...
<script>
    $('#import_import_excel_category_stages').modal('show');
    function get_data_file_excel() {
        ...
        var url = admin_url + 'products/import_category_stages';
        var file_data = $('#machines_import_form input#file_import').prop('files');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#import_import_excel_category_stages').modal('hide');
