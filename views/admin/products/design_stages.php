						...
						<table class="table table-stages table-hover sortable dataTable" style="margin: 0;">
							<thead>
								<tr style="background: #5cb0d5;">
									...
									<th style="width: 45%;"><?= lang('tnh_stage_name') ?></th>
									<th style="width: 15%;"><?= lang('Đánh dấu công đoạn phát sinh btp hoặc tp chưa hoàn thiện') ?></th>
									<th style="width: 15%;"><?= lang('tnh_final_stage') ?></th>
									<th style="width: 15%;"><?= lang('Máy móc') ?></th>
