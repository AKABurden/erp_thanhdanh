...
<div id="wrapper">
    ...
    <?php echo form_open('admin/products/import_bom',array('id'=>'import-bom')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="text-danger">
                            <div>
                                ...
                                <a href="<?= base_url('file/products/import_bom.xlsx?vs=1.8') ?>" title=""><?= lang('tnh_file_sample') ?></a>
                            </div>
                            <div>
                                ...
                                - Bắt đầu lưu dữ liệu từ dòng thứ 4 trong file Excel.</br>
                        ...
                        <div class="row">
                            <div class="col-md-2 mbot10">
                                ...
                                <input type="number" name="row_start" id="row_start" class="form-control" value="4" min="4">
                            </div>
                            <div class="col-md-2 mbot10">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function importBom(form) {
            ...
            var url = form.action;
            $.ajax({
                url : site.base_url+'admin/products/import_bom',
                type : 'POST',
                dataType: 'JSON',
                cache : false,
                contentType : false,
