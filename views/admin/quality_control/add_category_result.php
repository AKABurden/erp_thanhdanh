<?php echo form_open('admin/quality_control/add_category_result',array('id'=>'add-category-result')); ?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title"><?= _l('tnh_add_category_result'); ?></h4>
		</div>
...
<script>
    $(function(){
        $('#parent_id').select2({allowClear: true});
       	appValidateForm($('#add-category-result'), {
           code: 'required',
           name: 'required'
        }, addCategory);
