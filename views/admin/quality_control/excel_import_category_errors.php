<div id="modal_import_excel" class="modal fade" role="dialog">
    <form action="<?= admin_url('quality_control/excel_import_category_errors') ?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?= base_url('uploads/template/template_Loai_danh_muc_loi.xlsx?vs=1.1') ?>">Download file mẫu</a>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'quality_control/excel_import_category_errors';
