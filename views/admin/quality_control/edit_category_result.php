<?php echo form_open('admin/quality_control/edit_category_result/'.$id,array('id'=>'edit-category-result')); ?>
<div class="modal-dialog">
	<div class="modal-content">
		<div class="modal-header">
			<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
			<h4 class="modal-title"><?= _l('tnh_edit_category_result'); ?></h4>
		</div>
		<div class="modal-body">
			<div class="row">
				<div class="col-md-12">
					<div class="form-group">
						<?= lang('tnh_category_code_result', 'code') ?>
				...
				<div class="col-md-12">
					<div class="form-group">
						<?= lang('tnh_category_name_result', 'name') ?>
...
<script>
    $(function(){
       	appValidateForm($('#edit-category-result'), {
           code: 'required',
           name: 'required'
        }, addCategory);
