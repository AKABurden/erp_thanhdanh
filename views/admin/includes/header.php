...
ob_start();
?>
<li id="top_search" class="dropdown hide" data-toggle="tooltip" data-placement="bottom"
    ...
    <nav>
        ...
        <div class="mobile-menu">
            ...
            <ul class="mobile-icon-menu">
                ...
                <li class="icon header-timers timer-button" id="header-timers" data-placement="bottom"
                    data-toggle="tooltip" data-title="<?= lang('Menu') ?>">
        ...
        <ul class="nav navbar-nav navbar-right" style="display: flex">
            ...
            <li class="icon header-timers timer-button" id="header-timers" data-placement="bottom" data-toggle="tooltip"
                data-title="<?= lang('Menu') ?>">
                <a href="#" id="top-timers" class="dropdown-toggle top-timers" data-toggle="dropdown">
                    <i class="fa fa-th fa-lg" aria-hidden="true"></i> <span class="div-menu"><?= lang('Menu') ?></span>
                </a>
                <ul class="dropdown-menu animated fadeIn" id="H_menu_v2"
                    style="right: -180px;width: 1200px;overflow-x: auto;">
            ...
            <li class="dropdown notifications-wrapper header-notifications" data-toggle="tooltip"
                title="<?php echo _l('Cảnh báo tồn kho'); ?>" data-placement="bottom"
                style="display: flex;justify-content: center;align-items: center;">
                <buton class="btn btn-info" style="color: black;background-color: #ecf3f7;"><a
                        href="<?php echo base_url('admin/warning_warehouse');?>" style="color:unset"><span
                            class="bell fa fa-bell"></span> Cảnh báo tồn kho</a>
                </buton>
            </li>
            <?php //} ?>
            <li class="dropdown notifications-customs" id="notifications-customs" data-toggle="tooltip" title=""
                ...
                <ul class="dropdown-menu notifications animated fadeIn width400" data-total-unread="1">
                    <li class="relative notification-wrapper not-outside" style="text-align: left; padding: 5px;"
                        data-noti-custom-id="1">
                            ...
                            <a style="color: #000000" target="_blank" href="https://fososoft-2.gitbook.io/foso-erp/">
                                <div>
                                    <img style="width: 45px;height: 45px;"
                                        src="<?=base_url('uploads/document.png')?>"><span class="bold">Tài liệu hướng
                                        dẫn sử dụng</span>
                                </div>
                            </a>
                        </div>
                    ...
                    <li class="relative notification-wrapper not-outside" style="text-align: left; padding: 5px;"
                        ...
                        <div class="notification-box wap-li">
                            <a style="color: #000000" target="_blank" href="<?=admin_url('videos')?>">
                                <div>
                                    <img style="width: 45px;height: 45px;"
                                        src="<?=base_url('uploads/videos.png')?>"><span>Video hướng dẫn sử dụng</span>
                                </div>
                            </a>
                        </div>
                    </li>
            ...
            <li class="dropdown notifications-custom" id="notifications-custom" data-toggle="tooltip" title=""
                data-placement="bottom">
