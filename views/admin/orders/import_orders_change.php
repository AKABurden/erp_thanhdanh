...
<div id="wrapper">
    ...
    <?php echo form_open('admin/orders/import_orders_change',array('id'=>'import-orders')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="text-danger">
                            <div>
                                ...
                                <a href="<?= base_url('file/orders/import_orders_change.xlsx?vs=1.2') ?>" title=""><?= lang('tnh_file_sample') ?></a>
                            </div>
                            <div>
                                ...
                                - Bắt đầu lưu dự liệu từ dòng thứ 4 trong file Excel.</br>
                                - Trường dự liệu phải dưới dạng text không dùng công thức hay định dạng.</br>
                                - Không để 2 mặt hàng giống nhau kế tiếp trong 1 đơn hàng.</br>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function importOrders(form) {
            ...
            var url = form.action;
            $.ajax({
                url : site.base_url+'admin/orders/import_orders_change',
                type : 'POST',
                dataType: 'JSON',
                cache : false,
                contentType : false,
