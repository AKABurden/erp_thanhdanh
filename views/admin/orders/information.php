...
<script type="text/javascript">
    ...
    function excelOrdersInformation() {
        ...
        var url_print = site.base_url+'admin/orders/excel_orders_information?customer_search='+customer_search+'&start_date_search='+start_date_search+'&end_date_search='+end_date_search+'&type_orders_search='+type_orders_search+'&status_orders_search='+status_orders_search+'&branch_search='+branch_search;
        ...
        oTable = tnhInitDataTable('#table-orders-infomation', '', {
            ...
            "ajax": {
                ...
                "dataSrc": function(json) {
                    ...
                    $('#table-orders-infomation tfoot tr td:nth-child(13)').html('<div class="text-center">' + tnhFormatMoney(json.quantity_warehouse) + '</div>');
