                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" app-field-wrapper="category_tasks">
                                    ...
                                    <select id="category_tasks" name="category_tasks" class="selectpicker" data-width="100%" data-none-selected-text="Không có mục nào được chọn" data-live-search="true" tabindex="-98">
										<?php $value = (isset($task) ? $task->category_tasks : ''); ?>
                                        <option></option>
                            ...
                            <div class="col-md-6">
								<?php $value = (!empty($task->department_id) ? $task->department_id : []); ?>
								<?php echo render_select('department_id[]', (!empty($departments) ? $departments : []), ['departmentid', 'name'], 'Phòng ban phụ trách', $value, ['multiple' => true], [], '', '', false) ?>
                            </div>
                            <div class="col-md-6">
								<?php if (isset($task)) {
                            ...
                            <div class="col-md-6">
                                ...
                                ?>
                                <?php echo render_select('id_branch', !empty($branch) ? $branch : [], ['id', 'name'], 'id_branch', (isset($task) ? $task->id_branch : 0))?>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 hide">
                                <div class="form-group<?php if ($rel_type == 'procurement_supply'
									|| $rel_type == 'COO'
									|| $rel_type == 'TCKT'
									|| $rel_type == 'HCNS'
									|| $rel_type == 'QA'
