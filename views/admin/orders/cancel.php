<?php echo form_open('admin/orders/cancel/' . $id, array('id' => 'cancel-orders')); ?>
<div class="modal-dialog modal-md">
    <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h4 class="modal-title"><?= lang('tnh_cancel_order') ?></h4>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?= lang('tnh_note_cancel', 'note_cancel') ?>
                        <textarea name="note_cancel" id="note_cancel" class="form-control note_cancel" placeholder="<?= lang('tnh_note_cancel') ?>" rows="3" required="required"></textarea>
                    </div>
                </div>
            </div>
        </div>
