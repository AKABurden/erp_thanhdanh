            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
						...
						<?php echo render_input('code', 'department_list_code'); ?>
...
<script>
    $(function () {
        initDataTable('.table-departments', window.location.href, [4], [4], {"hide_not_active" : "[name='hide_not_active']:checked"}, [1, 'asc']);
