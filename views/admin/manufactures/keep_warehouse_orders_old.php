                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php
                                                    ...
                                                    $this->db->select("
                                                        tblwarehouse_items.*,
                                                        (tblwarehouse_items.product_quantity - coalesce(tb_tranfer_bussiness.quantity_tranfer_business,0)) as product_quantity,
                                                    ...
                                                    $this->db->where('(tblwarehouse_items.product_quantity - coalesce(tb_tranfer_bussiness.quantity_tranfer_business,0)) > ', 0);
                                                    ...
                                                    $this->db->or_where('exists (
                                                        ...
                                                        AND EXISTS (
                                                            ...
                                                            WHERE tbl_productions_orders_items.id = tbl_productions_orders_details.productions_orders_item_id AND (tblwarehouse_items.product_quantity - coalesce(tb_tranfer_bussiness.quantity_tranfer_business,0)) > 0
                                                        )
                                                    )', false, false);
                                                    $this->db->or_where('exists (
                                                        SELECT tbl_productions_orders_details.id
