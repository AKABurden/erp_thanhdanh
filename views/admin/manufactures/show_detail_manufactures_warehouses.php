...
<script>
    ...
    $(document).ready(function() {
        oTableModal = tnhInitDataTable('#table-view-items', '', {
            ...
            "ajax": {
                "url": '<?= site_url('admin/manufactures/getShowDetailManufacturesWarehouses') ?>',
                "type": "POST",
                "data": function(d) {
                ...
                "dataSrc": function(json) {
                    $('#table-view-items tfoot tr td:nth-child(3)').html('<div class="text-center">'+tnhFormatNumber(json.totalQuantity)+'</div>');
                    return json.aaData;
                }
            },
        })
