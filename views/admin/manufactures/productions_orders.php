...
<script type="text/javascript">
    ...
    function loadItemsPO(cData) {
        ...
        productions_orders_items = cData[10];
        cHtml = '';
    ...
    function loadTable() {
        oTableNew = tnhInitDataTable('#table-productions-orders-all', '<?= site_url('admin/manufactures/getProductionsOrdersAll') ?>', {
            ...
            "ajax": {
                ...
                "dataSrc": function(json) {
                    $('#table-productions-orders-all tfoot tr td:nth-child(11)').html('<div class="text-center">' + tnhFormatNumber(json.total_quantity) + '</div>');
                    $('#table-productions-orders-all tfoot tr td:nth-child(12)').html('<div class="text-center">' + tnhFormatNumber(json.total_quantity_sx) + '</div>');
                    $('#table-productions-orders-all tfoot tr td:nth-child(13)').html('<div class="text-center">' + tnhFormatNumber(json.total_quantity_hold) + '</div>');
                    $('#table-productions-orders-all tfoot tr td:nth-child(14').html('<div class="text-center">' + (json.total_quantity_new) + '</div>');
                    $('#table-productions-orders-all tfoot tr td:nth-child(15)').html('<div class="text-center">' + tnhFormatNumber(json.total_quantity_finished) + '</div>');
                    $('#table-productions-orders-all tfoot tr td:nth-child(16)').html('<div class="text-center">' + tnhFormatNumber(json.total_quantity_errors) + '</div>');
                    return json.aaData;
                }
            },
            "columnDefs": [{
