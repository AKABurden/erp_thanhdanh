...
<div id="wrapper">
    ...
    <?php echo form_open('admin/purchase_order/import_orders',array('id'=>'import-orders')); ?>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                <div class="panel_s">
                    <div class="panel-body">
                        ...
                        <div class="text-danger">
                            <div>
                                ...
                                <a href="<?= base_url('file/purchase_order/FOSO_import_PO.xlsx') ?>" title=""><?= lang('tnh_file_sample') ?></a>
                            </div>
                            <div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function importOrders(form) {
            ...
            var url = form.action;
            $.ajax({
                url : site.base_url+'admin/purchase_order/import_orders',
                type : 'POST',
                dataType: 'JSON',
                cache : false,
                contentType : false,
