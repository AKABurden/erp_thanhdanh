			...
			<div class="col-md-12">
				<div id="search-tnh" class="collapse in" aria-expanded="true">
					...
					<div class="col-md-3">
						...
						<input type="text" name="groups_ch" data-placeholder="<?= lang('customer_groups') ?>" id="groups_ch" class="groups_ch" style="width: 100%;" value="">
					</div>
				</div>
			</div>
				...
				<div class="panel_s">
					<div class="panel-body">
						...
						$_table_data = array(
							...
							array(
								'name' => _l('ch_date_created'),
								'th_attrs' => array('class' => 'toggleable', 'id' => 'th-date-created')
							),
                            array(
                                'name'=>_l('Chi nhánh'),
                                'th_attrs'=>array('class'=>'toggleable', 'id'=>'th-branch')
                            ),
						);
						...
						array_push($table_data, array('name' => _l('action'), 'th_attrs' => array('class' => 'toggleable', 'id' => 'th-action')));
...
<script>
	...
	$(function() {
		...
		var tAPI = initDataTable('.table-suppliers', admin_url + 'suppliers/table', [], [0], CustomersServerParams, <?php echo hooks()->apply_filters('customers_table_default_order', json_encode(array(7, 'desc'))); ?>);
	...
	ajaxSelectCallBack($('#groups_ch'), "<?= admin_url('suppliers/SearchGroup') ?>", 0);
</script>
</body>
