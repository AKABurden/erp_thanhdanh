                            ...
                            <div role="tabpanel" class="tab-pane active" id="tab_staff_profile">
                                <div class="row">
                                    <div class="col-md-3" style="border-right: 1px solid #bfcbd9;">
                                        <?php if (total_rows(db_prefix().'emailtemplates',
                                                array('slug' => 'two-factor-authentication', 'active' => 0)) == 0) { ?>
                                        ...
                                        <?php if (isset($member) && $member->profile_image != null) { ?>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-md-9">
                                                        <?php echo staff_profile_image($member->staffid,
                                        ...
                                        <?php echo render_textarea('email_signature', 'settings_email_signature',
                                            $value, ['data-entities-encode' => 'true']); ?>
                                        <div class="form-group select-placeholder">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <?php } ?>
                                                <?php if (!isset($member) && total_rows(db_prefix().'emailtemplates',
                                                        array('slug' => 'new-staff-created', 'active' => 0)) === 0) { ?>
                                                    <div class="checkbox checkbox-primary">
                                    ...
                                    <div class="col-md-9 small-table-right-col">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <?= lang('Hệ số lương trách nhiệm', 'coefficient_responsibility') ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <table id="tb-salary-new"
                                                    ...
                                                    <?php
                                                    $counterSalaryNew = 0;
                                                    $salaryNew = !empty($member) ? get_table_where('tbl_staff_salary',
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <table id="table_phucap"
                                                    ...
                                                    <?php
                                                    $counterAllowance = 0;
                                                    $allowanceStaff = !empty($member) ? get_table_where('tbl_staff_allowance',
                                                        ['staff_id' => $member->staffid]) : [];
                                                    ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <table id="table_giamtru"
                                                    ...
                                                    <?php
                                                    $countGiamTru = 0;
                                                    $reduceStaff = !empty($member) ? get_table_where('tbl_staff_reduce',
                                                        ['staff_id' => $member->staffid]) : [];
                                                    ?>
                            ...
                            <div role="tabpanel" class="tab-pane" id="staff_permissions">
                                <div class="row">
                                    <div class="col-md-5">
                                        ...
                                        ?>
                                        <?php echo render_select('role', $roles, array('roleid', 'name'), 'cong_title',
                                            $selected); ?>
                                        ...
                                        <?php echo render_select('employee_manage[]', $employees_v2,
                                            array('staffid', 'name'), 'tnh_manage', $employee_manage,
                                            ['multiple' => true]); ?>
                    ...
                    <div class="col-md-7 small-table-right-col hide">
                        ...
                        <div class="panel_s">
                            <div class="panel-body">
                                ...
                                <div class="mbot15 usernote hide inline-block full-width">
                                    ...
                                    <?php echo render_textarea('description', 'staff_add_edit_note_description', '',
                                        array('rows' => 5)); ?>
                                    ...
                                    <table class="table dt-table scroll-responsive" data-order-col="2"
                                        ...
                                        <?php foreach ($user_notes as $note) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($note['addedfrom'] == get_staff_user_id() || has_permission('staff',
                                                            '', 'delete')) { ?>
                        ...
                        foreach ($timesheets as $t) { ?>
                                    <tr>
                                        ...
                                        <td data-order="<?php echo $t['start_time']; ?>"><?php echo _dt($t['start_time'],
                            true); ?></td>
