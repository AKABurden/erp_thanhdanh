        ...
        <div class="panel_s mbot10 H_scroll" id="H_scroll">
            <div class="panel-body _buttons">
				<?php if (has_permission('staff', '', 'create')) { ?>
                    ...
                    <a class="btn btn-info pull-right H_action_button mleft5 hide" onclick="printCodeStaff(); return false;"><i
                                class="fa fa-print"></i> <?php echo _l('In QR'); ?></a>
                    <a class="btn btn-info pull-right H_action_button mleft5" onclick="ViewPDF(); return false;"><i
                                class="fa fa-print"></i> <?php echo _l('In QR'); ?></a>
                    <?php
                            ...
                            <div class="horizontal-tabs">
                                <ul class="nav nav-tabs nav-tabs-horizontal status-table" role="tablist">
                                    ...
                                    <li role="presentation">
                                        <a href="#status_work0" aria-controls="status_work0" role="tab"
                                           value="status_work0"
                                           data-toggle="tab"><?= lang('Thử việc') ?>(<span><?= $status_work0 ?></span>)</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#status_work1" aria-controls="status_work1" role="tab" value="status_work1"
                                           data-toggle="tab"><?= lang('Đang làm việc') ?>(<span><?= $status_work1 ?></span>)</a>
                                    </li>
                                    <li role="presentation">
                                        <a href="#status_work2" aria-controls="status_work2" role="tab" value="status_work2"
                                           data-toggle="tab"><?= lang('Nghỉ việc') ?>(<span><?= $status_work2 ?></span>)</a>
                                    </li>
                                </ul>
...
<script>
    ...
    $('.table-staff').on('draw.dt', function () {
        ...
        $.each(total_tr, function (i, v) {
            $("#branch_salary_" + i).select2({'allowClear': true});
        });
