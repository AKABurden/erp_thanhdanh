...
<script>
    ...
    var createTrItem = (item, currentQuantityInput, type) => {
        ...
        new_tr.find('td.promotion_suppliers').find('p').text(formatNumber(promotion_suppliers * item
            .quantity_suppliers));
