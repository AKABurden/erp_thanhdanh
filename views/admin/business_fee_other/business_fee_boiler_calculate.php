                        ...
                        <div class="table-responsive">
                            <table id="table-business-fee-boiler-calculate"
                                ...
                                <tr>
                                    ...
                                    <th class="text-center"><?= lang('(Lương cơ bản + trách nhiệm + chức vụ)') ?></th>
                                    <th class="text-center"><?= lang('Trách nhiệm theo tiền lương') ?></th>
            ...
            '<?= site_url('admin/business_fee_other/getBusinessFeeBoilerCalculate') ?>', {
                ...
                "ajax": {
                    ...
                    "dataSrc": function (json) {
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(5)').html(`<div class="text-center">${tnhFormatMoney(json.total_sunday)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(6)').html(`<div class="text-right">${tnhFormatMoney(json.total_sunday_money)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(7)').html(`<div class="text-center">${tnhFormatMoney(json.total_holiday)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(8)').html(`<div class="text-right">${tnhFormatMoney(json.total_holiday_money)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(9)').html(`<div class="text-center">${tnhFormatMoney(json.total_weekday)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(10)').html(`<div class="text-right">${tnhFormatMoney(json.total_weekday_money)}</div>`);
                        $('.table-business-fee-boiler-calculate-new tfoot tr td:nth-child(11)').html(`<div class="text-right">${tnhFormatMoney(json.total)}</div>`);
                        return json.aaData;
                    }
                },
