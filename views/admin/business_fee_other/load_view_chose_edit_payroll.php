            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                        <?= lang('year', 'year') ?>
                        <select name="year" id="year_edit" class="selectpicker form-control" required data-placeholder="<?= lang('year') ?>"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <?= lang('month', 'month') ?>
                        <select name="month" id="month_edit" class="selectpicker form-control" required data-placeholder="<?= lang('month') ?>"
                                style="width: 100%;" style="width: 100%;">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="branch_edit" id="branch_edit" class="selectpicker form-control" required data-placeholder="<?= lang('Chi nhánh') ?>"
                                style="width: 100%;" style="width: 100%;">
                            <option></option>
...
<script>
    $(function() {
        ...
        $(".edit_payroll").click(function() {
            ...
            if (month_edit && year_edit && branch_edit) {
                window.open(site.base_url + 'admin/business_fee_other/edit_business_fee_boiler_calculate?month=' + month_edit + '&year=' +
