...
<script type="text/javascript">
    ...
    $(document).on('change', '#type_vouchers', function(event) {
        ...
        var type_vouchers = $('#type_vouchers').val();
        <?php if (empty($items)) { ?>
            var htmlss = '<select class="selectpicker no-margin" data-width="100%" id="vouchers_id" data-none-selected-text="<?php echo _l('ch_list_code'); ?>" name="vouchers_id"  data-live-search="true" >\
            <option value=""></option>\
                        </select>';
