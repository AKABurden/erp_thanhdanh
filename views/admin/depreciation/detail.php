...
<div class="modal fade" id="depreciation" role="dialog">
    <div class="modal-dialog modal-lg" style="width: 80%">
        <div class="modal-content">
            ...
            <?php
            echo form_open(admin_url('depreciation/add/'.$value), array('id' => 'record_increased-form', 'class' => '_transaction_form invoice-form'));
            ?>
                                                        ...
                                                        <table class="tnh-tb table-bordered table-hover dont-responsive-table m-group0" style="table-layout: fixed;">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="3">
                                                                        <?php $value = (isset($items) ? $items->note : _l('ch_value_of_depreciation').' '._l('month').' '.$month.' '._l('years').' '.$year); ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td >
                                                                        <input type="text" name="month" class="hide" value="<?=$month?>">
                                                                        <?=$month?>
                                                                    </td>
                                                                    <td >
                                                                        <label for="date" class="control-label">
                                                                    ...
                                                                    <td >
                                                                        <input type="text" name="year"  class="hide" value="<?=$year?>">
                                                                        <?=$year?>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
