...
<?php echo form_open('admin/returned_goods/add', array('id' => 'returned-goods')); ?>
<div id="wrapper">
						...
						<table class="tnh-tb table-bordered table-hover">
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											<input type="text" name="order_id" data-placeholder="<?= lang('tnh_reference_orders') ?>" id="order_id" class="order_id" style="width: 100%;" value="">
										</div>
									</td>
								</tr>
								<tr>
				...
				<table class="table tnh-tb table-bordered table-hover">
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="text" name="discount_direct" id="discount_direct" class="form-control money-format" value="0">
							</td>
						</tr>
