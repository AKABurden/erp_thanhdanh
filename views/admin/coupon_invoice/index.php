        ...
        oTable = tnhInitDataTable('#table-coupon-invoices', '', {
            ...
            "ajax": {
                ...
                "dataSrc": function (json) {
                    $('tfoot tr td:nth-child(8)').html(`<div class="text-right">${tnhFormatMoney(json.grandTotal)}</div>`);
                    $('tfoot tr td:nth-child(9)').html(`<div class="text-right">${tnhFormatMoney(json.TotalPayment)}</div>`);
                    return json.aaData;
                }
            },
            "columnDefs": [{
