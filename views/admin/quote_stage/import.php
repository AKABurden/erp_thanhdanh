<div id="modal_import_excel" class="modal fade" role="dialog">
    <form action="<?=admin_url('quote_stage/import')?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?=base_url('uploads/template/import_quote_stage.xlsx?')?>">Download file mẫu</a>
...
<script>
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'quote_stage/import';
