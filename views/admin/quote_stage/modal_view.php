                        ...
                        <div id="tab_modal_stage" class="tab-pane fade in active">
                            <table id="table-items-modal" class="table dont-responsive-table mbot40" style="width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center">Danh mục công đoạn</th>
    ...
    $('#table-items-modal').DataTable({
        ...
        buttons: [{
                ...
                customize: function (xlsx) {
                    ...
                    var r1 = Addrow(1, [{ k: 'A', v: ('Mã bảng giá công đoạn : ' + stage_quote_code) }, { k: 'B', v: "" }, { k: 'C', v: "" }]);
                    var r2 = Addrow(2, [{ k: 'A', v: ('Tên bảng giá công đoạn : ' + stage_quote_name) }, { k: 'B', v: "" }, { k: 'C', v: "" }]);
