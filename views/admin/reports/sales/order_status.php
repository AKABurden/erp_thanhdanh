...
<script type="text/javascript">
    var paramsOrderStatus = {'customers': '#customers', 'orders': '#orders', 'start_date_delivery': '#start_date_delivery', 'end_date_delivery': '#end_date_delivery', 'products_search': '#products_search'};
            ...
            '#tb-order-status',
            {
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        "targets": 7, "name": 'delivered_last_period'
                    },
                    {
                        "render": function(data, type, row) {
                        ...
                        "targets": 8, "name": 'delivered_this_period'
                    },
                    {
                        "render": function(data, type, row) {
                            if (!data || data == 0) return '';
                ...
                "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                    var quantity_order = 0, delivered_last_period = 0, delivered_this_period = 0, total_delivery = 0, rest = 0;
