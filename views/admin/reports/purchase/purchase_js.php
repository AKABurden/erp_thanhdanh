...
<script>
    ...
    function init_report(e, type) {
        ...
        if (type == 'detail-purchase-report') {
            detail_purchase_report.removeClass('hide');
            report_from_choose.removeClass('hide');
            items.removeClass('hide');
        } else
        if (type == 'detail-purchase_order-report') {
        ...
        if (type == 'to_pay_debt-report') {
            to_pay_debt_report.removeClass('hide');
            report_from_choose.removeClass('hide');
            supplierts.removeClass('hide');
        } else
        if (type == 'detail_debt-report') {
        ...
        if (type == 'general-purchase-detail-report') {
    ...
    function report_general_purchase_detail_report() {
        ...
        initDataTable('.table-general-purchase-detail-report', admin_url + 'reports/general_purchase_detail_report', false, false, fnServerParams, [0, 'asc']);
    }
    function report_general_purchase() {
        ...
        initDataTable('.table-general-purchase-report', admin_url + 'reports/general_purchase_report', false, false, fnServerParams, [0, 'asc']);
    }
    ...
    function detail_purchase_report_v2() {
        ...
        initDataTable('.table-detail-purchase-report', admin_url + 'reports/detail_purchase_report', false, false, fnServerParams, [0, 'asc']);
    }
    ...
    function to_pay_debt_report_v2() {
        ...
        initDataTable('.table-to_pay_debt-report', admin_url + 'reports/to_pay_debt_report', false, false, fnServerParams, [0, 'asc']);
    }
    ...
    function detail_debt_report_v2() {
        ...
        initDataTable('.table-detail_debt-report', admin_url + 'reports/detail_debt_report', false, false, fnServerParams, [0, 'asc']);
    }
    ...
    function detail_purchase_order_report_v2() {
        ...
        initDataTable('.table-purchase_order-report', admin_url + 'reports/purchase_order_report', false, false, fnServerParams, [0, 'asc']);
    }
