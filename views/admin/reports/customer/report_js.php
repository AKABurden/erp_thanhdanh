...
function debt_all_result() {
    ...
    initDataTable('.table-debt-all-result', admin_url + 'reports/debt_all_result', false, false, fnServerParams, [0, 'desc']);
}
...
function debt_all_result_detail() {
    ...
    initDataTable('.table-debt-all-result-detail', admin_url + 'reports/debt_all_result_detail', false, false, fnServerParams, [0, 'asc']);
}
