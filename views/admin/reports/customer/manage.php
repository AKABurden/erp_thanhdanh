                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 border-right">
                                ...
                                <?php if (has_permission('debt_all_result', '', 'view')) { ?>
                                    <p>
                                        <a class="font-medium" onclick="init_report(this,'debt-all-result'); return false;">
                                ...
                                <?php if (has_permission('debt_all_result_detail', '', 'view')) { ?>
                                    <p>
                                        <a class="font-medium" onclick="init_report(this,'debt-all-result-detail'); return false;">
                                            <i class="fa fa-caret-down" aria-hidden="true"></i>
                                ...
                                <?php if (has_permission('debt_all_result_by_staff', '', 'view')) { ?>
                                    <p>
                                        <a class="font-medium" onclick="init_report(this,'debt-all-result-by-staff'); return false;">
                                            <i class="fa fa-caret-down" aria-hidden="true"></i>
                            ...
                            <div class="col-md-4 border-right">
                                ...
                                <?php if (has_permission('debt_all_result', '', 'view')) { ?>
                                    <p>
                                        <a class="font-medium" onclick="loadReport(this, 'sale_listing')">
                                            <i class="fa fa-caret-down" aria-hidden="true"></i>
                                            <?php echo _l('tnh_sale_listing'); ?>
                                        </a>
                                    </p>
                                    <hr class="hr-10" />
                                <?php } ?>
                                <p>
                                    <a class="font-medium" onclick="init_report(this, 'detail-payment')">
                                        <i class="fa fa-caret-down" aria-hidden="true"></i>
