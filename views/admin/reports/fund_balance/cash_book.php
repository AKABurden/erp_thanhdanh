   <style>
      .table-cash-book tbody tr td:nth-child(1){
        white-space: inherit;
        text-align: center;
        min-width: 100px;
      }
      .table-cash-book tbody tr:not(:first-child) td:nth-child(2){
        white-space: inherit;
        text-align: center;
        min-width: 120px;
      }
      .table-cash-book tbody tr td:nth-child(3){
        white-space: inherit;
        text-align: center;
        min-width: 100px;
      }
      .table-cash-book tbody tr:not(:first-child) td:nth-child(4){
        white-space: inherit;
        min-width: 200px;
      }
      .table-cash-book tbody tr:not(:first-child) td:nth-child(5){
        white-space: inherit;
        min-width: 200px;
      }
      .table-cash-book tbody tr td:nth-child(6){
        white-space: inherit;
        text-align: right;
        min-width: 100px;
      }
      .table-cash-book tbody tr td:nth-child(7){
        white-space: inherit;
        text-align: right;
        min-width: 100px;
      }
      .table-cash-book tbody tr td:nth-child(8){
        white-space: inherit;
        min-width: 100px;
        text-align: right;
      }
   </style>
    <div id="cash-book" class="hide">
      <table class="table table table-striped table-cash-book">
         <thead>
            <tr>
