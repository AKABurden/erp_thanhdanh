               ...
               <div class="panel-body">
                  <div class="row">
                     <div class="col-md-4 border-right">
                      ...
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'diary-of-collecting-money'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('diary_of_collecting_money'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <?php } ?>
                      <?php if (has_permission('diary_of_spending_money', '', 'view')){ ?>
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'diary-of-spending-money'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('diary_of_spending_money'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <?php } ?>
                      <?php if (has_permission('diary_of_revenue_and_expenditure', '', 'view')){ ?>
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'diary-of-revenue-and-expenditure'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('diary_of_revenue_and_expenditure'); ?></a>
                      </p>
                      <?php } ?>
                  </div>
                  <div class="col-md-4 border-right">
                      ...
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'aggregate-fund-balance'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('aggregate_fund_balance'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <?php } ?>
                      <?php if (has_permission('cash_book', '', 'view')){ ?>
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'cash-book'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('cash_book'); ?></a>
                      </p>
                      <hr class="hr-10" />
                      <?php } ?>
                      <?php if (has_permission('cash_book_bank', '', 'view')){ ?>
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'cash-book-bank'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('cash_book_bank'); ?></a>
                      </p>
                      <?php } ?>
                  </div>
                <div class="col-md-4">
                  <h4 class="no-margin font-medium"><i class="fa fa-balance-scale" aria-hidden="true"></i> <?php echo _l('ch_cash_flow_report'); ?></h4>
                      ...
                      <p>
                        <a href="" class="font-medium" onclick="init_report(this,'cash-flow'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_cash_flow'); ?></a>
                      </p>
                      <?php } ?>
                      <hr class="hr-10" />
