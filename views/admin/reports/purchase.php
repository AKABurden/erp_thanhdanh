                  ...
                  <div class="row">
                     <div class="col-md-4 border-right">
                        ...
                        <?php if (has_permission('purchase_details', '', 'view')) { ?>
                           <p>
                              <a href="#" class="font-medium" onclick="init_report(this,'general-purchase-detail-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('general_purchase_detail_report'); ?></a>
                           </p>
                           <hr class="hr-10" />
                        <?php } ?>
                        <?php if (has_permission('consolidated_purchase_report', '', 'view')) { ?>
                           <p>
                              <a href="#" class="font-medium" onclick="init_report(this,'general-purchase-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_consolidated_purchase_report'); ?></a>
                           </p>
                           <hr class="hr-10" />
                        <?php } ?>
                        <?php if (has_permission('purchase_details_book', '', 'view')) { ?>
                           <p>
                              <a href="#" class="font-medium" onclick="init_report(this,'detail-purchase-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_purchase_details_book'); ?></a>
                           </p>
                        <?php } ?>
                        <hr class="hr-10" />
                        <!-- <?php if (has_permission('purchase_details_book', '', 'view')) { ?> -->
                        <p>
                           <a href="#" class="font-medium" onclick="init_report(this,'detail-purchase_order-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_purchase_order_details_book'); ?></a>
                        </p>
                        <!-- <?php } ?> -->
                     </div>
                     <div class="col-md-4 border-right">
                        ...
                        <?php if (has_permission('summary_of_liabilities', '', 'view')) { ?>
                           <p>
                              <a href="#" class="font-medium" onclick="init_report(this,'to_pay_debt-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_summary_of_liabilities'); ?></a>
                           </p>
                           <hr class="hr-10" />
                        <?php } ?>
                        <?php if (has_permission('details_of_liabilities_by_item', '', 'view')) { ?>
                           <p>
                              <a href="#" class="font-medium" onclick="init_report(this,'detail_debt-report'); return false;"><i class="fa fa-caret-down" aria-hidden="true"></i> <?php echo _l('ch_details_of_liabilities_by_item'); ?></a>
                           </p>
                           <hr class="hr-10" />
                        <?php } ?>
                     </div>
