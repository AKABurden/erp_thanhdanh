<div class="modal fade" id="add_coupon_support" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <?php echo form_open('admin/coupon_support/add',array('id'=>'form_add')); ?>
                    ...
                    <table class="tnh-tb table-bordered table-hover m-group0" style="table-layout: fixed;">
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 30%">
                                    <?php echo render_datetime_input('appointment_date','', date('d/m/Y H:i')); ?>
                                </td>
                                <td style="width: 15%">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <?php echo render_select('employees', $staff, array('staffid', 'fullname')); ?>
                                </td>
                            </tr>
                            <tr>
                                <td>
