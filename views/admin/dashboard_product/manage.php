        ...
        <div class="row">
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="card text-white bg-warning o-hidden h-100">
                                                    ...
                                                    <h3 class="mr-5"> Nguyên Liệu <br><span style="font-size: 16px" id="materials">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                                <div style="height: 118px;" class="col-md-4">
                                                <div class="card text-white bg-success o-hidden h-100">
                                                    <div class="card-body">
                                                    <img src="<?= base_url('assets/images/circle.svg')?>" class="card-img-absolute" alt="circle-image" />
                                                    <h3 class="mr-5">Công Cụ - Vật Tư<br><span style="font-size: 16px" id="items">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                                <div style="height: 118px;" class="col-md-4">
                                                <div class="card text-white bg-primary o-hidden h-100" style="background-color: #ff4015;">
                                                    <div class="card-body">
                                                    <img src="<?= base_url('assets/images/circle.svg')?>" class="card-img-absolute" alt="circle-image" />
                                                    <h3 class="mr-5">Thành Phẩm<br><span style="font-size: 16px" id="products">0</span></h3>
                                                    </div>
                                                </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="border-radius-4 wrap_box">
                                                    <strong><h4 class="text-center">Top 5 nguyên vật liệu đạt mức tối thiểu</h4></strong>
                                                    <hr/>
                                                    <div>
                                                        <div style="float: left; padding: 0 0 0 10px;">
                                                            <span style="font-size: 10px;">Nguyên Liệu</span>
                                                        </div>
                                                        <div style="float: right; padding: 0 10px 0 0;">
                                                            <span style="font-size: 10px;">Số lượng thiếu</span>
                                                        </div>
                                                        <div class="clearfix"></div>
                                                    </div>
                                                    <br/>
                                                    <div class="top_materials"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="border-radius-4 wrap_box">
                                                    <strong><h4 class="text-center">Top 5 thành phẩm đạt mức tối thiểu</h4></strong>
                                                    <hr/>
                                                    <div>
                                                    <div style="float: left; padding: 0 0 0 10px;">
                                                        <span style="font-size: 10px;">Thành Phẩm</span>
                                                    </div>
                                                    <div style="float: right; padding: 0 10px 0 0;">
                                                        <span style="font-size: 10px;">Số lượng thiếu</span>
                                                    </div>
            ...
            <!-- loc theo khach hang -->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="border-radius-4 wrap_box">
                                                    <strong><h4 class="text-center">TOP 5 THÀNH PHẨM ĐẠT DOANH THU CAO NHẤT</h4></strong>
                                                    <hr/>
                                                    <div>
                                                    <div style="float: left; padding: 0 0 0 10px;">
                                                        <span style="font-size: 10px;">THÀNH PHẨM</span>
                                                    ...
                                                    <div style="float: right; padding: 0 10px 0 0;">
                                                        <span style="font-size: 10px;">doanh thu</span>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    </div>
                                                    <br/>
                                                    <div class="top_product_bestsell"></div>
                                                </div>
                                            </div>
                                        </div>
                                            <div class="clearfix"></div>
...
<script>
    ...
    function top_materials() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_product/top_materials/",
            data: dataString,
            cache: false,
            success: function (data) {
              data = JSON.parse(data);
              $('.top_materials').html(data);
              }
        });
    }
    function top_items() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_product/top_items/",
            data: dataString,
            cache: false,
            success: function (data) {
              data = JSON.parse(data);
    ...
    function top_items_bestsell() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_product/top_items_bestsell/",
            data: dataString,
            cache: false,
            success: function (data) {
              data = JSON.parse(data);
              $('.top_items_bestsell').html(data);
              }
        });
    }
    function top_product_bestsell() {
        var months_report = $('select[name="months-report"]').val();
        var report_to = $('input[name="report-to"]').val();
        var report_from = $('input[name="report-from"]').val();
        var customers_ch = $('[name="customers_ch"]').val();
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_product/top_product_bestsell/",
            data: dataString,
            cache: false,
            success: function (data) {
              data = JSON.parse(data);
              $('.top_product_bestsell').html(data);
              }
        });
    }
    function get_total_limit() {
        ...
        jQuery.ajax({
            type: "post",
            url: "<?=admin_url()?>dashboard_product/count_all/",
            data: dataString,
            cache: false,
            success: function (data) {
                data = JSON.parse(data);
                $('#materials').html(data.materials);
    ...
    function init_dashboard_report_cot() {
        ...
        var customers_ch = $('[name="customers_ch"]').val();
        dataString = {[csrfData['token_name']] : csrfData['hash'],months_report:months_report,report_from:report_from,report_to:report_to,search_id_staff:search_id_staff,customers_ch:customers_ch};
        $.post(admin_url + 'dashboard_product/dashboard_report_cot/',dataString, function(response) {
    ...
    function init_dashboard_report() {
        ...
        var customers_ch = $('[name="customers_ch"]').val();
        dataString = {[csrfData['token_name']] : csrfData['hash'],months_report:months_report,report_from:report_from,report_to:report_to,search_id_staff:search_id_staff,customers_ch:customers_ch};
        $.post(admin_url + 'dashboard_product/dashboard_report/',dataString, function(response) {
        var response = JSON.parse(response);
