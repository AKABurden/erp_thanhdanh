                    ...
                    <div class="">
                        ...
                        ?>
                            ...
                            <div id="search">
                                ...
                                <!--                                </div>-->
                                <div class="col-md-3">
                                    <div class="form-group no-mbot" app-field-wrapper="customer_admins_search">
                                        <label for="customer_admins_search" class="control-label"><?= _l('staff_admin') ?></label>
                                        <select id="customer_admins_search" name="customer_admins_search" class="selectpicker" data-width="100%" data-none-selected-text="<?= _l('staff_admin') ?>" data-live-search="true" tabindex="-98">
                                            <option></option>
...
<script>
    ...
    tAPI = initDataTable('.table-clients', admin_url + 'clients/table', [0], [0], CustomersServerParams, [1, 'desc']);
