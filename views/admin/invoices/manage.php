	...
	<div class="panel_s mbot10 H_scroll" id="H_scroll">
      	<div class="panel-body _buttons">
         	...
         	<?php if(has_permission('invoices','','create')){ ?>
            	<a href="<?php echo admin_url('invoices/invoice'); ?>" class="btn btn-info pull-left new new-invoice-list mright5 H_action_button">
         	...
         	<?php if(!isset($project)){ ?>
               	<a href="<?php echo admin_url('invoices/recurring'); ?>" class="btn btn-info pull-left H_action_button">
