<div id="modal_import_criteria" class="modal fade" role="dialog">
    <form action="<?=admin_url('Kpi/import_criteria')?>" id="import_form" enctype="multipart/form-data" method="post" accept-charset="utf-8" novalidate="novalidate">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a target="_blank" href="<?=base_url('uploads/template/template_kpi_criteria (1).xlsx?vs=1.1')?>">Download file mẫu</a>
...
<script>
    $('#modal_import_criteria').modal('show');
    ...
    function get_data_file_excel() {
        ...
        var url = admin_url + 'Kpi/import_criteria';
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.success) {
                    $('#modal_import_criteria').modal('hide');
                    if(oTable) {
                        oTable.ajax.reload();
                    }
                } else {
                    if (typeof data.error !== 'undefined') {
                        $('.show-errors').html(data.error);
                    }
                }
            }
        });
