<?php echo form_open('admin/manufactures/add_production_planning/' . $id, array('id' => 'created-detail')); ?>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <?= $business_plan['status'] == 'un_approved' ? '<span class="label label-danger">' . lang($business_plan['status']) . '</span>' : '<span class="label label-success">' . lang($business_plan['status']) . '</span>' ?>
                    </div>
                </div>
