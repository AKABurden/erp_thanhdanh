				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="form-group">
							...
							<input type="text" name="amount_to_vnd" placeholder="<?= lang('amount_to_vnd') ?>" id="amount_to_vnd" data-placeholder="<?= lang('amount_to_vnd') ?>" class="form-control amount_to_vnd money-format" value="" required="required">
						</div>
						<div class="form-group">
...
<script>
	$(function(){
		...
		$('#currency_modal').on('show.bs.modal', function(event) {
			...
			$('#currency_modal input[name="amount_to_vnd"]').val('');
			...
			if (typeof(id) !== 'undefined') {
				...
				var amount_to_vnd = $(button).parents('tr').find('td').eq(2).text();
				...
				$('#currency_modal input[name="amount_to_vnd"]').val(amount_to_vnd);
