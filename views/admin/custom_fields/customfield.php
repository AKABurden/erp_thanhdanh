                        ...
                        <div class="customers_field_info mbot25 alert alert-info<?php if(isset($custom_field) && $custom_field->fieldto != 'customers' || !isset($custom_field)){echo ' hide';} ?>">
                          ...
                          <div class="select-placeholder form-group">
                            ...
                            <select name="fieldto" id="fieldto" class="selectpicker" data-width="100%" <?php echo $disable; ?> data-none-selected-text="<?php echo _l('dropdown_non_selected_tex'); ?>">
                                ...
                                <option value="suppliers" <?php if(isset($custom_field) && $custom_field->fieldto == 'suppliers'){echo 'selected';} ?>><?php echo _l('ch_suppliers'); ?></option>
                                <option value="supplier_quotes" <?php if(isset($custom_field) && $custom_field->fieldto == 'supplier_quotes'){echo 'selected';} ?>><?php echo _l('ch_supplier_quotes'); ?></option>
                                <option value="imports" <?php if(isset($custom_field) && $custom_field->fieldto == 'imports'){echo 'selected';} ?>><?php echo _l('ch_import'); ?></option>
                                <option value="materials" <?php if(isset($custom_field) && $custom_field->fieldto == 'materials'){echo 'selected';} ?>><?php echo _l('tnh_materials'); ?></option>
                                <option value="tools_supplies" <?php if(isset($custom_field) && $custom_field->fieldto == 'tools_supplies'){echo 'selected';} ?>><?php echo _l('tnh_tools_supplies'); ?></option>
                                <option value="products" <?php if(isset($custom_field) && $custom_field->fieldto == 'products'){echo 'selected';} ?>><?php echo _l('tnh_products'); ?></option>
