...
<style class="">
    ...
    .view-delivery tr th:nth-child(8), .view-delivery tr td:nth-child(8) {
        display: none;
    }
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-deliveries"
                                   class="table dt-tnh table-hover table-condensed table-deliveries-new">
                                <thead>
                                <tr>
                                    <th>
                                        <div class="checkbox mass_select_all_wrap text-center"><input type="checkbox"
                                                                                                      id="mass_select_all"
                                                                                                      data-to-table="deliveries-new"><label
            ...
            '#table-deliveries',
            {
                ...
                "columnDefs": [
                    ...
                    },
                    {
                        ...
                        "targets": 2, "name": 'reference_no', 'width': '120px'
                    },
                    {
                        "render": function (data, type, row) {
                            data = data.split('__');
                        ...
                        "targets": 3, "name": 'customer_name', 'width': '120px'
                    },
                    {"targets": 4, "name": 'address_delivery', 'width': '120px'},
                    {"targets": 5, "name": 'reference_invoice', 'width': '100px'},
                    {"targets": 6, "name": 'reference_orders', 'width': '120px'},
                    {
                        "render": function (data, type, row) {
                            return '<div class="text-right">' + tnhFormatMoney(data) + '</div>';
                        },
                        "targets": 7, "name": 'grand_total', 'width': '100px'
                    },
                    ...
                    },
                    {
                        ...
                        "targets": 10, "name": 'status', 'width': '100px'
                    },
                    {"targets": 11, "name": 'note', 'width': '100px'},
                    {"targets": 12, "name": 'user_status', 'visible': false},
                    {"targets": 13, "name": 'list_users', 'visible': false, 'searchable': false},
                    {"targets": 14, "name": 'name_branch', 'searchable': false},
                    {"targets": 15, "name": 'actions', 'sortable': false, 'searchable': false, 'width': '150px'},
                ],
