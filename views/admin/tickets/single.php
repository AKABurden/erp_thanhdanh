                                ...
                                <div>
                                    ...
                                    <?php if ($ticket->lastreply !== NULL) { ?>
                                        <span class="ticket-label label label-success inline-block"
                                              data-toggle="tooltip" title="<?php echo _dt($ticket->lastreply); ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="customer_id" id="customers" class="customers" style="width: 100%;" data-placeholder="<?= lang('customers') ?>"  value="<?= 'customers__'.$ticket->customer_id ?>" required="required">
                                        </div>
                                        <div class="form-group">
                                            <?= lang('contact', 'contactid') ?>
                                            <input type="text" name="contactid" id="contactid" class="contactid" style="width: 100%;" data-placeholder="<?= lang('contact') ?>"  value="<?= $ticket->contactid ?>" required="required">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <?= lang('orders', 'order_id') ?>
                                                <input type="text" name="order_id" id="order_id" class="order_id" style="width: 100%;" data-placeholder="<?= lang('orders') ?>"  value="<?= $ticket->order_id ?>">
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ajaxSelectParamsCallback('#customers', 'admin/clients/searchCustomers', $('#customers').val());
    customer_id = $('#customer_id').val();
    ajaxSelectParamsCallback('#contactid', 'admin/clients/searchContractNew', $('#contactid').val(), {customer_id: customer_id}, true);
    ajaxSelectParamsCallback('#order_id', 'admin/orders/searchOrdersByParams', $('#order_id').val(), {customer_id: customer_id}, true);

    $(document).on('change', '.customers', function(event) {
        event.preventDefault();
        customer_id = $(this).val();
        ajaxSelectParamsCallback('#contactid', 'admin/clients/searchContractNew', 0, {customer_id: customer_id}, true);
        ajaxSelectParamsCallback('#order_id', 'admin/orders/searchOrdersByParams', 0, {customer_id: customer_id}, true);
        $('#contactid').val(0);
        $('#order_id').val(0);
    });
</script>