...
<div role="tabpanel" class="tab-pane" id="company_info">
    ...
    <?php echo render_input('settings[fax_company]','Fax',get_option('fax_company')); ?>
    <?php echo render_input('settings[email_company]','Email',get_option('email_company')); ?>
    <?php echo render_input('settings[company_vat]','company_vat_number',get_option('company_vat')); ?>
    <?php echo render_input('settings[bank_account]','bank_account',get_option('bank_account')); ?>
    <?php echo render_input('settings[bank_name]','bank_name',get_option('bank_name')); ?>
    <?php echo render_input('settings[general_manager]','general_manager',get_option('general_manager')); ?>
    <?php echo render_input('settings[company_website]','company_website',get_option('company_website')); ?>
    <?php echo render_input('settings[general_manager]','general_manager',get_option('general_manager')); ?>
