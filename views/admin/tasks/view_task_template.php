...
<!--                                            <li>-->
<!--                                                <a href="#" onclick="-->
<!--                                                        //task_change_milestone(--><?php //echo $milestone['id']; ?><!--//,--><?php ////echo $task->id; ?>
<!--                                                        //);">-->
        ...
        <div class="col-md-4 task-single-col-right">
            ...
            <div class="task-info task-single-inline-wrap task-info-start-date">
                <h5><i class="fa task-info-icon fa-fw fa-lg fa-calendar-plus-o pull-left fa-margin"></i>
                    ...
                    <?php if (has_permission('tasks', '', 'edit') && $task->status != 5) { ?>
                        <input name="startdate" tabindex="-1" value="<?php echo _d($task->startdate); ?>" style="width: 120px;" id="task-single-startdate" class="task-info-inline-input-edit datepicker pointer task-single-inline-field">
                    <?php } else { ?>
            ...
            <div class="task-info task-info-due-date task-single-inline-wrap<?php if (!$task->duedate && !has_permission('tasks', '', 'edit')) {
                ...
                <h5>
                    ...
                    <?php if (has_permission('tasks', '', 'edit') && $task->status != 5) { ?>
                        <input name="duedate" tabindex="-1" value="<?php echo _d($task->duedate); ?>" id="task-single-duedate" class="task-info-inline-input-edit datepicker pointer task-single-inline-field" autocomplete="off" <?php if ($project_deadline) {
