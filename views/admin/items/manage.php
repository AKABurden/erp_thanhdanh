        ...
        <div class="panel-body _buttons">
            ...
            <div class="dropdown pull-right">
                ...
                <ul class="dropdown-menu pull-right" role="menu" aria-labelledby="dropdownMenu1" style="width: 200px;">
                    ...
                    <li>
<!--                        <a href="--><?//= base_url('admin/items/export_excel_items') ?><!--" class="tnh-modal" data-tnh="modal"-->
...
<!--                        </a>-->
            ...
            <div class="pull-right mright5 H_border">
                <a href="<?= base_url('admin/items/add_item') ?>"
                    class="btn btn-info mright5 H_action_button tnh-modal active-modal" data-tnh="modal"
                    data-toggle="modal" data-target="#myModal">
                    <?php echo _l('add'); ?>
                </a>
            </div>
				<?php if ($this->perExportItems): ?>
                    <div class="pull-right mright5 H_border">
                        <a href="<?= base_url('admin/items/export_excel_items') ?>" class="btn btn-info mright5 H_action_button tnh-modal" data-tnh="modal"
                           data-toggle="modal" data-target="#myModal">
                            <i class="fa fa-file-text-o"></i>
                            <?php echo lang('tnh_export_excel'); ?>
                        </a>
                ...
                <div id="search-tnh" class="collapse in" aria-expanded="true" style="">
                    <div class="col-md-3">
                        ...
                        <select name="category_search" id="category_search"
                            data-placeholder="<?= lang('tnh_item_materials_category') ?>" class="modal-select2"
                            style="width: 100%;">
                            <option value=""></option>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="materials_search" id="materials_search" style="width: 100%;"
                            data-placeholder="<?= lang('materials') ?>" value="">
                    </div>
                    <div class="col-md-3">
                                    ...
                                    <tr>
                                        <th>
                                            <div class="checkbox mass_select_all_wrap text-center"><input
                                                    ...
                                                    data-to-table="materials"><label for="mass_select_all"></label>
                                            </div>
                                        </th>
                                        <th><?= lang('image') ?></th>
                                        <th><?= lang('category') ?></th>
...
$(document).ready(function() {
    ...
    $('#species_search').select2({'allowClear': true});
    ...
    $(document).on('change', '#category_search, #materials_search, #species_search', function(event) {
