...
<script>
    ...
    function handling_status_internal(_internal_proposal_id, _status) {
    ...
    $(function() {
        ...
        $('body').on('change', 'input[name="filterStatus"], select[name="staff_search"], select[name="category_tasks_search"] , select[name="type_plan_propose"], input[name="date_start"], input[name="date_end"]', function() {
            if (oTable) {
                oTable.draw('page');
            }
        })
    ...
    $('body').on('click', '#agree', function() {
        var id = $(this).data('id');
        $.get(admin_url + 'internal_proposal/approve/' + id, function(response) {
