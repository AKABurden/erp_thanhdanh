<script>
    ...
    $(function(){
        //
        // initDataTableFixedColums('.table-care_of_clients', admin_url+'care_of_clients/table', [0], [0], filterList, [], {
        //     leftColumns: 2,
        //     rightColumns: 2,
        // });
        initDataTable('.table-care_of_clients', admin_url+'care_of_clients/table', [0], [0], filterList, [1, 'desc']);
    });
