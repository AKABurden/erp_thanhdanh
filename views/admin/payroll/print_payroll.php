    ...
    <div id="wrap" style="padding:1px;">
        ...
        if (!empty($personnel)) { ?>
            <?php foreach ($personnel as $key => $value) { ?>
                ...
                ?>
                <table class="table-custom" style="margin-right: 5px;">
                    <tr>
