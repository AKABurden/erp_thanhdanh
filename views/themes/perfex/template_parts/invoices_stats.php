    ...
    <div class="col-md-4 invoices-stats-unpaid">
        <div class="row">
            <div class="col-md-8 stats-status">
                <span><h5 class="bold no-margin">
                    <?php echo _l('purchase_order_new'); ?></h5></span>
                </div>
        ...
        <div class="col-md-4 invoices-stats-paid">
            <div class="row">
                <div class="col-md-8 stats-status">
                    <span><h5 class="bold no-margin"><?php echo _l('purchase_approved'); ?></h5></span>
                </div>
        ...
        <div class="col-md-4 invoices-stats-overdue">
            <div class="row">
                <div class="col-md-8 stats-status">
                    <span><h5 class="bold no-margin"><?php echo _l('purchase_no_approved'); ?></h5></span>
                </div>
                <div class="col-md-4 text-right stats-numbers bold">
